...
SC_MODULE(h264) {
  ...
  void createInstVec(std::string inst) { 
    ...
    sc_trace(stimVecFile_h264, gbl_clk, std::string("gbl_clk") );
    sc_trace(stimVecFile_h264, gbl_reset_, std::string("gbl_reset_") );
    sc_trace(stimVecFile_h264, gbl_enable, std::string("gbl_enable") );
