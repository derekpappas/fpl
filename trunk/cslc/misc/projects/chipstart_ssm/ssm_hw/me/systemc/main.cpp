...
int sc_main (int argc, char* argv[]) {
	...
	sc_trace(wf, tb.me_->gbl_reset_, "gbl_reset_");
	sc_trace(wf, tb.me_->gbl_enable, "gbl_enable");
	...
	sc_trace(wf, tb.me_->eu_->lasOp, "lasOp");
	sc_trace(wf, tb.me_->eu_->isInstFormatOpLas, "isInstFormatOpLas");
	...
	sc_trace(wf, tb.me_->rf_->eu_rf_wren_int, "eu_rf_wren_int");
	sc_trace(wf, tb.me_->rf_->eu_rf_wr_addr_int, "eu_rf_wr_addr_int");
	sc_trace(wf, tb.me_->rf_->eu_rf_wr_addr_equal_rd_addr_b_1, "eu_rf_wr_addr_equal_rd_addr_b_1");


	sc_trace(wf, tb.me_->rf_->rfRdAddrEqEuRfWrAddr_a        , "rfRdAddrEqEuRfWrAddr_a        ");
	sc_trace(wf, tb.me_->rf_->rfRdAddrEqEuRfWrAddr_b        , "rfRdAddrEqEuRfWrAddr_b        ");

	sc_trace(wf, tb.me_->rf_->eu_rf_wr_addr_equal_rd_addr_a, "eu_rf_wr_addr_equal_rd_addr_a");
	sc_trace(wf, tb.me_->rf_->eu_rf_wr_addr_equal_rd_addr_b, "eu_rf_wr_addr_equal_rd_addr_b");
