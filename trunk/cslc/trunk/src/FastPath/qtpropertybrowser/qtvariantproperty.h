...
public:
    ...
    //FIXME: need to write a wrapper later to work around
    static int comboboxTypeId();
    static int rangeTypeId();
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void slotComboboxNamesChanged(QtProperty *, const QStringList &))
    Q_PRIVATE_SLOT(d_func(), void slotComboboxSelectablesChanged(QtProperty *, const QStringList &))
    Q_PRIVATE_SLOT(d_func(), void slotComboboxIconsChanged(QtProperty *, const QMap<int, QIcon> &))
    ...
    Q_PRIVATE_SLOT(d_func(), void slotBooleanDisplayNameChanged(QtProperty *, const QStringList &))
