...
{
public:
    QtPropertyPrivate(QtAbstractPropertyManager *manager) : m_enabled(true), m_editable(true), m_modified(false), m_manager(manager) {}
    QtProperty *q_ptr;
...
/*!
    ...
    \sa setEditable()
*/
void QtProperty::setEditable(bool editable)
{
    if (d_ptr->m_editable == editable)
        return;

    d_ptr->m_editable = editable;
    propertyChanged();
}
