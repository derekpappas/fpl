...
class GuiCVisitorTraversal : public NSCSLOmVisitor::CVisitorTraversal {
    int tabbing;
  ...
  public:    
    ...
    void beforeTraversal(const NSCSLOm::RefCSLOmParameter                       & param                           ) { };
    ...
    void inTraversal(const NSCSLOm::RefCSLOmParameter                           & param                           ) { };
    ...
    void afterTraversal(const NSCSLOm::RefCSLOmParameter                        & param                           ) { };
