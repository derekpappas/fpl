//----------------------------------------------------------------------
// Copyright (c) 2005, 2006, 2007, 2008, 2009, 2010 Fastpathlogic
// All Rights Reserved.
...
/*
 *   CDOM Verilog StimExp generator
 *   Authors: MonicaS 
 *   2010
 */

#ifndef CDOM_STIM_EXP_GENERATOR
#define CDOM_STIM_EXP_GENERATOR
//#ifndef 
//#define 
...
class CStimExpGenerator;
typedef boost::shared_ptr<CStimExpGenerator> RefCStimExpGenerator;

//********************************************************************************
// CStimExpGenerator class
//********************************************************************************
class CStimExpGenerator : public NSCdomVisitor::CVisitorTraversal {
   public:
     CStimExpGenerator(std::string outputPath);
    ...
    RefString m_MemWidth;
    RefString m_AddrWidth;
    RefString m_VectorId;
    RefString m_VectorVersion;
    RefString m_VectorName;
    RefString m_VectorFile;
    RefString m_VectorRadix;
    RefString m_MemDepth;

    // stim_exp ports
    RefString m_clock;
    RefString m_reset;
    RefString m_rd_en;
    RefString m_vector_out;
    RefString m_valid;
    RefString m_version_err;
    RefString m_id_err;

    //stim_exp variables
    RefString m_memory_out;
    RefString m_stim_expect_memory;
    RefString m_rd_addr;
    RefString m_mem_out_is_id;
    RefString m_mem_out_is_version;
    RefString m_mem_addr;
    RefString m_stim_expect_memory_loaded;
    RefString m_mem_out_is_id_or_version;
    RefString m_mux_select;
    RefString m_vector_id_match;
    RefString m_vector_version_match;

    //dut inst
    std::vector<RefString> m_dutInstVec;
    std::vector<RefString> m_stimInstVec;
    std::vector<RefString> m_expInstVec;
