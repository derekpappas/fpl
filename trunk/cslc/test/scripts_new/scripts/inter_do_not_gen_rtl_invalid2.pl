...
print "Generated tests path : inter_not_gen_rtl_invalid2/\n";
...
#register reg
    if($i <= 25 || $i > 75 && $i <= 100 || $i > 125 && $i <= 150) {
...
#unit a
    ...
    print FH "  a$k () {\n";
    if($i <= 50) {
	print FH "    rf$k\_$zero.do_not_gen_rtl();\n";
    }
    elsif($i > 75 && $i <= 125) {
...
#unit b
	...
	print FH "    ff$k\_$one.do_not_gen_rtl();\n";
    }
    print FH "  }\n";
    print FH "};\n\n";
...
#unit c
	...
	print FH "    mem$k\_$zero.do_not_gen_rtl();\n";
    }
    print FH "  }\n";
    print FH "};\n\n";
