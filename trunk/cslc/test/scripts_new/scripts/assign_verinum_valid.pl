...
sub createCslFile {
    ...
    print FH "  csl_port p_data2(input,$val6);\n"; 
    print FH "  csl_signal s_addr2($val21);\n";
    print FH "  csl_signal s_data3($val23);\n";
    print FH "  csl_signal s_addr3($val8);\n";
    print FH "  a() {\n";
    ...
    if($i > 40){
        ...
        print FH "  csl_signal s_addr23($val19);\n";
