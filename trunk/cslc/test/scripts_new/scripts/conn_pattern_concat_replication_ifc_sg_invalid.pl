...
print "the path for generated tests is : $path"."conn_pattern_concat_replication_ifc_sg_invalid/ \n";
...
sub main {
    my ($i) = $_[0];
    my $test_name = "conn_pattern_concat_replication_ifc_sg$i"."_illegal.csl";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val5);
    &mkDir("$path/conn_pattern_concat_replication_ifc_sg_invalid");
    open(FH,">$path/conn_pattern_concat_replication_ifc_sg_invalid/$test_name");
    print FH "//Generated by Petronela\n";
    print FH "//testing the cmd connect_by_pattern for connections ifc.p,sg.sig,ifc[.ifc],sg[.sg] to concat expr.,replication exp \n\n";
    ...
    print FH "  d() {\n";
    if($i <= 15) {
        print FH "    {c0.b0.a0.p_a$i,c0.b0.a0.pa}.connect_by_pattern(ifca5.p_ifca$i);\n";
        print FH "    {c1.b0.a1.p,c1.b0.a1.p_a_br$i}.connect_by_pattern(sgd5.s_sggd);\n";
        print FH "    {2{p_c$i,pc,p}}.connect_by_pattern(c0.ifcb4);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    {c0.b1.a1.pa,c0.b1.a1.p_a$i,p}.connect_by_pattern(c1.sgb4.s_sigb,$word);\n";
        print FH "    {3{p,p_d$i}}.connect_by_pattern(c0.ifcb4.ifca0,$word1);\n";
        print FH "    {c1.b1.a0.s_a$i,c1.b1.a0.s_a_br$i}.connect_by_pattern(c0.b1.ifcd3.ifcb0.ifca0.p_if,$word2);\n";
    }
    elsif($i > 30) {
        print FH "    {4{c1.cp_c_br$i,c1.p}}.connect_by_pattern(c0.b0.sgd3.sgb0,$word);\n";
        print FH "    {s_d_br$i,s_d$i,sd}.connect_by_pattern(c0.ifcd4.p_iftd$i,$word1);\n";
    }
    ...
    print FH "  e() {\n";
    if($i <= 15) {
        print FH "    {d0.c0.b1.p_b$i,d0.c0.b1.p}.connect_by_pattern(d0.c0.a0.ifca2.p_ifa,$word2);\n";
        print FH "    {5{b0.s_b$i}}.connect_by_pattern(ifcd6.ifcb0,$word3);\n";
        print FH "    {4{s_e$i,se,s}}.connect_by_pattern(b0.sga3.s_sga,$word4);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    {d1.c1.b1.a1.s_a$i,d1.c1.b1.a1.sa}.connect_by_pattern(b0.a1.ifcd2,$word2);\n";
        print FH "    {d0.c0.b0.p_b$i,d0.c0.b0.p_b_br$i}.connect_by_pattern(d1.c0.b1.sgb3,$word3);\n";
    }
    elsif($i > 30) {
        print FH "    {2{e.b0.p_b_br$i,e.b0.p}}.connect_by_pattern(ifca6.p_if,$word2);\n";
        print FH "    {3{d1.c0.b0.p,d1.c0.b0.p_b_br$i}}.connect_by_pattern(d1.c0.sgb4.s_sigb,$word3);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 15) {
        print FH "    {d0.c0.a0.p_a_br$i,d0.c0.a0.p}.connect_by_pattern(sgb7.sga0,$word5);\n";
        print FH "    {d0.c1.p_c$i,d0.c1.pc,d0.c1.p}.connect_by_pattern(e1.d0.c0.b0.a1.ifcd2.ifcb1.ifca1.p_ifca$i,$word6);\n";
        print FH "    {2{e0.d0.c1.b1.a1.s_a$i,e0.d0.c1.b1.a1.sa}}.connect_by_pattern(d0.ifcb5.p_if,$word7);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    {d1.c0.a0.p_a$i,d1.c0.a0.pa,d1.c0.a0.p}.connect_by_pattern(e0.d0.c0.sgd4.s_siggd,$word5);\n";
        print FH "    {3{e0.b0.p_b$i,e0.b0.p_b_br$i}}.connect_by_pattern(d0.sgb5.sga1.s_sa,$word6);\n";
        print FH "    {4{d1.c1.s_c$i,d1.c1.sc}}.connect_by_pattern(e1.b0.ifcd3.p_ifd,$word7);\n";
    }
    elsif($i > 30) {
        print FH "    {3{e0.p_e$i,pe}}.connect_by_pattern(d1.c0.a0.ifcd2.p_ifcd$i,$word5);\n";
        print FH "    {e1.d1.p_d$i,e1.d1.p}.connect_by_pattern(sgd7.s_sd,$word6);\n";
        print FH "    {2{ptop,p_top$i,p}}.connect_by_pattern(d0.c0.ifcb4.p_ifcb$i,$word7);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
