...
print "the path for the generated tests is : $path"."conn_pattern_replication_minus_pps_sps_invalid1/ \n";
...
my @lower = (12,24,36,48);
my @upper = (55,63,77,93);
...
sub main {
    my ($i,$l, $u) = @_;
    my $test_name = "connect_replication_minus$i"."_".$l."_".$u."_illegal.csl";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val);
    &mkDir("$path/conn_pattern_replication_minus_pps_sps_invalid1");
    open(FH,">$path/conn_pattern_replication_minus_pps_sps_invalid1/$test_name");

    print FH "//Generated by Petronela\n";
    print FH "//testing cmd. connect_by_pattern for invalid connections port[part select]([upper-:lower]) to replication expr., signal[part select]([upper-:lower]) to replication expr.\n\n";
