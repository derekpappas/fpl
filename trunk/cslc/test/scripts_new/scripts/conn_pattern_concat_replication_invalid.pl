...
print "the path for generated tests is : $path"."conn_pattern_concat_replication_invalid/ \n";
...
sub main {
    my ($i) = $_[0];
    my $test_name = "conn_pattern_concat_replication$i"."_illegal.csl";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val5);
    &mkDir("$path/conn_pattern_concat_replication_invalid");
    open(FH,">$path/conn_pattern_concat_replication_invalid/$test_name");
    print FH "//Generated by Petronela\n";
    print FH "//testing the cmd connect_by_pattern for invalid connections concat exp.,replication exp. to concat exp. \n\n";
    ...
    print FH "  d() {\n";
    if($i <= 15) {
        print FH "    {5{c0.b1.a0.p_a$i}}.connect_by_pattern({c0.b0.a0.p_a$i,c0.b0.a0.pa},$word);\n";
        print FH "    {p,p_d$i}.connect_by_pattern({c1.b0.a1.p,c1.b0.a1.p_a_br$i},$word1);\n";
        print FH "    {3{c1.b1.a1.p,c1.b1.a1.p_a_br$i}}.connect_by_pattern({p_c$i,pc,p},$word2);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    {c1.p_c$i,c1.pc,c1.p}.connect_by_pattern({c0.b1.a1.pa,c0.b1.a1.p_a$i,p},$word);\n";
        print FH "    {3{c0.b1.a1.pa}}.connect_by_pattern({p,p_d$i},$word1);\n";
        print FH "    {s_d_br$i,s_d$i,sd}.connect_by_pattern({c1.b1.a0.s_a$i,c1.b1.a0.s_a_br$i},$word2);\n";
    }
    elsif($i > 30) {
        print FH "    {2{s_d_br$i}}.connect_by_pattern({c1.cp_c_br$i,c1.p},$word);\n";
        print FH "    {c1.cp_c_br$i,c1.p}.connect_by_pattern({s_d_br$i,s_d$i,sd},$word1);\n";
    }
    ...
    print FH "  e() {\n";
    if($i <= 15) {
        print FH "    {2{d1.c0.b1.sb}}.connect_by_pattern({d0.c0.b1.p_b$i,d0.c0.b1.p},$word2);\n";
        print FH "    {2{p_b$i,p}}.connect_by_pattern({b0.s_b$i,b0.sb,s_b_br$i},$word3);\n";
        print FH "    {d1.c1.b1.a1.s_a$i,d1.c1.b1.a1.sa}.connect_by_pattern({s_e$i,se,s},$word4);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    {e.b0.p_b_br$i,e.b0.p}.connect_by_pattern({d1.c1.b1.a1.s_a$i,d1.c1.b1.a1.sa},$word2);\n";
        print FH "    {4{d0.c1.b0.a1.s_a$i}}.connect_by_pattern({d0.c0.b0.p_b$i,d0.c0.b0.p_b_br$i},$word3);\n";
    }
    elsif($i > 30) {
        print FH "    {5{d1.c0.b0.p_b$i}}.connect_by_pattern({e.b0.p_b_br$i,e.b0.p},$word2);\n";
        print FH "    {d1.c0.b0.p,d1.c0.b0.p_b_br$i}.connect_by_pattern({d1.c0.b0.p,d1.c0.b0.p_b_br$i},$word3);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 15) {
        print FH "    {e0.b0.s_b$i,e0.b0.sb,e0.b0.s_b_br$i}.connect_by_pattern({d0.c0.a0.p_a_br$i,d0.c0.a0.p},$word5);\n";
        print FH "    {2{d0.c0.p_c$i,d0.c0.pc,d0.c0.p}}.connect_by_pattern({d0.c1.p_c$i,d0.c1.pc,d0.c1.p},$word6);\n";
        print FH "    {2{d0.c0.a0.sa}}.connect_by_pattern({e0.d0.c1.b1.a1.s_a$i,e0.d0.c1.b1.a1.sa},$word7);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    {d0.c0.b0.p_b$i,d0.c0.b0.p_b_br$i}.connect_by_pattern({d1.c0.a0.p_a$i,d1.c0.a0.pa,d1.c0.a0.p},$word5);\n";
        print FH "    {e0.b0.p_b_br$i,e.b0.p}.connect_by_pattern({e0.b0.p_b$i,e0.b0.p_b_br$i},$word6);\n";
        print FH "    {4{d1.c0.a0.p_a$i}}.connect_by_pattern({d1.c1.s_c$i,d1.c1.sc},$word7);\n";
    }
    elsif($i > 30) {
        print FH "    {2{e0.p_e$i,pe}}.connect_by_pattern({e0.p_e$i,pe},$word5);\n";
        print FH "    {d1.c1.cp_c_br$i,d1.c1.p}.connect_by_pattern({e1.d1.p_d$i,e1.d1.p},$word6);\n";
        print FH "    {d0.s_d_br$i,d0.s_d$i,sd}.connect_by_pattern({ptop,p_top$i,p},$word7);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
