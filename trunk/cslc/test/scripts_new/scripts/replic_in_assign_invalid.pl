...
sub main {
    my $i = $_[0];
    my $test_name = "replic_assign_test".$i."_illegal.csl";
...
sub createCslFile {
    ...
    if($i==1){
        print (" Generated path: $path/replic_assign_invalid/ \n");}
    my $val = int(rand(300));
    if($val == 0) { $val = 1; }
    ...
    if($test_name=~/(_illegal)/){
        &mkDir("$path/replic_assign_invalid");
        open(FH,">$path/replic_assign_invalid/$test_name");
    }

#*************************************************************
# {replic_expr} = port/signal
# op_expr = {replic_expr};
# {replic_expr} ={replic_expr}
    ...
    print FH "// INVALID TEST $i;\n\n";
     ...
     foreach( my $j=1; $j<=$i; $j++){
        ...
        print FH "  u_a() {\n";
 foreach( my $j=1; $j<=$i; $j++){
        print FH " {2{s1_out}}= out_data$j;          //illegal replicate expression on LHS\n";
        print FH " {3{s2_out}}= out_addr$j;          //illegal replicate expression on LHS\n";
    }
        print FH "  }\n";
        print FH "};\n";
 ...
 foreach( my $j=1; $j<=$i; $j++){
    ...
    print FH "  u_b() {\n";
     ...
     print FH " {3{ wr_sig$j}}= {3{wr_addr$j}};                                //illegal replicate expression on LHS  \n";
     print FH " (p1_data$j & p2_data$j)={2{rf_$j.data_out0, rf_$j.data_out1}};  // illegal to assign a replicate expression to an operation\n";
  ...
  foreach( my $j=1; $j<=$i; $j++){
    ...
    print FH " u_b ub_i$j(.in_data$j({2{s1}}),.wr_addr$j({3{s2}}),.rd0_addr$j({3{s3}}),.rd1_addr$j({3{s4}}));\n";
}
    print FH "   top_$i(){}\n";
    print FH " };\n"; 
    }
...
foreach(my $j=11; $j<=$i; $j++){
    ...
    print FH " ifc_i2={2{s1_$j/2}};     //illegal LHS object\n";
    print FH " ifc_i1={2{s2_$j/5}};     //illegal LHS object\n";
}
print FH "  }\n";
print FH "};\n";
...
print FH " u2_$i(){\n";
foreach(my $j=11; $j<=$i; $j++){
print FH " {sg_i1,sg_i1} ={4{ifc_i3.p_in$j}};                  //illegal LHS object\n";
print FH " ifc_i3 ={{3{sg_i1.sg1_$j}},{2{sg_i2.sg1_$j}}};      //illegal LHS object\n";
print FH " p3_$j ={3{{2{sg_i1}}}};                             //illegal object on replicate_expr\n";
}
print FH "  }\n";
print FH "};\n";
...
foreach(my $j=11; $j<=$i; $j++){
    print FH " u1_i.s1_$j={2{u2_i.ifc_i3}};                                   //illegal object on replicate_expr \n";
    print FH " u2_i.p2_$j={5{u1_i.ifc_i1}};                                   //illegal object on replicate_expr\n";
    print FH " {u2_i.sg_i1.sg1_$j, u2_i.sg_i2.sg1_$j}={2{u1_i.ifc_i1}};       //illegal object on replicate_expr\n";
}
print FH "  }\n";
print FH "};\n";
}
...
print FH "};\n";
    ...
    print FH " u_top_$i(){\n";
foreach(my $j=21; $j<=$i; $j++){
    print FH " ifc2_i1.ifc1_i1={6{sg2_i1.sg1_i1.sig1_$j}};                                            //illegal LHS object\n";
    print FH " sg2_i1.sg1_i1 ={ 2{ifc2_i1.p_out$j}};                                                  //illegal LHS object\n";
    print FH " sg2_i1={6{ifc2_i1.p_in$j}};                                                            //illegal LHS object\n";
    print FH " u1_i1.ifc2_i1.ifc1_i1.p_out$j={3{u1_i2.sg2_i1.sg1_i1 + u1_i2.sg2_i1.sg1_i1}};          //illegal object on replicate_expr\n"; 
    print FH " u1_i1.sg2_i1.sig2_$j={3{ifc2_i1.ifc1_i1}};                                             //illegal object on replicate_expr\n";
}
    print FH " }\n";
    print FH "};\n";
}
...
foreach(my $j=31; $j<=$i; $j++){
    ...
    my $v11_=$v11-1;
    my $v12_=$v12-1;
    print FH " ifc2_i1={2{sg2_i1.sig1_$j [$o:$j1],sg2_i1.sig1_$j [$j:$v11_]}};                                                //illegal LHS object\n";
    print FH " sg2_i1.sig1_$j={2{ifc2_i1.p_in$j [$o:$j1] & ifc2_i1.ifc1_i1.p_in$j [$o:$v11] }};                               //error: different widths\n";

    print FH " ifc2_i1.ifc1_i1.p_out$j [$o:$v11_]={{2{sg2_i1.sg1_i1.sig1_$j [$o:$j]}},{2{sg2_i1.sg1_i1.sig2_$j [$o:$j]}}};    //error: different widths\n";
  
    print FH " u1_i1.ifc2_i1.ifc1_i1.p_out$j [$j1:$v12_]={4{u1_i2.sg2_i1.sg1_i1.sig1_$j [$o:$j] + u1_i2.sg2_i1.sg1_i1.sig2_$j [$o:$j1]}};  //error: different widths on operation expression}\n"; 
    print FH " {u1_i1.sg2_i1.sig2_$j ,u1_i1.sg2_i1.sig1_$j} ={2{{2{ifc2_i1.p_in$j [$j1: 100000111100]}}}};                                //error: number to big for upper index\n";
}
    print FH " }\n";
    print FH "};\n";
}
...
foreach(my $j=41; $j<=50; $j++){
    if($j==41){
    print FH " u1_$i u1_i1(.ifc2_i1.ifc1_i1.p_out$j({2{u1_i2.sg2_i1.sg1_i1.sig1_$j + u1_i2.sg2_i1.sg1_i1.sig2_$j}}), .ifc2_i1.ifc1_i1.p_in$j({3{sg2_i1.sg1_i1}}));\n";    
    print FH " u1_$i u1_i2(.ifc2_i1.ifc1_i1({6{ifc2_i1.p_out$j ^ sg2_i1.sg1_i1.sig2_$j}},.ifc2_i1.ifc1_i1.p_in$j({{4{ifc2_i1.p_in$j}}, sg2_i1.sg1_i1.sig1_$j}));\n";      
    print FH " u2_$i(){\n";
}}
    print FH " }\n";
    print FH "};\n";
    ...
    print FH "    u1_$i u1_i3 (.p11({4{s1}}),.p12({2{s3,s4}}));\n";
    print FH "    u2_$i u2_i1 (.p21({2{s2}}),.p22({2{{2{s5,s6}}}}));\n";
    print FH " top(){}\n";
    print FH " };\n";
}
#*************************************************************
# unit,rf,fifo in replicate_expr
 if($i>50 && $i<=60){
    print FH "//Generated by Monica\n";
    print FH "// Replicate with unit/rf/fifo \n\n";
    print FH "// INVALID TEST $i;\n\n";
    ...
    print FH "  u1_$i(){\n";
 foreach (my $j=51; $j<=$i; $j++){
    print FH " f1_i$j={2{rf1_i$j.data_out0,data_out1}};\n";
    print FH " rf1_i$j={2{f1_i$j}};\n";
}
    print FH " }\n";
    print FH " };\n";
  ...
  foreach (my $j=51; $j<=$i; $j++){
    ...
    print FH "  u2_$i(){\n";
 foreach (my $j=51; $j<=$i; $j++){
    print FH " u1_i$j={2{rf3_i$j}};\n";
    print FH " rf3_i$j={2{u1_i$j}};\n";
    print FH " {u1_i$j.f1_i$j, f2_i$j}={ 2{u1_i$j.rf1_i$j}};\n";
}
    print FH " }\n";
    print FH " };\n";
}
