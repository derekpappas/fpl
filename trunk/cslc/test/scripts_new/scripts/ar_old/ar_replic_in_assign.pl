...
sub main {
    my $i = $_[0];
    my $test_name = "replic_assign_test".$i."_legal.csl";
...
sub createCslFile {
    ...
    if($i==1){
        print ("Generated path: $path/replic_assign_valid/\n");}
    my $val = int(rand(300));
    if($val == 0) { $val = 1; }
    ...
    if($val2==0) {$val2=1;}
    if($test_name=~/(_legal)/){
        &mkDir("$path/replic_assign_valid");
        open(FH,">$path/replic_assign_valid/$test_name");
    }
#*************************************************************
# port/signal ={replic_expr}
    ...
    print FH "// VALID TEST $i;\n\n";
      ...
      foreach( my $j=1; $j<=$i; $j++){
        ...
        print FH "  u_a() {\n";
 foreach( my $j=1; $j<=$i; $j++){
        print FH " s1_out$j =cnt1_$j.reg_out;\n";
        print FH " s2_out$j =cnt2_$j.reg_out;\n";
 ...
 foreach( my $j=1; $j<=$i; $j++){
    ...
    print FH "  u_b() {\n";
     foreach( my $j=1; $j<=$i; $j++){
     print FH " rf_$j.rd_en0=rd_en[0];\n";
     print FH " rf_$j.rd_en1=rd_en[1];\n";
     print FH " wr_sig$j= wr_addr$j;\n";
     print FH " p1_data$j={2{rf_$j.data_out0}};\n";
#     print FH " p2_data$j={{2{rf_$j.data_out0 +  rf_$j.data_out1}}, {3{wr_sig$j}}};\n";
 } 
...
print FH " p2_$j ={{3{sg_i1.sg1_$j}},{2{sg_i2.sg1_$j}}};\n";
...
foreach(my $j=11; $j<=$i; $j++){
    print FH " u1_i.s1_$j={2{u2_i.ifc_i3.p_in$j}};\n";
    print FH " u2_i.p2_$j={5{u1_i.ifc_i1.p_out$j}};\n";
    print FH " {u2_i.sg_i1.sg1_$j, u2_i.sg_i2.sg1_$j}={2{u1_i.ifc_i1.p_in$j}};\n";
}
print FH "  }\n";
print FH "};\n";
}
...
foreach(my $j=21; $j<=$i; $j++){
    ...
    print FH " u1_i1.ifc2_i1.ifc1_i1.p_out$j={3{u1_i2.sg2_i1.sg1_i1.sig1_$j + u1_i2.sg2_i1.sg1_i1.sig2_$j}};\n"; 
    print FH " u1_i1.sg2_i1.sig2_$j={3{ifc2_i1.p_in$j}};\n";
}
    print FH " }\n";
    print FH "};\n";
}
...
foreach(my $j=31; $j<=$i; $j++){
    ...
    my $v11_=$v11-1;
    my $v12_=$v12-1;
    print FH " ifc2_i1.p_out$j={2{sg2_i1.sig1_$j [$o:$j1],sg2_i1.sig1_$j [$j:$v11_]}};\n";
    print FH " sg2_i1.sig1_$j={2{ifc2_i1.p_in$j [$o:$j1] & ifc2_i1.ifc1_i1.p_in$j [$o:$j1] }};\n";

    print FH " ifc2_i1.ifc1_i1.p_out$j [$o:$v12_]={{2{sg2_i1.sg1_i1.sig1_$j [$o:$j]}},{2{sg2_i1.sg1_i1.sig2_$j [$o:$j]}}};\n";
  
    print FH " u1_i1.ifc2_i1.ifc1_i1.p_out$j [$j1:$v12_]={4{u1_i2.sg2_i1.sg1_i1.sig1_$j [$o:$j] + u1_i2.sg2_i1.sg1_i1.sig2_$j [$o:$j]}};\n"; 
    print FH " {u1_i1.sg2_i1.sig2_$j ,u1_i1.sg2_i1.sig1_$j} ={2{{2{ifc2_i1.p_in$j [$j1: $v11_]}}}};\n";
}
    print FH " }\n";
    print FH "};";
}
...
foreach(my $j=41; $j<=50; $j++){
    if($j==41){
    print FH " u1_$i u1_i1(.ifc2_i1.ifc1_i1.p_out$j({3{u1_i2.sg2_i1.sg1_i1.sig1_$j + u1_i2.sg2_i1.sg1_i1.sig2_$j}}), .ifc2_i1.ifc1_i1.p_in$j({3{sg2_i1.sg1_i1.sig1_$j}}));\n";    
    print FH " u1_$i u1_i2(.ifc2_i1.ifc1_i1.p_out$j({3{ifc2_i1.p_out$j ^ sg2_i1.sg1_i1.sig2_$j}}),.ifc2_i1.ifc1_i1.p_in$j({{2{ifc2_i1.p_in$j}}, sg2_i1.sg1_i1.sig1_$j}));\n";      
    print FH " u2_$i(){\n";
}}
    print FH " }\n";
    print FH "};\n";
    ...
    print FH "    u1_$i u1_i3 (.p11({2{s1}}),.p12({4{s3,s4}}));\n";
