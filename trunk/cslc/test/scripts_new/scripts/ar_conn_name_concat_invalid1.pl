...
sub main {
    my ($i,$l, $u) = @_;
    my $test_name = "ar_conn_name_concat$i"."_".$l."_".$u."_illegal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/ar_conn_name_concat_invalid1");
    open(FH,">$path/ar_conn_name_concat_invalid1/$test_name");
    ...
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    {a0.p_a$i,a0.pa}.connect_by_name(s_d$i);\n";
        print FH "    {a0.p,a0.p_a_br$i}.connect_by_name(p_d_br$i);\n";
        print FH "    {c0.p_c$i,c0.pc,c0.p}.connect_by_name(d.p[$u-:$u]);\n";
    }
    elsif($i > 2 && $i <= 4) {
        print FH "    {a0.pa,a0.p_a$i,a0.p}.connect_by_name(s_d$i"."[$u:$l]);\n";
        print FH "    {p,p_d$i}.connect_by_name(b0.p_b".$i."[$u:$l]);\n";
        print FH "    {a0.s_a$i,a0.s_a_br$i}.connect_by_name(pd[$u:$l]);\n";
    }
    elsif($i > 4) {
        print FH "    {c0.p_c_br$i,c0.p}.connect_by_name(s);\n";
        print FH "    {s_d_br$i,s_d$i,sd}.connect_by_name(c0.pc[$u-:$u]);\n";
    }
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    {b0.p_b$i,b0.p}.connect_by_name(s_e_br$i);\n";
        print FH "    {b0.s_b$i,b0.sb,b0.s_b_br$i}.connect_by_name(p_e$i"."[$u:$l]);\n";
        print FH "    {s_e$i,se,s}.connect_by_name(b0.pb[$u-:$u]);\n";
    }
    elsif($i > 1 && $i <= 3) {
        print FH "    {a0.s_a$i,a0.sa}.connect_by_name(p_e$i"."[$u:$l]);\n";
        print FH "    {b0.p_b$i,b0.p_b_br$i}.connect_by_name(s_e$i"."[$u-:$u]);\n";
    }
    elsif($i > 3) {
        print FH "    {b0.p_b_br$i,b0.p}.connect_by_name(p[$u:$l]);\n";
        print FH "    {b0.p,b0.p_b_br$i}.connect_by_name(se);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 2) {
        print FH "    {a0.p_a_br$i,a0.p}.connect_by_name(stop);\n";
        print FH "    {c0.p_c$i,c0.pc,c0.p}.connect_by_name(s_top$i);\n";
        print FH "    {a0.s_a$i,a0.sa}.connect_by_name(d0.p"."[$u-:$u]);\n";
        print FH "    {d0.p_d$i,d0.p}.connect_by_name(ptop);\n";
    }
    elsif($i == 3) {
        print FH "    {a0.p_a$i,a0.pa,a0.p}.connect_by_name(s_top$i);\n";
        print FH "    {b0.p_b$i,b0.p_b_br$i}.connect_by_name(stop);\n";
        print FH "    {c0.s_c$i,c0.sc}.connect_by_name(p[$u:$l]);\n";
        print FH "    {p_top$i,ptop}.connect_by_name(s_e[$u:$l]);\n";
    }
    elsif($i > 3) {
        print FH "    {e0.p_e$i,pe}.connect_by_name(s_top_br$i);\n";
        print FH "    {d0.p_d$i,d0.p}.connect_by_name(s_top_br$i);\n";
        print FH "    {ptop,p_top$i,p}.connect_by_name(d0.b0.p_b$i"."[$u-:$u]);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
