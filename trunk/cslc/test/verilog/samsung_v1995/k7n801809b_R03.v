//
//	File Name: K7N801809A.v
//	Version  : Rev 0.3
//	NOV  30 2001
//
//	Description: ( 8Mb X18 NtSRAM ) 
//
...
`ifdef hc25
	...
	`define		tLZC		0.8		// Clock High to Output Low-Z
	`define		tOH		0.8		// Output Hold from Clock High
...
`ifdef hc22
	...
	`define		tLZC		1.0		// Clock High to Output Low-Z
	`define		tOH		1.0		// Output Hold from Clock High
	`define		tLZOE		0		// Output Enable Low to Output Low-Z
...
module K7N801809B ( Dq, Addr, K, CKEb, 
	   	  Bwa_n, Bwb_n,
	   	  WEb, ADV, OEb,                  
...
if((zz==0)&&( past_adv==0 )&&(past_state==0)&&(past_deselect==0))   // Single Write
 	   ...
 	   //   Write Burst Logic  //
                //////////////////////////
        	//if((zz==0)&&(single_w==1)&&( past_adv==1 ))  // Write Burst
