...
*
*  Description :  K7Q163684A (512K x 36 QDR-b4 SRAM)
*
*  File Name   :  k7q163684a.v
*  Version     :  Rev0.4
*  Date        :  Jan 7th, 2002
*
...
module k7q163684a (D, Q, SA, R_N, W_N, BW_N, K, K_N, C, C_N);

    	// Constant Parameters
    	parameter                   addr_bits =      17;    // This is external address
