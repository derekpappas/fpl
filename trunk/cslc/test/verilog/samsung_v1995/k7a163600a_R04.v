...
*  
*  Description :  K7A163600A (512K x 36)
*
*  File Name   :  k7a163600a.v 
*  Version     :  Rev0.4 
*  Date        :  Jan 30th, 2002
*
...
module k7a163600a (A, ADV_N, ADSP_N, ADSC_N, CLK, CS1_N, CS2, CS2_N, WE_N, OE_N, GW_N, BW_N, ZZ, LBO_N, DQ);
	...
	if (Command_pi[0] === 3'b111) begin
		...
		$display("$m : at time %t : Not select effect!!", $time);
	end
