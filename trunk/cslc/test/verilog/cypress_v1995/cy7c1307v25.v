...
//
//  
//      Model:          CY7C1307V25    QDR-I Burst-of-4
...
//                      below
//      Revision History
//      Rev 1.0-pks     Model Created
`timescale  1ns /  10ps
//
//      NOTE :  Any setup/hold errors will force input signal to x state
//              or if results are in-determinant (write addr) core is reset x
// define fixed values

`define wordsize (36 -1) //Size of the data bus to be defined
`define no_words (131072 -1)            // 4 arrays of 128K x 36 RAM
...
module cy1307( TCK,TMS,TDI,TDO,D, Q, A, K, K_n, RPS_n, WPS_n, BWS0_n, BWS1_n, BWS2_n, BWS3_n, C, C_n,ZQ); 
...
input                   K, K_n, // clock inputs 
                        RPS_n,          // Read Port Select
                        WPS_n,          // Write Port Select
                        ZQ,
                        BWS0_n, BWS1_n, BWS2_n, BWS3_n; // Byte Write Select

input   [16:0]          A;              // address busses
...
wire BWS0_n_o, BWS1_n_o ;       //Previous Copy of BWS0,BWS1
wire [16:0] A;          // address input bus

reg [16:0] Read_Address, Read_Address_o,Read_Address_o_o,Read_Address_o_o_o, Write_Address, Write_Address_o, Write_Address_o_o, Write_Address_o_o_o;
...
reg      samplz_en;             // Signal designed to indicate when an SAMPLZ instruction is entered -- active high
...
wire [`wordsize:0]  chip_out =  !tristate ?  Data_out : 36'bz ; // data bus
...
reg Byte_write_din1_0_o, Byte_write_din1_1_o, Byte_write_din2_0_o, Byte_write_din2_1_o;
reg Byte_write_din1_0_o_o, Byte_write_din1_1_o_o, Byte_write_din2_0_o_o, Byte_write_din2_1_o_o;

wire [`wordsize:0]  Dout =  !tristate ?  Data_out : 36'bz ;     // data bus
...
always @(noti2_1)
begin
        $display("NOTICE      : 020 : BWS0 problem on K_n");
end
...
always @(noti2_3)
begin
        $display("NOTICE      : 020 : BWS1 problem on K_n");
end
...
always @(noti2_5)
begin
        $display("NOTICE      : 020 : BWS2 problem on K_n");
end
...
always @(noti2_7)
begin
        $display("NOTICE      : 020 : BWS3 problem on K_n");
end
...
always @(posedge K)
begin
        Byte_write_din1_0_o_o = Byte_write_din1_0_o;
        Byte_write_din1_1_o_o = Byte_write_din1_1_o;

        Byte_write_din1_0_o = Byte_write_din1_0;
        Byte_write_din1_1_o = Byte_write_din1_1;

        Byte_write_din1_0 <= BWS0_n;
        Byte_write_din1_1 <= BWS1_n;
        Byte_write_din1_2 <= BWS2_n;
        Byte_write_din1_3 <= BWS3_n;
...
always @(posedge  K_n)
begin
        Byte_write_din2_0_o_o = Byte_write_din2_0_o;
        Byte_write_din2_1_o_o = Byte_write_din2_1_o;

        Byte_write_din2_0_o = Byte_write_din2_0;
        Byte_write_din2_1_o = Byte_write_din2_1;

        Byte_write_din2_0 <= BWS0_n;
        Byte_write_din2_1 <= BWS1_n;
        Byte_write_din2_2 <= BWS2_n;
        Byte_write_din2_3 <= BWS3_n;
...
begin 
        state = `reset;
        prev_state = `reset;
        vendor_code = 32'b00001011010011100101000001101001;     // IDCODE for QDR CY7C1307V25 device.This may not be changed.
...
$setuphold(posedge K_n, BWS0_n, `tsc, `thc, noti2_1);
$setuphold(posedge K, BWS1_n,  `tsc, `thc, noti2_2);
$setuphold(posedge K_n, BWS1_n, `tsc, `thc, noti2_3);

$setuphold(posedge K, BWS2_n,  `tsc, `thc, noti2_4);
$setuphold(posedge K_n, BWS2_n, `tsc, `thc, noti2_5);
$setuphold(posedge K, BWS3_n,  `tsc, `thc, noti2_6);
$setuphold(posedge K_n, BWS3_n, `tsc, `thc, noti2_7);
