...
//									     **
//  									     **	
// File name		:		CY7C1308CV25.v			     **
//									     **
// Date			:		April 22nd 2003  		     **	
//									     ** 									   // Model		:		CY7C1308CV25(256K x 36 Four word burst**
...
`define no_words (262144 -1)		// 256KK x 36 RAM 
...
reg	[8:0]	Mem_array_lb [18'h7fffe:0];
reg	[17:9]	Mem_array_ib1 [18'h7fffe:0];
reg	[26:18]	Mem_array_ib2 [18'h7fffe:0];
reg	[35:27]	Mem_array_ub [18'h7fffe:0];
reg	[17:0]	Address_reg; 
reg	[3:0]	BW_reg_pos, BW_reg_neg;
reg	[17:0]  Wr_Address_reg1, Wr_Address_reg2, Wr_Address_reg3;
reg	[17:0]	Rd_Address_reg1, Rd_Address_reg2, Rd_Address_reg3;
...
always @(posedge K)
	...
	if (prev_cycle1 == `Write)
		Wr_Address_reg2[17:2] <= Wr_Address_reg1[17:2];
	if (prev_cycle2 == `Write)
		Wr_Address_reg3[17:2] <= Wr_Address_reg2[17:2];
	if (present_cycle == `Read)
		Rd_Address_reg1 <= Address_reg;
	if (prev_cycle1 == `Read)
		Rd_Address_reg2[17:2] <= Rd_Address_reg1[17:2];
	if (prev_cycle2 == `Read)
		Rd_Address_reg3[17:2] <= Rd_Address_reg2[17:2];
       end
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00001011111011100110000001101001;	// IDCODE for DDR CY7C1308CV25 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
