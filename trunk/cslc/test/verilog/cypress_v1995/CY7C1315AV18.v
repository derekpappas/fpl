...
//
//  
//	Model:	CY7C1315AV18 2M x 36 QDR(tm)-II Burst-of-4 SRAM
// 	Date:		June 4, 2004
//
//	Revision:	1.2
//
...
//	    1.2- Remove setup, hold time requirement on A with respect to Kn
...
module cyqdr2_b4 (TCK,TMS,TDI,TDO,D, Q, A, K, K_n, C, C_n, RPS_n, WPS_n, BWS0_n, BWS1_n, BWS2_n, BWS3_n, CQ, CQ_n,ZQ,DOFF);
...
input 	[16:0] 		A;		// address busses for a 1024K RAM
...
reg [16:0] Read_Address, Read_Address_o,Read_Address_o_o,Read_Address_o_o_o,Read_Address_o_o_o_o, Write_Address, Write_Address_o, Write_Address_o_o, Write_Address_o_o_o;
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011011100101000001101001;	// IDCODE for QDR2 CY7C1315AV18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
...
$setuphold(posedge K_n, BWS3_n, `tsc, `thc, noti2_5);
$setuphold(posedge K, BWS2_n,  `tsc, `thc, noti2_6);
