...
//
//  
//	Model:	CY7C1413V18 4M x 18 QDR(tm)-II Burst-of-4 SRAM
// 	Date:		March 19, 2004
//
//	Revision:	1.0
//
...
`define no_words (524288 -1)	//512K x 18 RAM (uses 4)
...
reg [18:0] Read_Address, Read_Address_o,Read_Address_o_o,Read_Address_o_o_o,Read_Address_o_o_o_o, Write_Address, Write_Address_o, Write_Address_o_o, Write_Address_o_o_o;
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011011010111000001101001;	// IDCODE for QDR2 CY7C1513V18 device. This may not be changed.
