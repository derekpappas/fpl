...
//
//  
//	Model:	CY7C1313AV18 1M x 18 QDR(tm)-II Burst-of-4 SRAM
// 	Date:		March 22, 2004
//
//	Revision:	1.0
//
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011011010101000001101001;	// IDCODE for QDR2 CY7C1313AV18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
