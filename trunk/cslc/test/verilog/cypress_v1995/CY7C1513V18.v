...
//
//  
//	Model:		CY7C1513V18 4M x 18 QDR(tm)-II Burst-of-4 SRAM
// 	Date:		July 23rd, 2003
//
//	Revision:	1.0
//
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011011010100000001101001;	// IDCODE for QDR2 CY7C1513V18 device. This may not be changed.
