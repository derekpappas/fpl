...
*     Websitel:  www.cypress.com/support
*      Company:  Cypress Semiconductor
*       Part #:  CY7C1219H (32K x 36)
*
*  Description:  Cypress 1Mb Synburst SRAM (Pipelined DCD)
*
*
...
module CY7C1219H_PLDCD (ZZ, Mode, ADDR, GW_N, BWE_N, BWb_N, BWa_N, BWc_N, BWd_N, CE1_N, CE2, CE3_N, ADSP_N, ADSC_N, ADV_N, OE_N, DQ, CLK);

    parameter                       addr_bits =     15;         //  	18 bits
    parameter                       data_bits =     36;         //  	18 bits
