...
//									     **
//  									     **	
// File name		:		CY7C1518V18.v			     **
//									     **
// Date			:		July 28th, 2003			     **	
//									     ** 									 
// Model		:		CY7C1518V18(4M x 18 Two word burst   **
...
`define tSC	0.40	//Control signals(BW, WE_bar, LD_bar) setup time
`define tSCddr	0.28	//Control signals(BW, WE_bar, LD_bar) setup time
...
`define tSA	0.40	//Address setup time to K rising edge
`define tSC	0.40	//Control signals(BW, WE_bar, LD_bar) setup time
`define tSCddr	0.30	//Control signals(BW, WE_bar, LD_bar) setup time
...
`define tSC	0.50	//Control signals(BW, WE_bar, LD_bar) setup time
`define tSCddr	0.35	//Control signals(BW, WE_bar, LD_bar) setup time
...
`define tSCddr	0.40	//Control signals(BW, WE_bar, LD_bar) setup time
...
`define no_words (4194304 -1)		// 4Mx18
...
reg	[8:0]	Mem_array_lb [22'h3fffff:0];
reg	[17:9]	Mem_array_ub [22'h3fffff:0];
reg	[21:0]	Address_reg; 
reg	[1:0]	BW_reg_pos, BW_reg_neg;
reg	[21:0]  Wr_Address_reg1, Wr_Address_reg2;
reg	[21:0]	Rd_Address_reg1, Rd_Address_reg2;
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010100010010100000001101001;	// IDCODE for DDR2 CY7C1518V18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
