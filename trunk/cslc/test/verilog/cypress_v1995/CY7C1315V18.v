...
//
//  
//	Model:		CY7C1315V18 2M x 36 QDR(tm)-II Burst-of-4 SRAM
// 	Date:		June 4, 2004
//
//	Revision:	1.2
//
...
//	    1.2- Remove setup, hold requirement on Address with respect to Kn
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011011100101000001101001;	// IDCODE for QDR2 CY7C1315V18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
