...
//
//  
//	Model:	CY7C1514V18 2M x 36 QDR(tm)-II Burst-of-2 SRAM
// 	Date:		July 7, 2003
//
//	Release:	1.0 
//
...
`define no_words (1048576 -1)		// 1M x 36 RAM (Uses 2)
...
reg[19:0] Read_Address, Read_Address_o, Read_Address_o_o, Write_Address;
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011010100100000001101001;	// IDCODE for QDR2 CY7C1514V18 device. This may not be changed.
