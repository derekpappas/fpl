...
//
//  
//	Model:	CY7C1412AV18 2M x 18 QDR(tm)-II Burst-of-2 SRAM
// 	Date:		Sept 29th, 2004
//
//	Revision:	1.0
//
...
//
//	Revision Hisory
//	Rev 1.0-rkf New model created from CY7C1412V18
//
...
`define no_words (1048576 -1)		// 1M x 18 RAM (Uses 2)
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011010010111000001101001;	// IDCODE for QDR2 CY7C1312V18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
