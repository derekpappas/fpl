...
*       Part #:  CY7C1387C (1M x 18)
*
*  Description:  Cypress 18Mb Synburst SRAM (Pipelined DCD)
*
*
...
// Timings for Different Speed Bins (sb):	250MHz, 225MHz, 200MHz, 167MHz
...
module CY7C1387_PLDCD (ZZ, Mode, ADDR, GW_N, BWE_N, BWb_N, BWa_N, CE1_N, CE2, CE3_N, ADSP_N, ADSC_N, ADV_N, OE_N, DQ, CLK);

    parameter                       addr_bits =     20;         //  	19 bits
