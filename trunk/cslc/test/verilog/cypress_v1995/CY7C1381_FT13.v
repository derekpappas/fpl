...
*      Website:  www.sypress.com/support
*      Company:  Cypress Semiconductor
*       Part #:  CY7C1381KV25 (512K X 36)
*
*  Description:  Cypress 18Mb Synburst SRAM (Flow-through)
*
...
`ifdef sb133
        ...
        `define         tCH         	2.1	// Clock HIGH time
        `define         tCL           	2.1	// Clock LOW time

        `define         tCHZ           	4.0	// Clock to High-Z
        `define         tCLZ           	2.0	// Clock to Low-Z

        `define         tOEHZ           4.0	// OE# HIGH to Output High-Z
        `define         tOELZ           0.0	// OE# LOW to Output Low-Z 
        `define         tOEV           	3.2	// OE# LOW to Output Valid 
...
`ifdef sb117
        ...
        `define         tCH             2.3     // Clock HIGH time
        `define         tCL             2.3     // Clock LOW time
...
`ifdef sb100
        ...
        `define         tCLZ            2.0     // Clock to Low-Z
        `define         tOEHZ           5.0     // OE# HIGH to Output High-Z
        `define         tOELZ           0.0     // OE# LOW to Output Low-Z 
        `define         tOEV            3.8     // OE# LOW to Output Valid
...
module CY7C1381_FT (ZZ, MODE, ADDR, GW_N, BWE_N, BWd_N, BWc_N, BWb_N, BWa_N, CE1_N, CE2, CE3_N, ADSP_N, ADSC_N, ADV_N, OE_N, DQ, CLK);
