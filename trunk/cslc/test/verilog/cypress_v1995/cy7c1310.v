...
//
//  
//	Model:		CY7C1310V18 1M x 18 QDR(tm)-II Burst-of-2 SRAM
// 	Date:		April 1st, 2003
//
//	Revision:	1.0
//
...
//
//	Revision Hisory
//	Rev 1.0-pks New model created from qdrii x18 
//
...
`define no_words (1048576 -1)		// 1M x 8 RAM (Uses 2)
...
begin
	...
	begin
		...
		begin
			mem1[Write_Address] = Data_in1[7:0];
		end
		...
		begin
			mem2[Write_Address] = Data_in2[7:0];
		end
	end
end
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011010000101000001101001;	// IDCODE for QDR2 CY7C1310V18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
