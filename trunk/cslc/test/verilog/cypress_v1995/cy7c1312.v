...
//
//  
//	Model:		CY7C1312AV18 1M x 18 QDR(tm)-II Burst-of-2 SRAM
// 	Date:		April 1st, 2002
//
//	Revision:	1.0
//
...
//
//	Revision Hisory
//	Rev 1.0-pks New model created from qdrii x36 
//
...
`define no_words (524288 -1)		// 512K x 18 RAM (Uses 2)
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011010010101000001101001;	// IDCODE for QDR2 CY7C1312AV18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
