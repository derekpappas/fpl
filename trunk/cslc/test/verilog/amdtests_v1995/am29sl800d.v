...
//    V0.1    A.Savic           03 Sept 15    Initial
//    v0.2    A.Savic           03 Sept 22   Access time fix
//                                           PLI call added
//                                           Read status, x16 mode
//                                           Autoselect address out of range
//    v1.0    A.Savic           03 Oct 08    Top/Bottom architecture detect
//    V1.1    A.Savic           03 Dec 10    RY is an open drain output
//                                           Memory declaration
//                                           Erase Suspend timing update
//    v1.2    A.Savic           03 Dec 23    Named block for Sector Address
//                                           window control correctly disabled
//                                           Timing Checks Enable for address
//                                           setup/hold
//                                           Preload Section
//    v1.1   A.Savic            04 Jan 12    VHDL VITAL Check Enable equivalents
//                                           added for address/data setup and
//                                           hold Timing Checks near CE# and WE#
//                                           falling/rising edge
//    v1.2   A.Savic            04 Jan 14    Specify block path expansion for
//                                           unique ModelSim/NCSim Verilog SDF
//    v1.3   A.Savic            04 Jan 16    Preload section update - sector
//                                           contents independent preload
//    v1.4   A.Savic            04 Feb 24    CTMOUT bug fixed
//
//////////////////////////////////////////////////////////////////////////////
//  PART DESCRIPTION:
//
...
////////////////////////////////////////////////////////////////////////////////
        ...
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ1 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ2 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ3 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ4 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ5 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ6 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ7 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ8 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ9 ,  thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ10 , thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ11 , thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ12 , thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ13 , thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ14 , thold_A0_CENeg, Viol);
        $hold ( posedge CENeg &&& CheckEnable_DQ0_CE, DQ15 ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ0  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ1  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ2  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ3  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ4  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ5  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ6  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ7  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ8  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ9  ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ10 ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ11 ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ12 ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ13 ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ14 ,   thold_A0_CENeg, Viol);
        $hold ( posedge WENeg &&& CheckEnable_DQ0_WE, DQ15 ,   thold_A0_CENeg, Viol);
...
// FSM states
 ...
 reg deq;
    ...
    if (tmp_char == "T")
        ...
        begin
           //am29sl800d_prot  sector protect file
           //   //      - comment
        ...
        begin
           //am29sl800d memory preload file
