...
//    V0.1    N.Makljenovic  03 Jul 22   Initial
//    V0.2    A.Savic        03 Aug 29   Changed memory preload file names and
//                                       UserPreload default values
//    V0.3    A.Savic        03 Nov  14   Sector Address time window reset
//                                        Output timing fix ( tOE/tCE/tACC )
//                                        Erase Suspend status fix
//                                        Suspend operation timing fix
//                                        High/Low detect added
//    v0.4    M.Marinkovic   03 Dec 10    RY# is open drain output
//                                        Memory cannot be 2D array
//    v0.5    M.Marinkovic   03 Dec 11    Path delay section corrected
//    v0.6    M.Marinkovic   03 Dec 15    Corrected verilog problem in NCsim
//    v0.7    M.Marinkovic   04 Jan 16    Mem preload changed
//                                        path delay pin-to-pin
//    v0.8    A.Savic        04 Apr 26    Sector Erase Timer reset fix
//
//////////////////////////////////////////////////////////////////////////////
//  PART DESCRIPTION:
//
...
//  Part:           AM29LV256MH/AM29LV256ML
//
//  Description:    256Mbit (16M x16-Bit/32M x8-Bit) Uniform Sector Flash Memory
...
//  internal delays
    ...
    parameter mem_file_name   = "none";//"am29lv256m.mem";
    parameter prot_file_name  = "none";//"am29lv256m_prot.mem";
    parameter secsi_file_name = "none";//"am29lv_secsi.mem";

    parameter TimingModel = "DefaultTimingModel";

    parameter PartID = "AM29LV256MH93R";
    parameter MaxData = 255;
    parameter SecSize = 65535;
    parameter SecSiSize = 255;
    parameter SecNum = 255;  // actual is 511;
...
//    nmos   (RDY ,   RY_zd     , 1);
 ...
 specify
     ...
     specparam   tdevice_WBPB                    = 2950; //ns;
            //Program Operation
     specparam   tdevice_POB                     = 50000; //50 us;
 ...
 reg deq;
    ...
    integer secure_silicon[0:SecSiSize];
        ...
        begin
           ...
           //am29lv320mh_prot  sector protect file
           //   //      - comment
           ...
           // Memory Preload
           //am29lv320m.mem, memory preload file
   ...
   always @(posedge WBPO_in)
   begin:TWBPOr
     #tdevice_WBPB WBPO_out = WBPO_in;
   end
   always @(negedge WBPO_in)
   begin:TWBPOf
     #1 WBPO_out = WBPO_in;
   end
   ...
   always @(posedge SEO_in)
   begin:TSEOr
     #tdevice_SEO SEO_out = SEO_in;
   end
   always @(negedge SEO_in)
   begin:TSEOf
     #1 SEO_out = SEO_in;
   end
...
//    /////////////////////////////////////////////////////////////////////////
   ...
   begin
    ...
    integer i;
    integer j;
            //Resolve architecture - set High to 1'b1 if
            //TimingModel[11] == 'H' or set High to 1'b0 if
            //TimingModel[11] == 'L'

            //Assumptions:
            //1. TimingModel has format as
            //"AM29LV256ML93R"
            //it is important that 11-th character from first
            // one is "H" or "B"
            //2. TimingModel does not have more then 20 characters

            tmp_timing = TimingModel;//copy of TimingModel
            i = 19;
            while ((i >= 0) && (found != 1'b1))
            begin
            ...
            //if non null character is found
            //high/low character is 10 characters right from first ("a")
            if (found)
                for (j=0;j<=7;j=j+1)
                    tmp_char[j] = TimingModel[(i-9)*8+j];
