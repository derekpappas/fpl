...
//    V0.1    A.Savic       03 July 24   Initial
...
//    v0.4    M.Marinkovic  03 Dec 10    RY# is open drain out
//    v0.5    M.Marinkovic  03 dec 11    Path delay secion corrected
//                                       Memory cannot be 2D array
//    v0.6    M.Marinkovic  03 Dec 15    Corrected verilog problem in NCsim
//    V0.7    M.Marinkovic  04 Jan 19    Changed mem preload and path delay
...
//  Part:           AM29LV320MH/L
//
//  Description:    32Mbit (2M x16-Bit/4M x8-Bit) Uniform Sector Flash Memory
//
//
//////////////////////////////////////////////////////////////////////////////
//  Known Bugs:
...
//  internal delays
    ...
    parameter mem_file_name   = "none";//"am29lv320m.mem";
    parameter prot_file_name  = "none";//"am29lv320m_prot.mem";
    parameter secsi_file_name = "none";//"am29lv_secsi.mem";

    parameter TimingModel = "DefaultTimingModel";//"AM29LV320ML90R";

    parameter PartID = "AM29LV320MH";
...
//    nmos   (RDY ,   RY_zd     , 1);
 ...
 specify
     ...
     specparam   tdevice_WBPB                    = 7500; // 7.5 us
            //Program Operation
