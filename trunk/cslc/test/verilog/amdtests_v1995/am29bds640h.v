...
//    V0.1       A.Savic        03 Dec 09   First release
//    V0.2       A.Savic        03 Dec 16   Updated for NC Sim
//    V0.3       A.Savic        03 Dec 18   No bank restriction for Sector Erase
//                                          Erase Suspend / Resume refer to
//                                          all busy / suspended banks
//    V0.4       A.Savic        14 Jan 04   Specify block path expansion for
//                                          unique ModelSim/NCSim Verilog SDF
//    v0.5       A.Savic        04 Jan 19   Preload section update - sector
//                                          contents independent preload
//    v0.6       A.Savic        04 Feb 19   Memory wrap with busy sector check
...
//                                          equivalents added
//                                          Burst halt timing
//    v0.7       A.Savic        04 Jun 28   Aligned to new datasheet revision :
...
//  Part:           AM29BDS640H
//
//  Description:   64 Megabit (4 M x 16-Bit) CMOS 1.8 Volt-only
   ...
   begin
    ...
    if (tmp_char == "5" || tmp_char == "8")
        ...
        Reduced = 1'b0;
            ...
            // To Be Defined
            ASEL_array[8'h0E] = 16'h2200;
            ASEL_array[8'h0F] = 16'h2201;
            if ( ~Reduced )
            // Standard Handshake
    ...
    reg     sector_prot[0:SecNum];
        ...
        begin
           //am29bds640h_prot  sector protect file
           //   //      - comment
        ...
        begin
        //am29bds640h memory preload file
        ...
        // preload last sector in bank B (118) and first one in bank A (119)
        // for burst read mode with bank cross testing
        // address range to be filled is 16#7FF0# to 16#7FFF# within
        // sector 118 and 16#00# to 16#6F# in sector 119
