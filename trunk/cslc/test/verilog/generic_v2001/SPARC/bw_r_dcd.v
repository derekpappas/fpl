...
`else
  `ifdef FPGA_SYN
  `else
                	$error("bw_r_dcd"," rd/wr conflict on single-port");
  `endif
`endif
			end
...
`else
  `ifdef FPGA_SYN
  `else
                	$error("bw_r_dcd"," rd or wr vld is x out of reset");
  `endif
`endif
			end
...
`else
  `ifdef FPGA_SYN
  `else
                	$error("bw_r_dcd"," addr undefined for rd - typ addr");
  `endif
`endif
			end
...
`else
  `ifdef FPGA_SYN
  `else
                	$error("bw_r_dcd"," addr undefined for rd - alt addr");
  `endif
`endif
			end
...
`else
  `ifdef FPGA_SYN
  `else
                	$error("bw_r_dcd"," addr undefined for wr - alt addr");
  `endif
`endif
			end
...
`else
  `ifdef FPGA_SYN
  `else
                	$error("bw_r_dcd"," incorrect addr selected for wr - typ addr");
  `endif
`endif
			end
