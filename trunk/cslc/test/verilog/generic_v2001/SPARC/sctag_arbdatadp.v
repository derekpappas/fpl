...
dff   #(64)  ff_read_mbdata_reg    (.din(mb_data_read_data[63:0]), .clk(en_clk_mbdata),
...
dff     #(64)    ff_data_c1     (.din(arbdp_mux2_data_px2[63:0]), .clk(rclk),
                   .q(arbdp_inst_data_c1[63:0]), .se(se), .si(), .so());


// data ecc data flopped to C9
dff     #(64)    ff_deccdp_data_c9     (.din(deccdp_arbdp_data_c8[63:0]), .clk(rclk), 
...
dff     #(32)    ff_data31to0_c2   (.din(arbdp_wr_data_c1[31:0]), .clk(rclk),
...
dff     #(32)    ff_data63to32_c2   (.din(arbdp_wr_data_c1[63:32]), .clk(rclk), 
...
dff     #(7)    ff_ecc0to6_c2   (.din(arbdp_wr_ecc_c1[6:0]), .clk(rclk),
...
dff     #(7)    ff_ecc7to13_c2   (.din(arbdp_wr_ecc_c1[13:7]), .clk(rclk),
