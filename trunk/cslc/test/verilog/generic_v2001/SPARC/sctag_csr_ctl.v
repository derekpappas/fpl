...
dff     #(3)    ff_word_addr_c7   (.din(arbdp_word_addr_c6[2:0]), 
				.clk(rclk),
                               .q(word_addr_c7[2:0]),
                               .se(se), .si(), .so());
...
dff     #(1)    ff_bist_reg_write_en_d1   (.din(bist_reg_write_en), 
				.clk(rclk),
...
dff     #(1)    ff_control_reg_write_en_d1   (.din(control_reg_write_en), 
				.clk(rclk),
...
dff     #(1)    ff_erren_reg_write_en_d1   (.din(erren_reg_write_en), 
				.clk(rclk),
...
dff     #(1)    ff_errst_reg_write_en_d1   (.din(errst_reg_write_en), .clk(rclk),
...
dff     #(1)    ff_erraddr_reg_write_en_d1   (.din(erraddr_reg_write_en), .clk(rclk),
...
dff     #(1)    ff_errinj_reg_write_en_d1   (.din(errinj_reg_write_en), .clk(rclk),
...
dff     #(3)    ff_mux1_sel_c7   (.din(mux1_sel_c6[2:0]), .clk(rclk),
                               .q(mux1_sel_c7[2:0]),
                               .se(se), .si(), .so());
...
dff     #(1)    ff_err_state_new_c9_ldsu   
...
dff     #(1)    ff_err_state_new_c9_ldau   
...
dff     #(1)    ff_err_state_new_c9_ldwu   
...
dff     #(1)    ff_err_state_new_c9_ldru   
...
dff     #(1)    ff_err_state_new_c9_ldsc   
...
dff     #(1)    ff_err_state_new_c9_ldac   
...
dff     #(1)    ff_err_state_new_c9_ldwc   	
...
dff     #(1)    ff_err_state_new_c9_ldrc   
...
dff     #(1)    ff_rdmard_uerr_c13   
			(.din(rdmard_uerr_c12), .clk(rclk),
                         .q(rdmard_uerr_c13),
                         .se(1'b0), .si(), .so());

dff     #(1)    ff_rdmard_cerr_c13   
...
dff     #(1)    ff_str_ld_hit_c8   (.din(str_ld_hit_c7), .clk(rclk),
                               .q(str_ld_hit_c8),
                               .se(1'b0), .si(), .so());

dff     #(1)    ff_str_ld_hit_c9   (.din(str_ld_hit_c8), .clk(rclk),
                               .q(str_ld_hit_c9),
                               .se(1'b0), .si(), .so());

dff     #(1)    ff_async_bit_c9   (.q(async_bit_c9), .clk(rclk),
...
dff     #(1)    ff_en_por_c7_d1   (.din(en_por_c7), .clk(rclk),
                               .q(en_por_c7_d1),
                               .se(1'b0), .si(), .so());
