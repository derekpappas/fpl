...
// 			   .q(mbf_inst_px2[`L2_POISON:`L2_SZ_LO]), .se(se), .si(), .so());
  ...
  dff   #(7)  ff_read_mbdata_reg_inst1    
			(.din(mb_data_read_data[`MBD_EVICT:`MBD_ENTRY_LO]), 
			.clk(clk_0),
                        .q(mbf_inst_px2[`L2_EVICT:`L2_ENTRY_LO]), .se(se), .si(), .so());

  dff   #(23)  ff_read_mbdata_reg_inst2    
			(.din(mb_data_read_data[`MBD_POISON:`MBD_SZ_LO]), 
			.clk(clk_0),
                        .q(mbf_inst_px2[`L2_POISON:`L2_SZ_LO]), .se(se), .si(), .so());
...
//************************
 ...
 dff     #(11)    ff_inst1_c1    (.din(mux4_inst_px2[`L2_FBF:`L2_ENTRY_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c1[`L2_FBF:`L2_ENTRY_LO]),
                                .se(se), .si(), .so());

 dff     #(11)    ff_inst1_c2    (.din(arbdp_inst_c1[`L2_FBF:`L2_ENTRY_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c2[`L2_FBF:`L2_ENTRY_LO]),
                                .se(se), .si(), .so());

 dff     #(11)    ff_inst1_c3    (.din(arbdp_inst_c2[`L2_FBF:`L2_ENTRY_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c3[`L2_FBF:`L2_ENTRY_LO]),
                                .se(se), .si(), .so());


 dff     #(23)    ff_inst2_c1    (.din(mux4_inst_px2[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c1[`L2_POISON:`L2_SZ_LO]),
                                .se(se), .si(), .so());


 dff     #(23)    ff_inst2_c2    (.din(arbdp_inst_c1[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c2[`L2_POISON:`L2_SZ_LO]),
                                .se(se), .si(), .so());

 dff     #(23)    ff_inst2_c3    (.din(arbdp_inst_c2[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c3[`L2_POISON:`L2_SZ_LO]),
                                .se(se), .si(), .so());


 dff     #(23)    ff_inst2_c4    (.din(arbdp_inst_c3[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c4[`L2_POISON:`L2_SZ_LO]),
                                .se(se), .si(), .so());

 dff     #(23)    ff_inst2_c5    (.din(arbdp_inst_c4[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c5[`L2_POISON:`L2_SZ_LO]),
                                .se(se), .si(), .so());


 dff     #(23)    ff_inst2_c6    (.din(arbdp_inst_c5[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c6[`L2_POISON:`L2_SZ_LO]),
                                .se(se), .si(), .so());


 dff     #(23)    ff_inst2_c7    (.din(arbdp_inst_c6[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
                               .q(arbdp_inst_c7[`L2_POISON:`L2_SZ_LO]),
                                .se(se), .si(), .so());

 dff     #(23)    ff_inst2_c8    (.din(arbdp_inst_c7[`L2_POISON:`L2_SZ_LO]),
                                .clk(rclk),
