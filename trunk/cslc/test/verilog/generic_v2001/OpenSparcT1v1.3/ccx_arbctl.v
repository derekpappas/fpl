...
//flop and drive data ready signal
      dff #(1) dff_ccx_com_dr(                              //relocate this flop to ctl 
...
//   dff #(16) dff_ccx_com_fifo_wrptrd1(
   dff #(5) dff_ccx_com_fifo_wrptrd1(
            .din           (wrptr[4:0]),
	    .q             (wrptr_d1[4:0]),
	    .clk           (rclk),
	    .se            (1'b0),
...
//            .din           (rdptr[15:0]),
   dff #(5) dff_ccx_com_fifo_rdptrd1(
            .din           (rdptr_mux[4:0]),
	    .q             (rdptr_d1[4:0]),
	    .clk           (rclk),
	    .se            (1'b0),
   ...
   dff #(1) dff_ccx_com_fifo_emptyd1(
            .din           (fifo_empty_d1),
	    .q             (fifo_empty_d2),
	    .clk           (rclk),
	    .se            (1'b0),
   ...
   dff #(1) dff_ccx_com_fifo_bypassd1(
            .din           (fifo_bypass),
	    .q             (fifo_bypass_d1),
	    .clk           (rclk),
	    .se            (1'b0),
   ...
   dff #(1) dff_ccx_com_fifo_fifoseld1(
            .din           (fifo_req_sel),
	    .q             (fifo_req_sel_d1),
	    .clk           (rclk),
	    .se            (1'b0),
      ...
      dff #(1) dff_ccx_com_fifo_currseld1(
            .din           (current_req_sel),
