...
dffre     #(1)    ff_csr_l2_control_reg_0   (.din(csr_l2_control_prev_0_l), 
...
// other mode bits
//////////////
dffre     #(2)    ff_csr_l2_control_reg_2to1   (.din(csr_l2_control_prev[2:1]), 
		.en(csr_ctl_wr_en_c8), .rst(~dbb_rst_l) ,
...
// scrub interval.
//////////////
dffre      #(12)    ff_csr_l2_control_reg_scb_int   (.din(csr_l2_control_prev[14:3]), 
		.en(csr_ctl_wr_en_c8), .rst(~dbb_rst_l) ,
...
// steering bits + dbgen
//////////////
dffre     #(5)    ff_csr_l2_control_reg_steering   (.din(csr_l2_control_prev[19:15]), 
		.en(csr_ctl_wr_en_c8), .rst(~dbb_rst_l) ,
...
dffe     #(1)    ff_csr_l2_control_reg_dbg   (.din(csr_l2_control_prev[20]), 
		.en(csr_ctl_wr_en_c8), 
...
// Directory clear bit.
//////////////
dffre     #(1)    ff_csr_l2_control_reg_dir_clr   (.din(csr_l2_control_prev[21]), 
		.en(csr_ctl_wr_en_c8), .rst(~dbb_rst_l) ,
...
dff     #(1)    ff_dir_clr_d1   (.din(csr_l2_control_reg[21]), .clk(rclk),
		.q(dir_clr_d1), .se(se), .si(), .so());

dff     #(1)    ff_dir_clr_d2   (.din(dir_clr_d1), .clk(rclk),
...
/////////////////////////////////////////////////////////
	...
	dff     #(32)    ff_scrub_count   (.din(scrub_counter_p[31:0]), .clk(rclk),
...
/////////////////////////////////////////////////////////
	...
	dffre     #(3)    ff_csr_l2_erren_d1   (.din(csr_l2_erren_prev[2:0]), 
...
dff     #(5)    ff_inst_tid_c9   (.q(inst_tid_c9[4:0]), .clk(rclk),
                               .din(oqdp_tid_c8[4:0]),
                               .se(se), .si(), .so());
...
dffe    #(1)    ff_async_bit (.din(csr_l2_errstate_prev[`ERR_ASYNC]), .clk(rclk),
...
dffe     #(1)    ff_csr_l2_errrw_d1 (.din(csr_l2_errstate_prev[`ERR_RW]), .clk(rclk),
...
dff     #(1)    ff_csr_l2_errmeu_d1 (.din(csr_l2_errstate_prev[`ERR_MEU]), 
			.clk(rclk),
                 	.q(csr_l2_errstate_reg[`ERR_MEU]),
                 	.se(se), .si(), .so());

dff     #(1)    ff_csr_l2_errmec_d1 (.din(csr_l2_errstate_prev[`ERR_MEC]), 
			.clk(rclk),
                 	.q(csr_l2_errstate_reg[`ERR_MEC]),
                 	.se(se), .si(), .so());

dff    #(19)    ff_csr_l2_errstate_d1
...
dff     #(1)    ff_sctag_clk_tr (.din(sctag_clk_tr_prev),
			.clk(rclk),
                 	.q(sctag_clk_tr),
                 	.se(se), .si(), .so());
...
dffe     #(36)    ff_csr_l2_erraddr_d1   (.din(csr_l2_erraddr_prev[39:4]),
...
dff     #(64) ff_csr_rd_data_c8   (.din(csr_rd_data_c7[63:0]),
        		.clk(rclk), 
