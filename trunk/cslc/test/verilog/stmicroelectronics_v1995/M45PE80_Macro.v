/////////////////////////////////////////////////////////////////////////////////////////
//
// File:           - M45PE80_Macro.v
// Date:           - July 2004
// Author:         - Xue-feng Hu at MPG Memory Competence Center of China
// Description:    - Define macro regarding characteristics of M45PE80 SPI flash memory 
...
//             1.0:     2004/3/26 build a new "Macro" file for M45PE80
...
//=======================================================================================
`define DATA_BITS           8
`define MEM_SIZE            1048576         //8M bits = 1M bytes
`define MEM_ADDR_BITS       20              //memory address bits
`define PAGES               4096            //4096 pages
`define PAGE_SIZE           256             //256 bytes in each page
`define PAGE_ADDR_BITS      12              //page address bits
`define PAGE_OFFSET_BITS    8               
`define SECTORS             16              //16 sectors
`define SECTOR_SIZE         65536           //64K bytes in each sector
`define SECTOR_ADDR_BITS    4
