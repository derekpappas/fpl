...
`define SIZE               1048576     // 1 Mbits
`define PLENGTH            256         // page length (in bytes)
`define SSIZE              262144      // Sector size (in bytes)
`define NB_BPI             2           // number of BPi bits
`define SIGNATURE          8'b00010000 // electronic signature
`define BIT_TO_CODE_MEM    17          // number of bit to code a 1Mbits memory
...
`define TRES1  3000        // notS high to Stand-By power mode without ID Read
...
`define Tbase  1000000000  // time base( 1s)   
