...
`define SIZE               4194304*16  // 64 Mbit //040525 hu
`define PLENGTH            256         // page length 256 bytes
`define SSIZE              524288      // Sector size 512 kbits
`define NB_BPI             3           // number of BPi bits
`define SIGNATURE          8'h16       // electronic signature 16h
`define manufacturerID     8'h20       // Manufacturer ID
`define memtype            8'h20       // memorytype
`define density            8'h17       // memory density 64mbits

`define BIT_TO_CODE_MEM    23          // number of bit to code a 64Mbits(8Mbytes) memory
...
`define TBE    160           // bulk erase cycle time (160s)
