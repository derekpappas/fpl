/////////////////////////////////////////////////////////////////////////////////////////
//
// File:           - M45PE10_Memory.v
// Date:           - July 2004
// Author:         - Xue-feng Hu at MPG Memory Competence Center of China
// Description:    - M45PE10 SPI Bus Flash Memory Verilog Simulation Model
...
//=====================================
// M45PE10 memory simulation model
//=====================================
module M45PE10  (
                    C,
                    D,
...
parameter       memory_capacity         = 8'h11;
...
begin
    ...
    begin
        if(i==0)
        begin
            if(memory_address[`MEM_ADDR_BITS-1:0] == `MEM_ADDR_BITS'h1ffff)
