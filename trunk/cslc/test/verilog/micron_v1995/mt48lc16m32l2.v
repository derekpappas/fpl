...
*        Model:  mt48lc16m32l2 (2Meg x 32 x 4 Banks)
*
*  Description:  Micron 512 SDRAM Twin Die Verilog model
*
...
* ---  --------------------------  ---------------------------------------
* 2.1  dritz           03/23/2005  - mt48lc16m32l2 Fixed dqm mask bits and functionality
...
module mt48lc16m32l2 (Dq, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, dqm);

`include "parameters_mt48lc16m32l2.v"

    parameter addr_bits =       13;
    parameter data_bits =       32;
    parameter col_bits  =        9;
    parameter mem_sizes =  4194304;  //2Meg part
