...
*        Model:  mt48lc16m32s2 (4Meg x 32 x 4 Banks)
*
...
* ---  --------------------------  ---------------------------------------
* 2.2  dritz           03/23/2005  - MT48LC16M32S2
* 2.1  dritz           03/23/2005  - Fixed dqm mask bits and functionality
...
module mt48lc16m32s2 (Dq, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, dqm);

`include "parameters_mt48lc16m32s2.v"

    parameter addr_bits =       13;
    parameter data_bits =       32;
    parameter col_bits  =        9;
    parameter mem_sizes =  4194304;  //4Meg part
