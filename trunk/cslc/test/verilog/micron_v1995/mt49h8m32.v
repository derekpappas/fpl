...
*  Part Number:  MT49H8M32 (1Meg x 32 x 8 Banks)
*
...
* ---  --------------------------  ---------------------------------------
* 1.3  SH              08/09/2002  - Update DVLD signal
*      Micron Technology Inc.
*
* 1.2  SH              01/23/2002  - Fix race condition problem
*      Micron Technology Inc.      - Improve signals skew handling
*
* 1.1  SH              10/29/2001  - Fix DVLD signal
*      Micron Technology Inc.      - Add Data Mask for Write
*
* 1.0  SH              06/18/2001  - Initial release
*      Micron Technology Inc.
*
**************************************************************************/
...
module mt49h8m32 (Dq, Dvld, Dqs, Dqs_n, Clk, Clk_n, Cs_n, As_n, We_n, Ref_n, Addr, Bank, Dm);
