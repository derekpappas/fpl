...
//    V1.1    M.Radmanovic   05 Apr 04    Changed reset implementation due to
//                                        datasheet update, fixed coding style
//    V1.2    M.Radmanovic   05 Aug 02    The Toggle Bits will not change if
//                                        you read a new address without
//                                        toggling OE#. OE#, CE# are
//                                        independent of each other
//    V1.3    T.Popovic      05 Aug 16    Programming of corrupted locations
//                                        not allowed.
//    V1.4    D.Randjelovic  06 Feb 27    Implemented SPEEDSIM option
...
//  Part:           S29GL512N
//
//  Description:    512Mbit (x8/x16) Page mode Flash Memory
//
//////////////////////////////////////////////////////////////////////////////
//  Known Bugs:
//
...
// FSM states
    ...
    always @(oe_toggle_event)
    begin
        oe_toggle = 1'b1;
        #1 oe_toggle = 1'b0;
    end

    always @(oe or oe_toggle or reseted or current_state)
    begin
        if (reseted)
        begin
        case (current_state)
