...
void c0::createInstVec(std::string inst) { 
  ...
  stimVecFile_c0 = NSSystemCVW::sc_create_vec_file(stimName,2,4);
  ((NSSystemCVW::vec_file*)stimVecFile_c0)->sc_set_vcd_time_unit(-9);
  expVecFile_c0 = NSSystemCVW::sc_create_vec_file(expName,2,4);
  ((NSSystemCVW::vec_file*)expVecFile_c0)->sc_set_vcd_time_unit(-9);

  sc_trace(stimVecFile_c0, ar_sa0_s10, std::string("ar_sa0_s10") );
...
void c0::createInstVcd(std::string inst) { 
  ...
  stimVecFile_c0 = sc_core::sc_create_vcd_trace_file(stimName);
  ((vcd_trace_file*)stimVecFile_c0)->sc_set_vcd_time_unit(-9);
  expVecFile_c0 = sc_core::sc_create_vcd_trace_file(expName);
  ((vcd_trace_file*)expVecFile_c0)->sc_set_vcd_time_unit(-9);
...
c0::c0(sc_core::sc_module_name c0)  :
	fpl_module(c0) {

  b0_ = new b0("b0_");
  b0_->ar_sa0_s10(ar_sa0_s10);
