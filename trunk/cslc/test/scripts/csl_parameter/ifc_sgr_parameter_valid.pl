...
print "Generated path: $path"."ifc_sgr_parameter_valid/ \n";
...
sub createCslFile {
    ...
    print FH "//Test cases from: table_csl_parameter.ods\n";
    if($i <= 30) {
    ...
    if($i>30 ){
    print FH "  csl_port p_ifa1(input,$val5);\n";
    ...
    print FH "  csl_port p_ifca(input,ifb_x);\n";
    print FH "  csl_port p_ifa(input,ifb_y);\n";
    print FH "  csl_port pt_ita(output,ifb_z);\n";
    if($i > 10 ) {
        print FH "  csl_parameter ifcb_t($val4);\n";
  #      print FH "  csl_port p_icb(output,ifcb_t);\n";
    ...
    if($i>30 ){
      print FH "  csl_port p_b(output,$val45);\n";
    ...
    if($i > 10 && $i <= 15){
        print FH "csl_interface ifcd {\n";
        print FH "  csl_parameter ifcd_x($val41,30);\n";
        print FH "  csl_parameter ifcd_y($val43,27);\n";
        print FH "  csl_parameter ifcd_z($val45,32);\n";
        print FH "  csl_parameter ifcd_t($val47,28);\n";
        print FH "  csl_port p_ifcd(input,ifcd_x);\n";
        ...
        print FH "  csl_parameter ifce_v($val43);\n";
        print FH "  csl_port p_ifce(input,ifce_x);\n";
        print FH "  csl_port p_ife(input,ifce_z);\n";
        print FH "  csl_port p_iftce(output,ifce_y);\n";
    ...
    if($i > 30) {     
       ...
       print FH "csl_signal_group sga{\n";
        ...
        print FH "  csl_signal p_ifca(sga_z);\n";
        print FH "  csl_signal p_ifa(sga_x);\n";
        print FH "  csl_signal p_ifa1(sga_y);\n";
        print FH "  sga(){}\n";
        print FH "};\n\n";
        
        print FH "csl_signal_group sgb{\n";
        print FH "  sga sga0;\n";
        print FH "  csl_parameter sgb_x($val43,20);\n";
        print FH "  csl_parameter sgb_y($val41,30);\n";
        print FH "  csl_parameter sgb_z($val49,$val50);\n"; 
        print FH "  csl_parameter sgb_t($val45,$val46);\n";
        print FH "  csl_signal p_ifca(sgb_z);\n";
        print FH "  csl_signal p_ifa(sgb_x);\n";
        print FH "  csl_signal pt_ita(sgb_y);\n";
        print FH "  csl_signal p_b(sgb_t);\n";    
        print FH "  sgb(){}\n";
        print FH "};\n\n";
 if($i > 35) { 
       
        print FH " csl_interface ifcc {\n";
        print FH "  csl_parameter ifcc_x($val15 \'b$val16);\n";
        print FH "  csl_parameter ifcc_y($val33 \'h$val34);\n";
        print FH "  csl_parameter ifcc_z($val23 \'o$val24);\n"; 
        print FH "  csl_parameter ifcc_t($val17 \'b$val18);\n";
        print FH "  csl_parameter ifcc_s($val25 \'o$val26);\n";
        print FH "  csl_port s_sgc(input,ifcc_z);\n";
        print FH "  csl_port s_c(input,ifcc_y);\n";
        print FH "  csl_port s_sc(input,ifcc_x);\n";
        print FH "  csl_port s_sgrc(input,ifcc_t);\n";
        print FH "  csl_port s_src(input,ifcc_s);\n";
        print FH "  ifcb ifcb0;\n";
        print FH "  ifcc(){}\n";
        print FH "};\n\n";
  ...
  if($i > 35) {  
    ...
    #    print FH "  csl_port pa(input,a_x);\n";
        ...
        print FH "  ifcb #(.ifb_x($val5)) ifcb1;\n";
        print FH "  a(){\n";
        print FH "  }\n";
        print FH "};\n\n";
    }
    if($i > 10 && $i <= 15){
        ...
        print FH "  csl_parameter b_z($val1);\n";
        print FH "  csl_port p_b(input,b_x);\n";
        print FH "  csl_port p_b1(input,b_x);\n";
        print FH "  csl_port pb(output,b_z);\n";
        print FH "  ifce #(.ifce_v($val2)) ifce2;\n";
        print FH "  ifcd ifcd1;\n";
        print FH "  ifca #(.ifa_x($val1)) ifca1;\n";
        print FH "  ifcb #(.ifb_x($val1)) ifcb1;\n";
	print FH "  a #(.a_z($val2),.a_y($val2)) a0(.ifca4(ifca1),.ifcb1(ifcb1),.pta(p_b1),.p_a(p_b));\n";
        print FH "  b(){}\n";
        print FH "};\n\n";
    }
   if($i > 15 && $i <= 20){
        ...
        print FH "  csl_parameter b_z($val1);\n";
        print FH "  csl_port p_b(input,b_x);\n";
        print FH "  csl_port p_b1(input,b_z);\n";
 ...
 print FH "csl_unit b{\n";
        ...
        print FH "  csl_port p_b(input,b_x);\n";
        print FH "  csl_port p_b1(input,b_z);\n";
        print FH "  csl_port p_s(input,$val3);\n";
        print FH "  csl_port pt_b(output,b_x);\n";
        print FH "  ifce ifce1;\n";
        print FH "  ifcf ifcf1;\n";
        print FH "  b(){}\n";
        print FH "};\n\n";
    ...
    if($i <= 5) {
        print FH "  ifca ifca1;\n";
        print FH "  ifcb ifcb1;\n";
        print FH "  b #($val3,$val2) b0(.p_b(s_top),.pb(p_top),.ifca1(ifca1),.ifcb1(ifcb1));\n";
    }
...
#        print FH "  ifca #(,,$val1,$val3) ifca1;\n";
         print FH "  a #(.a_z($val2)) a0(.ifca4(ifca5),.pta(p_top),.p_a(s_top),.ifcb1(ifcb0));\n";   
    ...
    if($i > 10 && $i <= 15){
        ...
        print FH "  ifcb ifcb1;\n";
        print FH "  ifca ifca1;\n";  
        print FH "  b #(.b_z($val2)) b0(.pb(pt_top),.ifce2(ifce1),.ifcd1(ifcd2),.ifca1(ifca1),.ifcb1(ifcb1),.p_b(p_b),.p_b1(p_b1));\n";
    
    }
    if($i > 15 && $i <= 20) {
        print FH "  csl_signal st_top(top_y);\n";
        print FH "  ifcb  ifcb2;\n";
        print FH "  b #(.b_z($val3)) b2(.p_b(p_top),.p_b1(s_top),.pb(st_top),.ifcb1(ifcb2));\n";
	...
	print FH "  b #(.b_z($val23 \'o$val24)) b0(.p_b(p_top),.p_b1(ptop),.p_s(s_top),.pt_b(pt_t),.ifce1(ifce0),.ifcf1(ifcf0));\n";
    }
    if($i > 30){
        print FH "  sga sga1;\n"; 
        print FH "  sgb sgb1;\n";
        print FH "  ifca #(,$val2) ifca1;\n";
        print FH "  ifcb #($val49,$val43,$val41,)  ifcb1;\n"; 
      if($i <=35){
        print FH " b #(,$val3) b1(.ifca0(sga1),.ifcb0(sgb1),.p_b(p_top),.pb(s_top));\n";
	}
    }
    if($i > 35) {
        print FH "  sgc sgc0;\n";
        ...
        print FH " b #(,$val3) b1(.ifca0(sga1),.ifcb0(sgb1),.p_b(p_top),.pb(s_top),.ifcd0(ifcd2),.ifce0(ifce1),.ifcc0(sgc0));\n";
    ...
    if($i > 30){
        print FH "    b1.sga0.connect_by_name(ifca1);\n";
        print FH "    b1.sgb0.connect_by_name(ifcb1);\n";
