...
print "the path to the generated tests is : $path"."conn_pattern_concat_ifc_sg_invalid1/ \n";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val5);
    &mkDir("$path/conn_pattern_concat_ifc_sg_invalid1");
    open(FH,">$path/conn_pattern_concat_ifc_sg_invalid1/$test_name");
    print FH "//Generated by Petronela\n";
    print FH "//testing the cmd connect_by_pattern for connections ifc.p to concat exp.,sg.sig to concat expr. \n\n";
    ...
    print FH "  d() {\n";
    if($i <= 15) {
        print FH "    ifca5.p_ifca$i.connect_by_pattern({c0.b0.a0.p_a$i,c0.b0.a0.pa},$word);\n";
        print FH "    sgd5.s_sggd.connect_by_pattern({c1.b0.a1.p,c1.b0.a1.p_a_br$i},$word1);\n";
        print FH "    c0.ifcb4.p_ifb.connect_by_pattern({p_c$i,pc,p},$word2);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    c1.sgb4.s_sigb.connect_by_pattern({c0.b1.a1.pa,c0.b1.a1.p_a$i,p},$word);\n";
        print FH "    c0.ifcb4.ifca0.p_ifca$i.connect_by_pattern({p,p_d$i},$word1);\n";
        print FH "    c0.b1.ifcd3.ifcb0.ifca0.p_if.connect_by_pattern({c1.b1.a0.s_a$i,c1.b1.a0.s_a_br$i},$word2);\n";
    }
    elsif($i > 30) {
        print FH "    c0.b0.sgd3.sgb0.s_sb.connect_by_pattern({c1.cp_c_br$i,c1.p},$word);\n";
        print FH "    c0.ifcd4.p_iftd$i.connect_by_pattern({s_d_br$i,s_d$i,sd},$word1);\n";
    }
    ...
    print FH "  e() {\n";
    if($i <= 15) {
        print FH "    d0.c0.a0.ifca2.p_ifa.connect_by_pattern({d0.c0.b1.p_b$i,d0.c0.b1.p},$word2);\n";
        print FH "    ifcd6.ifcb0.p_ifcb$i.connect_by_pattern({b0.s_b$i,b0.sb,s_b_br$i},$word3);\n";
        print FH "    b0.sga3.s_sga.connect_by_pattern({s_e$i,se,s},$word4);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    b0.a1.ifcd2.p_if.connect_by_pattern({d1.c1.b1.a1.s_a$i,d1.c1.b1.a1.sa},$word2);\n";
        print FH "    d1.c0.b1.sgb3.s_sgb.connect_by_pattern({d0.c0.b0.p_b$i,d0.c0.b0.p_b_br$i},$word3);\n";
    }
    elsif($i > 30) {
        print FH "    ifca6.p_if.connect_by_pattern({e.b0.p_b_br$i,e.b0.p},$word2);\n";
        print FH "    d1.c0.sgb4.s_sigb.connect_by_pattern({d1.c0.b0.p,d1.c0.b0.p_b_br$i},$word3);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 15) {
        print FH "    sgb7.sga0.s_sigga.connect_by_pattern({d0.c0.a0.p_a_br$i,d0.c0.a0.p},$word5);\n";
        print FH "    e1.d0.c0.b0.a1.ifcd2.ifcb1.ifca1.p_ifca$i.connect_by_pattern({d0.c1.p_c$i,d0.c1.pc,d0.c1.p},$word6);\n";
        print FH "    d0.ifcb5.p_if.connect_by_pattern({e0.d0.c1.b1.a1.s_a$i,e0.d0.c1.b1.a1.sa},$word7);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    e0.d0.c0.sgd4.s_siggd.connect_by_pattern({d1.c0.a0.p_a$i,d1.c0.a0.pa,d1.c0.a0.p},$word5);\n";
        print FH "    d0.sgb5.sga1.s_sa.connect_by_pattern({e0.b0.p_b$i,e0.b0.p_b_br$i},$word6);\n";
        print FH "    e1.b0.ifcd3.p_ifd.connect_by_pattern({d1.c1.s_c$i,d1.c1.sc},$word7);\n";
    }
    elsif($i > 30) {
        print FH "    d1.c0.a0.ifcd2.p_ifcd$i.connect_by_pattern({e0.p_e$i,pe},$word5);\n";
        print FH "    sgd7.s_sd.connect_by_pattern({e1.d1.p_d$i,e1.d1.p},$word6);\n";
        print FH "    d0.c0.ifcb4.p_ifcb$i.connect_by_pattern({ptop,p_top$i,p},$word7);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
