...
print "the path for the generated tests is : $path"."conn_pattern_concat_pps_sps_invalid/ \n";
...
my @lower = (0,5,11,23,29);
my @upper = (42,54,66,78,90);
...
sub main {
    my ($i,$l, $u) = @_;
    my $test_name = "conn_pattern_concat_pps_sps$i"."_".$l."_".$u."_illegal.csl";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val5);
    &mkDir("$path/conn_pattern_concat_pps_sps_invalid");
    open(FH,">$path/conn_pattern_concat_pps_sps_invalid/$test_name");
    print FH "//Generated by Petronela\n";
    print FH "//testing the cmd connect_by_pattern for connections port to concat exp.,signal to concat expr., port[part select] to concat expr., signal[part select] to concat expr.\n\n";
    print FH "csl_bitrange br($w);\n";
    print FH "csl_bitrange brt($val2);\n";
    #print FH "csl_filed f1($val1),f2($val2);\n";
    print FH "csl_unit a {\n";
    if($i <= 2) {
    ...
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    s_d$i.connect_by_pattern({c0.b0.a0.p_a$i,c0.b0.a0.pa},$word);\n";
        print FH "    p_d_br$i.connect_by_pattern({c1.b0.a1.p,c1.b0.a1.p_a_br$i},$word1);\n";
        ...
        print FH "    s.connect_by_pattern({c1.cp_c_br$i,c1.p},$word);\n";
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    s_e_br$i.connect_by_pattern({d0.c0.b1.p_b$i,d0.c0.b1.p},$word2);\n";
        ...
        print FH "    se.connect_by_pattern({d1.c0.b0.p,d1.c0.b0.p_b_br$i},$word3);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 2) {
        print FH "    stop.connect_by_pattern({d0.c0.a0.p_a_br$i,d0.c0.a0.p},$word5);\n";
        print FH "    s_top$i.connect_by_pattern({d0.c1.p_c$i,d0.c1.pc,d0.c1.p},$word6);\n";
        print FH "    d0.p"."[$u:$l].connect_by_pattern({e0.d0.c1.b1.a1.s_a$i,e0.d0.c1.b1.a1.sa},$word7);\n";
    }
    elsif($i == 3) {
        print FH "    s_top$i.connect_by_pattern({d1.c0.a0.p_a$i,d1.c0.a0.pa,d1.c0.a0.p},$word5);\n";
        print FH "    stop.connect_by_pattern({e0.b0.p_b$i,e0.b0.p_b_br$i},$word6);\n";
        print FH "    p[$u:$l].connect_by_pattern({d1.c1.s_c$i,d1.c1.sc},$word7);\n";
    }
    elsif($i > 3) {
        print FH "    s_top_br$i.connect_by_pattern({e0.p_e$i,pe},$word5);\n";
        print FH "    s_top_br$i.connect_by_pattern({e1.d1.p_d$i,e1.d1.p},$word6);\n";
