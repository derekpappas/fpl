...
print "the path for generated tests is : $path"."conn_units_p_ps_s_ps_ifc_sg_invalid/ \n";
...
sub main {
    my ($i,$l, $u) = @_;
    my $test_name = "connect_units_p_ps_s_ps_ifc_sg$i"."_".$l."_".$u."_illegal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/conn_units_p_ps_s_ps_ifc_sg_invalid");
    open(FH,">$path/conn_units_p_ps_s_ps_ifc_sg_invalid/$test_name");
    
    print FH "//Generated by Petronela\n";
    print FH "//testing the method connect_units for connections port[part select] to ifc, signal[part select] to ifc, ifc to port[part select] and ifc to signal[part select]\n";
    print FH "// and port[part select] to signal_group, signal[part select] to signal_group, signal_group to port[part select] and signal_group to signal[part select]\n\n";
    ...
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    s_d$i"."[$u:$l].connect_units(a0.ifca1);\n";
        print FH "    c0.ifcb0.connect_units(s_d_br$i"."[$u:$l]);\n";
        print FH "    p_d$i"."[$u-:$l].connect_units(b0.ifca1);\n";
        print FH "    s_d$i"."[$u:$l].connect_units(a0.sga1);\n";
        print FH "    c0.sgb0.connect_units(s_d_br$i"."[$u:$l]);\n";
        print FH "    p_d$i"."[$u-:$l].connect_units(b0.sga1);\n";
    }
    elsif($i > 2 && $i <= 4) {
        print FH "    p_d$i"."[$u:$l].connect_units(b0.ifcb0);\n";
        print FH "    b0.ifcb0.connect_units(d.p[$u:$l]);\n";
        print FH "    c0.ifca1.connect_units(s_a$i"."[$u:$l]);\n";
        print FH "    p_d$i"."[$u:$l].connect_units(b0.sgb0);\n";
        print FH "    b0.sgb0.connect_units(d.p[$u-:$l]);\n";
        print FH "    c0.sga1.connect_units(s_a$i"."[$u:$l]);\n";
    }
    elsif($i > 4) {
        print FH "    s_d$i"."[$u:$l].connect_units(a0.ifcb0);\n";
        print FH "    c0.ifca1.connect_units(p_d$i"."[$u:$l]);\n";
        print FH "    s_d$i"."[$u:$l].connect_units(a0.sg0);\n";
        print FH "    c0.sga1.connect_units(p_d$i"."[$u-:$l]);\n";
    }
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    s_e_br$i"."[$u:$l].connect_units(a0.ifca1);\n";
        print FH "    b0.ifcb0.connect_units(s_e$i"."[$u:$l]);\n";
        print FH "    b0.pb[$u:$l].connect_units(ifca3);\n";
        print FH "    s_e_br$i"."[$u-:$l].connect_units(a0.sga1);\n";
        print FH "    b0.sgb0.connect_units(s_e$i"."[$u:$l]);\n";
        print FH "    b0.pb[$u:$l].connect_units(sga3);\n";
    }
    elsif($i > 1 && $i <= 3) {
        print FH "    p_e$i"."[$u:$l].connect_units(c0.ifcb0);\n";
        print FH "    s_e_br$i"."[$u:$l].connect_units(b0.ifcb0);\n";
        print FH "    p_e$i"."[$u-:$l].connect_units(c0.sgb0);\n";
        print FH "    s_e_br$i"."[$u:$l].connect_units(b0.sgb0);\n";
    }
    elsif($i > 3) {
        print FH "    ifcb2.connect_units(s_b_br$i"."[$u:$l]);\n";
        print FH "    p_e$i"."[$u-:$l].connect_units(a0.ifca1);\n";
        print FH "    sgb2.connect_units(s_b_br$i"."[$u:$l]);\n";
        print FH "    p_e$i"."[$u:$l].connect_units(a0.sga1);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 2) {
        print FH "    stop[$u:$l].connect_units(d0.a0.ifca1);\n";
        print FH "    s_top$i"."[$u:$l].connect_units(e0.c0.ifcb0);\n";
        print FH "    d0.ifca2.connect_units(ptop[$u:$l]);\n";
        print FH "    stop[$u:$l].connect_units(d0.a0.sga1);\n";
        print FH "    s_top$i"."[$u-:$l].connect_units(e0.c0.sgb0);\n";
        print FH "    d0.sga2.connect_units(ptop[$u:$l]);\n";
    }
    elsif($i == 3) {
        print FH "    e0.a0.ifcb0.connect_units(s_top$i"."[$u:$l]);\n";
        print FH "    stop[$u:$l].connect_units(d0.b0.ifca1);\n";
        print FH "    ifca4.connect_units(e0.b0.s_b$i"."[$u:$l]);\n";
        print FH "    e0.a0.sgb0.connect_units(s_top$i"."[$u:$l]);\n";
        print FH "    stop[$u-:$l].connect_units(d0.b0.sga1);\n";
        print FH "    sga4.connect_units(e0.b0.s_b$i"."[$u:$l]);\n";
    }
    elsif($i > 3) {
        print FH "    p_top_br$i"."[$u:$l].connect_units(e0.ifcb2);\n";
        print FH "    p_top_br$i"."[$u:$l].connect_units(e0.ifca3);\n";
        print FH "    d0.a0.ifcb0.connect_units(stop[$u:$l]);\n";
        print FH "    p_top_br$i"."[$u:$l].connect_units(e0.sgb2);\n";
        print FH "    p_top_br$i"."[$u:$l].connect_units(e0.sga3);\n";
        print FH "    d0.a0.sgb0.connect_units(stop[$u-:$l]);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
