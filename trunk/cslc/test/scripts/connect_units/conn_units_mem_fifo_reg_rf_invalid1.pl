...
print "the path to the generated tests is : $path"."conn_units_mem_fifo_reg_rf_invalid1/ \n";
...
sub createCslFile {
    ...
    my $word5 = &word($val4);
    my $word6 = &word($val5);
    &mkDir("$path/conn_units_mem_fifo_reg_rf_invalid1");
    open(FH,">$path/conn_units_mem_fifo_reg_rf_invalid1/$test_name");
    
    print FH "//Generated by Petronela\n";
    print FH "//testing the command connect_units for connections fifo to fifo,register to register and register_file to register_file --illegal \n\n";
    ...
    if($i > 2) {        
        print FH "  csl_signal s_data2($val2);\n"; 
        print FH "  csl_signal s_addr2($val2);\n";
        print FH "  csl_signal s_data3($val2);\n";
        print FH "  csl_signal s_addr3($val2);\n";
    }
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    b0.a0.$it1.connect_units(b0.$it2,\"$word\");\n";
        print FH "    c1.b1.$it2.connect_units(c1.b1.a0.$it1);\n";
    }
    elsif($i > 2) {
        print FH "    c0.$it1.connect_units(c0.b0.$it2);\n";
        print FH "    c1.$it1.connect_units(c1.b2.$it2,\"$word\");\n";
    }
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    d0.$it3.connect_units(d0.b0.$it4,\"$word1\");\n";
        print FH "    d1.$it3.connect_units(d1.c0.b1.$it4);\n";
    }
    elsif($i == 3) {
        print FH "    d1.$it3.connect_units(d1.c1.b0.a1.$it4,\"$word1\");\n";
        print FH "    d0.b1.a0.$it4.connect_units(d0.$it3);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i == 2) {
        print FH "    d0.$it3.connect_units(d0.b1.$it4);\n";
        print FH "    e1.d1.$it3.connect_units(e1.d1.b0.$it4,\"$word2\");\n";
        print FH "    d2.c1.b0.a1.ua1.connect_units(d2.$it3,\"$word3\");\n";
    }
    elsif($i == 4) {
        print FH "    e0.$it3.connect_units(e0.d0.b0.$it4,\"$word2\");\n";
        print FH "    e2.d0.b1.$it4.connect_units(e2.$it3);\n";
        print FH "    d1.b0.$it4.connect_units(d1.c1.uc0,\"$word3\");\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
