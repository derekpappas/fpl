...
print "the path for generated tests is: $path/conn_units_u_mem_fifo_reg_rf_invalid\n";
...
foreach my $unit(@units){
    for(my $i = 1; $i <= 4; $i++) {
        my @map1 = ("b0","b1");
        my @map2 = ("c0","c1","a0","a1","b0","b1");
        my @map3 = ("d0","d1","b0","b1");
        my @map4 = ("a0","a1");
        my @map5 = ("d0","d1","d2","e0","e1");
        my @map6 = ("b0","b1","b2");
...
sub main {
    my ($i,$unit,$it1,$it2,$it3,$it4) = @_;
    my $test_name = "conn_units_".$unit."_".$i."_".$it1."_".$it2."_".$it3."_".$it4."_illegal.csl";
    &createCslFile($test_name, $unit,$i,$it1,$it2,$it3,$it4);
}
...
sub port{
    ...
    print FH "  csl_port rd_data(input,$val);\n"; 
    print FH "  csl_port wr_data(output,$val);\n";
    ...
    print FH "  csl_port wr_addr(output,$val);\n";
    print FH "  csl_port rd_addr1(output,$val);\n";
    print FH "  csl_port rd_addr0(output,$val);\n";
    print FH "  csl_port data_in(output,$val);\n"; 
    print FH "  csl_port wr_en(output,$val);\n";
    print FH "  csl_port rd_en0(output,$val);\n";
    print FH "  csl_port data_out1(input,$val);\n"; 
    print FH "  csl_port data_out0(input,$val);\n";
    print FH "  csl_port rd_en1(output,$val);\n";
    print FH "  csl_port data(output,$val);\n"; 
    print FH "  csl_port enable(output,$val);\n";
    print FH "  csl_port reg_out(input,$val);\n";
...
sub createCslFile {
    my($test_name, $unit,$i,$it1,$it2,$it3,$it4) = @_;
    my $val = 1;
    ...
    my $word6 = &word($val1);
    my $word7 = &word($val3);
    &mkDir("$path/conn_units_u_mem_fifo_reg_rf_invalid/");
    open(FH,">$path/conn_units_u_mem_fifo_reg_rf_invalid/$test_name");
    print FH "//Generated by Petronela\n";  
    print FH "//testing cmd. connect_units for invalid connection  unit to fifo, unit to register, unit to register_file, unit to memory \n";
    ...
    if($i <= 2) {
        if($it2 eq "a0" || $it2 eq "a1"){
            print FH "    $it1.ub0.connect_units(c1.b1.$it2);\n";
            print FH "    c0.connect_units($it1.ua1);\n";
            print FH "    ud0.connect_units(c1.b1.$it2);\n";
        }
        elsif($it2 ne "b0" && $it2 ne "b1"){
            print FH "    $it1.ub0.connect_units($it2);\n";
            print FH "    $it2.connect_units(b1.a0.ua0);\n";
        }
    }
    elsif($i > 2) {
        print FH "    $it1.connect_units(c1.b0.$it2);\n";
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    $it3.connect_units(b0.$it4.ua1);\n";
        print FH "    c0.uc0.connect_units($it4);\n";
    }
    elsif($i == 3) {
        print FH "    d0.$it3.ub3.connect_units(c1.$it4);\n";
    ...
    if($i == 2) {
        if($it3 eq "e0" || $it3 eq "e1"){
            ...
            print FH "    $it3.ue0.connect_units(d0.$it4.a0);\n";
            print FH "    d2.c1.b0.a1.connect_units(e0.d0.ud0);\n"; 
        }
        else {
            print FH "    $it3.ub2.connect_units(e0.d0.$it4);\n";
            print FH "    $it3.connect_units(e0.d0.$it4.a0.ua0);\n";
            print FH "    d1.b1.ub0.connect_units(e1.c0.b0.a1);\n";
        }
    }
    elsif($i >= 4) {
        print FH "    $it3.ud0.connect_units(e0.d0.c0.$it4);\n";
        print FH "    a0.ua0.connect_units(d1.c1.$it4);\n";
        print FH "    d1.uc1.connect_units(e2.c1.a0);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
