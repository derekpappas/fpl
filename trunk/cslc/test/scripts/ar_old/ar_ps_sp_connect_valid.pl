...
sub main {
    my ($i,$var,$it1) = @_;
    my $test_name;
    $test_name = "connect_unit_p_s".$i."_".$it1."_legal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/ar_connect_ps_valid");
    open(FH,">$path/ar_connect_ps_valid/$test_name");
    ...
    if($i <= 5) {
        ...
        print FH "    b0.s_b$i.connect(a0.p_a$i);\n";
        
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    pt.connect(sg);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    p_c$i.connect(sg);\n";
        print FH "    a0.sg.connect(p_c$i);\n";
        print FH "    pt.connect(s_c$i);\n";
        
    }
    elsif($i > 15 && $i <= 20) {
        print FH "    a0.p_a$i.connect(s_a$i);\n";
        print FH "    sc.connect(a0.p_a$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    if($i > 5 && $i <= 10) {
        ...
        print FH "    pt.connect(b0.s_b$i);\n";
        print FH "    b0.sb.connect(pt);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i > 10 && $i <= 15) {
        print FH "    c0.a0.pt.connect(p_top$i);\n";
        print FH "    s_top$i.connect(pt);\n";
        print FH "    d0.p_d$i.connect($var);\n";
    }
    elsif($i > 15 && $i <= 20) {
        print FH "    d0.a0.p_a$i.connect($var);\n";
        print FH "    s_a$i.connect(c0.p_c$i);\n";
        print FH "    s_top$i.connect(d0.a0.p_a$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
