...
sub main {
    my ($i,$it1,$it2) = @_;
    my $test_name = "connect_unit_p_ifcp".$i."_".$it1."_".$it2."_legal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/ar_p_ifc_connect_valid");
    open(FH,">$path/ar_p_ifc_connect_valid/$test_name");
    
    print FH "//Generated by Petronela\n";
    print FH "//conections port to ifc.port, signal to ifc.port, ifc.port to port and ifc.port to signal\n\n";
    ...
    print FH "  a() {\n";
    if($i <= 2) {
        print FH "    $it1.connect(ifca1.$it2);\n";
        print FH "    s_a$i.connect(ifca1.p_ifa);\n";
        print FH "    ifcb0.p_if.connect(sa);\n";
    }
    elsif($i > 2 && $i <= 5) {
        print FH "    $it1.connect(ifcb0.$it2);\n";
        print FH "    s_a$i.connect(ifca1.p_ifca$i);\n";
        print FH "    ifca1.p_ifa.connect(sa);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    ifca1.p_ifa.connect(pa);\n";
        print FH "    ifcb0.p_ifcb$i.connect(p);\n";
        print FH "    s_a$i.connect(ifca1.p_ifa);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    ifca1.p_ifta$i.connect(p_a_br$i);\n";
        print FH "    ifca1.p_if.connect(p_a$i);\n";
        print FH "    ifcb0.p_if.connect(pa);\n";
        print FH "    s_a$i.connect(ifcb0.p_iftb$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  b() {\n";
    if($i <= 5){
        print FH "    ifcb0.p_ifb.connect(p);\n";
        print FH "    ifca1.p_ifca$i.connect(p);\n";
        print FH "    s_b$i.connect(ifca1.p_ifa);\n";
    }
    elsif($i > 5 && $i <= 7) {
        print FH "    $it1.connect(ifca1.$it2);\n";
        print FH "    s_b_br$i.connect(ifcb0.p_ifcb$i);\n";
        print FH "    ifcb0.p_ifb.connect(s_b$i);\n";
    }
    elsif($i > 7 && $i <=10) {
        print FH "    $it1.connect(ifcb0.$it2);\n";
        print FH "    s_b$i.connect(ifca1.p_if);\n";
        print FH "    ifca1.p_ifa.connect(s_b_br$i);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    ifca1.p_ifta$i.connect(p_b$i);\n";
        print FH "    sb.connect(ifcb0.p_b);\n";
        print FH "    ifca1.p_ifta$i.connect(s_b_br$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  c() {\n";
    if($i <= 5){
        print FH "    ifca1.p_ifca$i.connect(pc);\n";
        print FH "    sc.connect(ifcb0.p_ifb);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    ifcb0.p_ifb.connect(p_c$i);\n";
        print FH "    ifca1.p_ifca$i.connect(p);\n";
        print FH "    s_c_br$i.connect(ifca1.p_if);\n";
    }
    elsif($i > 10 && $i <= 12) {
        print FH "    $it1.connect(ifca1.$it2);\n";
        print FH "    s_c$i.connect(ifcb0.p_ifcb$i);\n";
    }
    elsif($i > 12 && $i <= 15) {
        print FH "    $it1.connect(ifcb0.$it2);\n";
        print FH "    s.connect(ifca1.p_ifca$i);\n";
        print FH "    ifca1.p_ifa.connect(sc);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    a0.p_a$i.connect(ifca2.$it2);\n";
        print FH "    c0.pc.connect(ifcb1.p_ifb);\n";
        print FH "    b0.sb.connect(ifca2.p_ifca$i);\n";
        print FH "    sd.connect(a0.ifcb0.p_ifcb$i);\n";
    }
    elsif($i >2 && $i <= 5) {
        print FH "    p_d$i.connect(ifcb1.$it2);\n";
        print FH "    s_d$i.connect(b0.ifca1.p_ifa);\n";
        print FH "    c0.ifcb0.p_ifb.connect(sd);\n";
        print FH "    a0.ifca1.p_ifca$i.connect(sd);\n";
    }
    elsif($i > 5 && $i <= 7) {
        print FH "    p_d$i.connect(a0.p_a$i);\n";
        print FH "    p.connect(b0.p_b$i);\n";
        print FH "    s_d$i.connect(c0.ifca1.p_ifca$i);\n";
        print FH "    c0.ifcb0.p_ifcb$i.connect(s_d_br$i);\n";
    }
    elsif($i > 7 && $i <= 10) {
        print FH "    p_d$i.connect(ifcb1.$it2);\n";
        print FH "    ifca2.p_ifa.connect(p_d$i);\n";
        print FH "    s_d_br$i.connect(a0.ifca1.p_ifa);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    p_d$i.connect(ifcb1.p_ifb);\n";
        print FH "    sd.connect(b0.ifcb0.p_b);\n";
    }
    elsif($i > 15 && $i <= 17){
        print FH "    $it1.connect(ifca2.$it2);\n";
        print FH "    p_d$i.connect(ifcb1.p_ifb);\n";
        print FH "    c0.ifcb0.p_ifb.connect(s_b_br$i);\n";
    }
     elsif($i > 17 && $i <= 20){
        print FH "    $it1.connect(ifcb1.$it2);\n";
        print FH "    b0.p_b$i.connect(ifca2.p_if);\n";
        print FH "    s_d$i.connect(a0.ifca1.p_if);\n";
    }
    ...
    print FH "  e() {\n";
    if($i <= 5) {
        print FH "    p_e_br$i.connect(ifca3.p_ifa);\n";
        print FH "    a0.sa.connect(ifca3.p_ifca$i);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    p_e$i.connect(ifca3.p_ifca$i);\n";
        print FH "    se.connect(c0.ifcb0.p_ifb);\n";
        print FH "    b0.s_b_br$i.connect(ifcb2.p_ifcb$i);\n";
    }
    elsif($i > 10 && $i <= 20) {
        print FH "    ifca3.p_ifca$i.connect(a0.p_a_br$i);\n";
        print FH "    s_e_br$i.connect(b0.ifca1.p_ifa);\n";
    }
    elsif($i > 20 && $i <= 22) {
        print FH "    $it1.connect(ifca3.$it2);\n";
        print FH "    c0.ifcb0.p_ifb.connect(se);\n";
    }
    elsif($i > 22 && $i <= 25) {
        print FH "    $it1.connect(ifcb2.$it2);\n";
        print FH "    se.connect(a0.ifca1.p_ifca$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 5) {
        print FH "    ifca4.p_ifca$i.connect(d0.a0.p_a$i);\n";
        print FH "    p.connect(ifca4.p_ifca$i);\n";
        print FH "    s_top$i.connect(d0.ifca2.p_ifca$i);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    ifcb3.p_ifcb$i.connect(e0.a0.p_a$i);\n";
        print FH "    ptop.connect(ifca1.p_ifa);\n";
        print FH "    e0.ifcb2.p_ifb.connect(st);\n";
        print FH "    s_top_br$i.connect(d0.b0.ifcb0.p_ifcb$i);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    p_top_br$i.connect(ifca4.p_ifta$i);\n";
        print FH "    ifcb3.p_iftb$i.connect(p);\n";
        print FH "    s_top$i.connect(e0.c0.ifca1.p_if);\n";
    }
    elsif($i > 25 && $i <= 27) {
        print FH "    $it1.connect(ifca4.$it2);\n";
        print FH "    d0.a0.p_a$i.connect(ifca4.$it2);\n";
        print FH "    stop.connect(e0.b0.ifcb0.p_ifcb$i);\n";
        print FH "    s_top$i.connect(e0.c0.ifca1.p_if);\n";
    }
    elsif($i > 27) {
        print FH "    $it1.connect(ifcb3.$it2);\n";
        print FH "    e0.b0.p.connect(ifca4.p_if);\n";
        print FH "    ifca4.p_ifa.connect(s_top$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
