...
sub generate_testbench_tests {
    ...
    print FH "$classUnit $unitDUT { \n";
    print FH "  csl_signal sclk,push,pop,full,empty,data(32),rst,valid;\n";
    print FH "  $fifoName1 fifo1_0(.clk(clk),.push(push),.pop(pop),.full(full),.empty(empty),\n";
    print FH "                        .rd_data(data),.wr_data(data),.reset_(rst),.valid(valid),.wr_clock(sclk),.rd_clock(sclk)); \n"; # look up what is the name for the fifo clock
    print FH "  $fifoName1 fifo1_1(.clk(clk),.push(push),.pop(pop),.full(full),.empty(empty),\n";
    print FH "                        .rd_data(data),.wr_data(data),.reset_(rst),.valid(valid),.wr_clock(sclk),.rd_clock(sclk)); \n"; # look up what is the name for the fifo clock
    print FH "  csl_port stim(input);\n";
    print FH "  csl_port exp(output);\n";
    ...
    print FH "    tb(){ \n";
    print FH "        clk.set_attr(clock); \n";
    print FH "        add_logic(clock,clk,100,ps); \n";
    print FH "    } \n";
    print FH "}; \n";
    ...
    print FH "$classUnit $unitDUT { \n";
    print FH "  csl_signal sclk,push,pop,full,empty,data(32),rst,valid,in,out;\n";
    print FH "  $fifoName1 $fifoName1(.clk(clk),.push(push),.pop(pop),.full(full),.empty(empty),\n";
    print FH "                        .rd_data(data),.wr_data(data),.reset_(rst),.valid(valid)); \n"; # look up what is the name for the fifo clock
    print FH "  csl_port stim_in(input);\n";
    print FH "  csl_port exp_out(output);\n";
    print FH "  csl_port clk(input);\n";
    print FH "  dut(){ \n";
    print FH "    clk.set_attr(clock); \n";
    print FH "    in = stim_in;\n";
    print FH "    sclk = clk;\n";
    print FH "    exp_out = out;\n";
    print FH "    } \n";
    print FH "}; \n";
    ...
    print FH "  csl_signal push,pop,full,empty,data(32),rst,valid;\n";
    print FH "  $fifoName1 $fifoName1" . "_1(.clk(clk),.push(push),.pop(pop),.full(full),.empty(empty),\n";
    print FH "                               .rd_data(data),.wr_data(data),.reset_(rst),.valid(valid)); \n";
    print FH "  csl_port stim_in(input); \n";   
    ...
    print FH "  dut(){ \n";
    print FH "    clk.set_attr(clock); \n";
    print FH "    empty = stim_in;\n";
    print FH "    exp_vec = valid;\n";
    print FH "    } \n";
    print FH "}; \n";
    ...
    my $i;
    for ( $i=0; $i<100; $i++) {   
        print FH "  f_$i f_$i" . "_1(.clk(clk),.push(push),.pop(pop),.full(full),.empty(empty),\n";
	print FH "                   .rd_data(data),.wr_data(data),.reset_(rst),.valid(valid)); \n";
    }
    print FH "  csl_port stim_in(input); \n";   
    print FH "  csl_port exp_vec(output); \n";   
    print FH "  csl_port clk(input); \n";
    print FH "  csl_signal stim,exp,sclk;\n";
    print FH "  dut(){ \n";
    print FH "    clk.set_attr(clock); \n";
    print FH "    stim = stim_in;\n";
    print FH "    sclk = clk;\n";
    print FH "    exp_vec = exp;\n";
    print FH "    } \n";
    print FH "}; \n";
	...
	print FH "  csl_signal clk,push,pop,full,empty,data(32),rst,valid;\n";
        print FH "  f_$i f_$i" . "_1(.clk(clk),.push(push),.pop(pop),.full(full),.empty(empty),\n";
	print FH "                   .rd_data(data),.wr_data(data),.reset_(rst),.valid(valid)); \n";
        print FH "  u_$i() {\n";
        print FH "    }\n";
    ...
    print FH "  csl_port exp_vec(output); \n";   
    print FH "  csl_port clk(input); \n";
    print FH "  csl_signal st,exp,sclk;\n";
    print FH "  dut(){ \n";
    print FH "    clk.set_attr(clock); \n";
    print FH "    st = stim_in;\n";
    print FH "    exp_vec = exp;\n";
