...
print "Generated path: $path"."ifc_prefix_suffix_valid/ \n";
...
sub createCslFile {
    ...
    print FH "// Test cases from : table_prefix_sufix.odg \n\n"; 
    ...
    if($i > 15){
     ...
     print FH " csl_unit a {\n";
    print FH "    csl_port pa1(output,$val4);\n";
    print FH "    csl_port pa2(input,$val3);\n";
    print FH "    ifca ifca1;\n";
    print FH "    ifca ifca2;\n";
 if($i > 5 && $i<=10){
    print FH "    ifcb ifcba1;\n";
    print FH "    ifcb ifcba3;\n";
 }
  if($i > 10 && $i<=15){
        print FH "  ifcd ifcda1;\n";
        print FH "  ifce ifcea1;\n";
    }
if($i > 15){
        print FH "  ifcd ifcda2;\n";
        print FH "  ifcf ifcfa2;\n";
        print FH "  ifcg ifcga2;\n";
        print FH "  ifch ifcha0;\n";
        print FH "  ifch ifcha1;\n";
    }
    print FH "  a() { }\n";        
    print FH "};\n\n";
    ...
    print FH "  ifca ifca2;\n";
 if($i <= 5){
    print FH "  a a1(.pa1(s_top),.pa2(p_top),.ifca1(ifca1),.ifca2(ifca2));\n";
}
    if($i > 5  && $i<=10){
        print FH "  ifcb ifcb1;\n";
        print FH "  ifcb ifcb3;\n";
        print FH "  a a1(.pa1(s_top),.pa2(p_top),.ifca1(ifca1),.ifca2(ifca2),.ifcba1(ifcb1),.ifcba3(ifcb3));\n";   
     
    }
    if($i > 10 && $i<=15){
        print FH "  ifcd ifcd1;\n";
        print FH "  ifce ifce1;\n";
        print FH "  a a1(.pa1(s_top),.pa2(p_top),.ifca1(ifca1),.ifca2(ifca2),.ifcda1(ifcd1),.ifcea1(ifce1));\n";
    }
    if($i > 15){
        print FH "  ifcd ifcd2;\n";
        print FH "  ifcf ifcf2;\n";
        ...
        print FH "  ifch ifch0;\n";
        print FH "  ifch ifch1;\n";
        print FH "  a a1(.pa1(s_top),.pa2(p_top),.ifca1(ifca1),.ifca2(ifca2),.ifcda2(ifcd2),.ifcfa2(ifcf2),.ifcga2(ifcg2),.ifcha0(ifch0),.ifcha1(ifch1));\n";
    }
    print FH "  top(){\n";
    if($i < 3){
