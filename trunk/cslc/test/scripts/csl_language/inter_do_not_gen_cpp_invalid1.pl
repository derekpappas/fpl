...
#oanab
#generating tests with the method called in unit,reg,rf,fifo,mem,tb,unit instance,reg instance
...
print "Generated tests path : inter_not_gen_cpp_invalid1/\n";
