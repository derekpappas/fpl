...
#oanab
#method called in unit,reg,rf,fifo,mem,unit instance,reg instance, rf instance,fifo instance,mem instance,tb,sg,sg instance
...
print "Generated tests path : inter_gen_uniq_invalid4/\n";
...
sub createCslFile {
    ...
    if($test_name=~/(_legal)/){
        ...
        &mkDir("$path/inter_gen_uniq_invalid4"); 
        open(FH,">$path/inter_gen_uniq_invalid4/$test_name");
    }
...
#unit a
	...
	print FH "    sg$k\_$zero.gen_unique_rtl_modules();\n";
    }
    elsif($i > 300 && $i <= 350) {
...
#unit b
	...
	print FH "    sg$k\_$one.gen_unique_rtl_modules();\n";
    }
    elsif($i > 300 && $i <= 350) {
...
#unit c
	...
	print FH "    b$k\_$one.gen_unique_rtl_modules();\n"; 
    }
    elsif($i > 150 && $i <= 200) {
	...
	print FH "    sg$k\_$two.gen_unique_rtl_modules();\n"; 
    }
    print FH "  }\n";
    print FH "};\n\n";
