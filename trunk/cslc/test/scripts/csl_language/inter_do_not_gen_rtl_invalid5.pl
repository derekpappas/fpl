...
print "Generated tests path : inter_not_gen_rtl_invalid5/\n";
...
sub createCslFile {
    ...
    if($test_name=~/(_legal)/){
        ...
        &mkDir("$path/inter_not_gen_rtl_invalid5"); 
        open(FH,">$path/inter_not_gen_rtl_invalid5/$test_name");
    }
...
#unit a
	...
	print FH "    rf$k\_$two.do_not_gen_rtl();\n";
...
#unit b
	...
	print FH "    f$k\_$zero.do_not_gen_rtl();\n";
    }
    elsif($i > 150 && $i <= 200) {
