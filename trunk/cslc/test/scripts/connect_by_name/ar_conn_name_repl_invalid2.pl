...
sub main {
    my ($i,$l, $u) = @_;
    my $test_name = "ar_conn_name_repl$i"."_".$l."_".$u."_illegal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/ar_conn_name_repl_invalid2");
    open(FH,">$path/ar_conn_name_repl_invalid2/$test_name");

    print FH "//Generated by Petronela\n";
    print FH "//connections for port to replication exp.,signal to replication expr., port[part select] to replication expr., signal[part select] to replication expr.\n\n";
    ...
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    p_d$i.connect_by_name({5{p_a$i}});\n";
        print FH "    p_d_br$i.connect_by_name({3{p,p_a_br$i}});\n";
        print FH "    p[$u:$l].connect_by_name({2{p_c$i}});\n";
    }
    elsif($i > 2 && $i <= 4) {
        if($val3 != 0){
            print FH "    s_d$i"."[$u:$l].connect_by_name({3{pa}});\n";   
            print FH "    b0.p".$i."[$u:$l].connect_by_name({3{d.p}});\n";
        }
        elsif($val4 != 0) {
            print FH "    s_d$i"."[$u:$l].connect_by_name({4{pa}});\n";   
#            print FH "    b0.p".$i."[$u:$l].connect_by_name({4{d.p}});\n";
        }
        else {
            print FH "    s_d$i"."[$u:$l].connect_by_name({2{pa}});\n";
            print FH "    b0.p".$i."[$u:$l].connect_by_name({2{d.p}});\n";
        }
        print FH "    pd[$u:$l].connect_by_name({2{sa}});\n";
    }
    elsif($i > 4) {
        print FH "    sd.connect_by_name({2{pc}});\n";
        if($val4 != 0) {
            print FH "    p[$u:$l].connect_by_name({2{s_d_br$i,s_d$i}});\n";
        }
    }
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    s_e_br$i.connect_by_name({2{p_b$i,p}});\n";
        print FH "    p_e$i"."[$u:$l].connect_by_name({2{sb}});\n";
        if($val4 != 0){
            print FH "    b0.pb[$u:$l].connect_by_name({2{se,s}});\n";
        }
        else {  
            print FH "    b0.pb[$u:$l].connect_by_name({2{se}});\n";
        }
    }
    elsif($i > 1 && $i <= 3) {
        if($val4 != 0) {
            print FH "    p_e$i"."[$u:$l].connect_by_name({4{s_a$i}});\n";
        }
        else {
            print FH "    p_e$i"."[$u:$l].connect_by_name({2{s_a$i}});\n";
        }
        print FH "    s_e$i"."[$u:$l].connect_by_name({2{p_b$i}});\n";
    }
    elsif($i > 3) {
        print FH "    p[$u:$l].connect_by_name({2{pb}});\n";
        print FH "    se.connect_by_name({5{p_b$i}});\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 2) {
        print FH "    stop.connect_by_name({2{p_a_br$i,p}});\n";
        print FH "    s_top$i.connect_by_name({2{p_c$i,pc,p}});\n";
#        print FH "    d0.p"."[$u:$l].connect_by_name({2{sa}});\n";
    }
    elsif($i == 3) {
        print FH "    s_top$i.connect_by_name({4{p_a$i}});\n";
        print FH "    stop.connect_by_name({2{pb}});\n";
        print FH "    p[$u:$l].connect_by_name({2{sa}});\n";
    }
    elsif($i > 3) {
        print FH "    s_top_br$i.connect_by_name({2{e0.p_e$i,pe}});\n";
        print FH "    s_top_br$i.connect_by_name({4{p_d$i}});\n";
#        print FH "    d0.b0.p_b$i"."[$u:$l].connect_by_name({2{p_top$i}});\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
