...
/**
 * Syntax-only declaration node for {@code csl_fifo_declaration} (batch 3 refinement).
 */
public final class CslomFifoDecl extends CslomNamedDecl {

    private String unitDefinitionText;

    public CslomFifoDecl(String name, int lineNumber, int columnNumber, String fileName) {
