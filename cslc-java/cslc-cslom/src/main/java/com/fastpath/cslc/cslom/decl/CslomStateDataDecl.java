...
/**
 * Syntax-only declaration node for {@code csl_state_data_declaration} (batch 3 refinement).
 */
public final class CslomStateDataDecl extends CslomNamedDecl {

    private String unitDefinitionText;

    public CslomStateDataDecl(String name, int lineNumber, int columnNumber, String fileName) {
