#ifndef USB_TRANSACTION_MGR_H
#define USB_TRANSACTION_MGR_H
...
class usb_transaction_mgr : public CsimUnit {
public:
  ...
  RefCsimUnit usb_tm_packetizer_;
  RefCsimUnit usb_tm_dispatcher_;
  //functions
  ...
  //constructor
  usb_transaction_mgr() : CsimUnit(RefString(new std::string("usb_transaction_mgr"))) {}
};
}
