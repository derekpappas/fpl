...
SC_MODULE(dsp) {
  ...
  void createInstVec(std::string inst) { 
    ...
    sc_trace(stimVecFile_dsp, gbl_clk, std::string("gbl_clk") );
    sc_trace(stimVecFile_dsp, gbl_reset_, std::string("gbl_reset_") );
    sc_trace(stimVecFile_dsp, gbl_enable, std::string("gbl_enable") );
