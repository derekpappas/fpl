...
namespace NSVerilogPreprocessor {
...
CPreprocessor::CPreprocessor(const char *inputFileName, const char *outputFileName, std::vector<std::string> &includePath) 
  ...
  for( char c = 0x30; c != 0x3A; ++c ) // '0'..'9'
    identifierTable[c] = 1;
  identifierTableFirst[0x5F] = identifierTable[0x5F] = 1; // '_' charancter
  identifierTableFirst[0x24] = identifierTable[0x24] = 1; // '$' charancter
