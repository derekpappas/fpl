...
namespace NSCdomSchematicCodeGenerator {
  ...
  class CUnitInstances;
  typedef boost::shared_ptr<CUnitInstances> Ref_CUnitInstances;
  typedef std::vector<Ref_CUnitInstances> TVec_Ref_CUnitInstances;
  typedef TVec_Ref_CUnitInstances::const_iterator CUnitInstances_iter;
  typedef TVec_Ref_CUnitInstances::reverse_iterator CUnitInstances_rIter;
  typedef boost::shared_ptr<TVec_Ref_CUnitInstances> RefTVec_Ref_CUnitInstances;

  class CUnitsInst;
  typedef boost::shared_ptr<CUnitsInst> Ref_CUnitsInst;
...
//********************************************************************************
  class CUnitInstances {
  private:
    RefString unitName; // current unit
    Ref_TVec_RefString unitInstances; // instances of the current unit
    Ref_TVec_RefString instanceNames; // instances in the current unit
      
  public:
    CUnitInstances();
    void setUnitName(RefString &);
    RefString getUnitName();
    void addUnitInstance(RefString &);
    Ref_TVec_RefString getUnitInstances();
    void addInstance(RefString &);
    Ref_TVec_RefString getInstanceNames();
    ~CUnitInstances();
  };
...
class CUnitsInst {
  private:
    RefTVec_Ref_CUnitInstances unitInst;
      
  public:
    CUnitsInst();
    void addUnitObj(Ref_CUnitInstances &);
    RefTVec_Ref_CUnitInstances getUnitObjs();
    ~CUnitsInst();
  };
...
//********************************************************************************
class CSchematicCodeGenerator : public NSCdomVisitor::CVisitorTraversal {
   private:
    ...
    // mapRefString_Ref_TVec_RefString unitInstancesMap;
  
    RefString topUnitInst; // set top unit to use it for instances
    ...
    RefString instName; // name of instance to be used by getHID function
   public:
    CSchematicCodeGenerator(std::string filename);
    ~CSchematicCodeGenerator();
    ...
    void getHID(RefString rs, TBool firstTime);
    //------end
