...
QtBoolEdit::QtBoolEdit(QWidget *parent) :
    ...
    m_textVisible(true)
{
    m_stringDisplayName << "False" << "True";
    ...
    m_checkBox->setText(m_stringDisplayName[1]);
}
...
void QtBoolEdit::setTextVisible(bool textVisible)
{
    ...
    if (m_textVisible)
        m_checkBox->setText(m_stringDisplayName[(int)isChecked()]);
    else
...
void QtBoolEdit::setDisplayName(const QStringList& stringDisplayName)
{
    if (m_stringDisplayName != stringDisplayName)
    {
        m_stringDisplayName = stringDisplayName;
        m_checkBox->setText(m_stringDisplayName[(int)isChecked()]);
    }
}
