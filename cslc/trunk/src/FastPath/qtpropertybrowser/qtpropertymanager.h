...
public:
    ...
    QStringList displayName(const QtProperty* property) const;

public Q_SLOTS:
    void setValue(QtProperty *property, bool val);
    void setDisplayName(QtProperty* property, const QStringList& stringDisplayName);
Q_SIGNALS:
    void valueChanged(QtProperty *property, bool val);
    void displayNameChanged(QtProperty* property, const QStringList& stringDisplayName);
protected:
    QString valueText(const QtProperty *property) const;
