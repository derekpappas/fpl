...
# write 0s (initialization) ascending
        ...
        movc reg max_addr
        mvrs haddrl reg       # move the highest ram address to haddr special register
...
# read 0s write 1s descending
        ...
        movc reg max_addr
        mvrs caddrl reg       # writes will start with highest address
        movc r1 one               # move 1 in r1
