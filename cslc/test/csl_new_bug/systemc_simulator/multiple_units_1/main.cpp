...
int sc_main (int argc , char *argv[]) {
  ...
  stimVecFile_top0_ = sc_create_vec_file("stim_vec_top0_",2,4);
  ((vec_file*)stimVecFile_top0_)->sc_set_vcd_time_unit(-9);
  expVecFile_top0_ = sc_create_vec_file("exp_vec_top0_",2,4);
  ((vec_file*)expVecFile_top0_)->sc_set_vcd_time_unit(-9);
