...
shloop2:and r3 r1 r2            # select bit
        ...
        and r6 r5 r7            # apply CZ mask
        br 0 loop2        
# read 0s write 1s read 1s descending
