...
sub cslFile {
    ...
    &mkDir("$path/verif_comp_exp_valid");
    open(FH,">$path/verif_comp_exp_valid/$test_name");
    &header($test_name);
    &description($cmd);
    &legend();
    ...
    print FH "  csl_port st(input),exp(output);\n";
    print FH "  csl_signal sclk;\n";
    print FH "    dut(){\n";
    print FH "    clk.set_attr(clock);\n";
    print FH "    sclk = clk;\n";
    print FH "    st = stim_in;\n";
    print FH "    exp_out = exp;\n";
    print FH "    }\n";
    print FH "};\n";
