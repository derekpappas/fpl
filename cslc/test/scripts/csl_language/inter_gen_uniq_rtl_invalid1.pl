...
#oanab
#method called in unit,reg,rf,fifo,mem,unit instance,reg instance, rf instance,fifo instance,mem instance
...
print "Generated tests path : inter_gen_uniq_invalid1/\n";
...
sub createCslFile {
    ...
    if($test_name=~/(_legal)/){
        ...
        &mkDir("$path/inter_gen_uniq_invalid1"); 
        open(FH,">$path/inter_gen_uniq_invalid1/$test_name");
    }
    print FH "//Generated by oanab\n";
    print FH "//Test cases from: gen_uniq_rtl_test_matr.odg \n\n";

#fifo f
    if($i > 50 && $i <= 100 || $i > 150 && $i <= 200 || $i > 350 && $i <= 450) {
...
#register reg
    if($i <= 50 || $i > 100 && $i <= 150 || $i > 300 && $i <= 350) {
...
#register rreg
    if($i > 100 && $i <= 200 || $i > 250 && $i <= 300 || $i > 400 && $i <= 450) {
	print FH "csl_register rreg$k {\n";
	print FH "  rreg$k () {\n";
	print FH "    set_width($val3);\n";
	print FH "    set_type(register);\n";
	if($i > 250 && $i <= 300 || $i > 400 && $i <= 450) {
	    print FH "    gen_unique_rtl_modules();\n";
	}
	print FH "  }\n";
	print FH "};\n\n";
...
#register file rf
    if($i <= 50 || $i > 150 && $i <= 250 || $i > 300 && $i <= 350) {
...
#memory mem
    if($i > 50 && $i <= 100 || $i > 150 && $i <= 200 || $i > 450 && $i <= 500) {
