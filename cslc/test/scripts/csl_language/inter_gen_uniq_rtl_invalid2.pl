...
#oanab
#method called in unit,reg,rf,fifo,mem,unit instance,reg instance, rf instance,fifo instance,mem instance,tb,mem map,vector
...
print "Generated tests path : inter_gen_uniq_invalid2/\n";
...
sub createCslFile {
    ...
    if($test_name=~/(_legal)/){
        ...
        &mkDir("$path/inter_gen_uniq_invalid2"); 
        open(FH,">$path/inter_gen_uniq_invalid2/$test_name");
    }
...
#fifo ff
    if($i > 50 && $i <= 100 || $i > 250 && $i <= 300 || $i > 450 && $i <= 500) {
...
#register rreg
    if($i <= 50 || $i > 200 && $i <= 250 || $i > 400 && $i <= 450) {
...
#register file rrf
    if($i > 50 && $i <= 100 || $i > 200 && $i <= 250 || $i > 400 && $i <= 450) {
...
#unit a
	...
	print FH "    rreg$k\_$two.gen_unique_rtl_modules();\n";
	print FH "    rrf$k\_$two.gen_unique_rtl_modules();\n";
    }
    print FH "  }\n";
    print FH "};\n\n";
...
#unit b
	...
	print FH "    clk.set_attr(clock);\n";
	print FH "    ff$k\_$two.gen_unique_rtl_modules();\n";
    }
    print FH "  }\n";
    print FH "};\n\n";
...
#unit c
	...
	print FH "    mmem$k\_$two.gen_unique_rtl_modules();\n";
    }
    print FH "  }\n";
    print FH "};\n\n";
...
#stim vector
    if($i <= 100 || $i > 150 && $i <= 200 || $i > 300 && $i <= 500) {
...
#testbench tb
	...
	elsif($i > 50 && $i <= 100 || $i > 150 && $i <= 200 || $i > 350 && $i <= 400) {
	    print FH "    gen_unique_rtl_modules();\n";
	}
	print FH "  }\n";
	print FH "};\n\n";
