...
print "the path for generated tests is : $path"."conn_pattern_replication_ifc_sg_invalid/ \n";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val5);
    &mkDir("$path/conn_pattern_replication_ifc_sg_invalid");
    open(FH,">$path/conn_pattern_replication_ifc_sg_invalid/$test_name");
    print FH "//Generated by Petronela\n";
    print FH "//testing the cmd connect_by_pattern for connections ifc[+.ifc] to replication exp.,sg[+.sg] to replication expr. \n\n";
    ...
    print FH "  d() {\n";
    if($i <= 15) {
        print FH "    ifca5.connect_by_pattern({5{b0.a0.p_a$i}},$word);\n";
        print FH "    sgd5.connect_by_pattern({3{c0.c0.a1.p,c0.b0.a0.p_a_br$i}},$word1);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    c1.sgb4.connect_by_pattern({6{p_d$i}},$word);\n";   
        print FH "    c0.ifcb4.ifca0.connect_by_pattern({5{d.p}},$word1);\n";
    }
    elsif($i > 30) {
        print FH "    c0.b0.sgd3.sgb0..connect_by_pattern(3{c0.pc},$word);\n";
        print FH "    c0.ifcd4.connect_by_pattern({2{s_d_br$i}},$word1);\n";
     }
    ...
    print FH "  e() {\n";
    if($i <= 15) {
        print FH "    d0.c0.a0.ifca2.connect_by_pattern({2{c0.b0.p_b$i,c0.b0.p}},$word3);\n";
        print FH "    ifcd6.ifcb0.connect_by_pattern({3{c0.b1.sb}},$word4);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    b0.a1.ifcd2.connect_by_pattern({5{c0.b0.a1.s_a$i}},$word3);\n";
        print FH "    d1.c0.b1.sgb3.connect_by_pattern({2{c0.b1.p_b$i}},$word4);\n";
    }
    elsif($i > 30) {
        print FH "    ifca6.connect_by_pattern({6{c0.b0.pb}},$word3);\n";
        print FH "    d1.c0.sgb4.connect_by_pattern({6{d0.c1.b1.p_b$i}},$word4);\n"; 
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 15) {
        print FH "    sgb7.sga0.connect_by_pattern({3{e0.d0.bc0.b0.a0.p_a_br$i,e0.d0.c0.b0.a0.p}},$word5);\n";
        print FH "    e1.d0.c0.b0.a1.ifcd2.ifcb1.ifca1.connect_by_pattern({5{d1.c0.p_c$i}},$word6);\n";
    }
    elsif($i > 15 && $i <= 30) {
        print FH "    e0.d0.c0.sgd4.connect_by_pattern({4{e1.d0.a0.p_a$i}},$word5);\n";
        print FH "    d0.sgb5.sga1.connect_by_pattern({3{e0.d0.b0.pb}},$word6);\n";
    }
    elsif($i > 30) {
        print FH "    d1.c0.a0.ifcd2.connect_by_pattern(5{d0.p_d$i}},$word6);\n";
        print FH "    sgd7.connect_by_pattern({3{p_top$i}},$word7);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
