...
print "Generated tests path : test/csl_test_gen/assign_concat_valid1/\n";
...
sub createCslFile {
    ...
    if($test_name=~/(_legal)/){
        &mkDir("$path/assign_concat_valid1");
        open(FH,">$path/assign_concat_valid1/$test_name");
    }
...
#    print FH "   s_a2_$k = {p_a2_$k, p_a3_$k} ;  \n";
   ...
   print FH "csl_signal s1($val3);\n";
    ...
    print FH "  top() { \n"; 
    if($k <= 5) { 
    print FH "    s_u1_$k = {p_b1_$k, p_b2_$k, p_c1_$k, p_c2_$k} ; \n";
    print FH "    s_u2_$k = {p_b3_$k, p_c3_$k} ; \n";
    print FH "    p_u1_$k={s1};\n";
    print FH "    p_u2_$k=s2;\n";
    print FH "// Assign concat_ports_and_one_signal in the same unit. \n\n";
    }
    elsif($k > 5 && $k <= 10) {
    print FH "   s_u1_$k = {p_a1_$k, p_a2_$k, p_a3_$k, p_a4_$k, p_u1_$k, p_u2_$k} ;  \n";
    print FH "   s_u2_$k = {p_a5_$k, p_b3_$k, p_c3_$k} ;  \n";
    print FH "// Assign concat_ports_and_one_signal in the same unit. \n\n";
    }
    elsif($k > 10 && $k <= 15) {
    print FH "    s_u1_$k = {s_b_$k, s_c_$k} ; \n";
    print FH "    s_u2_$k = {s_a1_$k, s_b_$k} ; \n";
    print FH "    p_u1_$k={s1};\n";
    print FH "    p_u2_$k=s2;\n";
    print FH "// Assign concat_signals_and_one_signal in the same unit. \n\n";
    }
