...
sub main {  
    ...
    my ($k, $ctests, $u) = @_; 
    my $test_name = "concat_assign".$k."_".$u."_legal.csl";
...
#  if ($j==1 ) {
#     print ("Generated path:  $path/concat_assign_valid/ \n"); }
    ...
    if($test_name=~/(_legal)/){
        &mkDir("$path/concat_assign_valid");
        open(FH,">$path/concat_assign_valid/$test_name");
    }
    elsif($test_name=~/(_illegal)/) {
        &mkDir("$path/concat_assign_invalid"); 
        open(FH,">$path/concat_assign_invalid/$test_name");
    }
    ...
    print FH "    p_y_$k = {s_k1_$k, s_x_$k} ; \n";
    }
    elsif($k > 5 && $k <= 10) {
    print FH "   p_z_$k = {s_x_$k, s_y_$k} ;  \n";
    print FH "   p_t_$k = {s_k1_$k, s_y_$k} ;  \n";
    }
    elsif($k > 10 && $k <= 15) {
    print FH "    p_t_$k = {s_x_$k, s_y_$k} ; \n";
    print FH "    p_k1_$k = {s_y_$k, s_k1_$k} ; \n";
    ...
    print FH "    p_b_$k = {s_k2_$k, s_a_$k} ; \n";
    }
    elsif($k > 5 && $k <= 10) {
    print FH "   p_k2_$k = {s_a_$k, s_b_$k} ; \n";
    print FH "   p_a_$k = {s_k2_$k, s_b_$k} ; \n";
    }
    elsif($k > 10 && $k < 15) {
