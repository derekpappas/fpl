...
print "the path for generated tests is : $path"."conn_units_pps_s_invalid/ \n";
...
sub main {
    my ($i,$l, $u) = @_;
    my $test_name = "conn_units_pps_s$i"."_".$l."_".$u."_illegal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/conn_units_pps_s_invalid");
    open(FH,">$path/conn_units_pps_s_invalid/$test_name");

    print FH "//Generated by Petronela\n";
    print FH "//testing the method connect_units for connections port[part select] to signal and signal to port[part select]\n\n";
    ...
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    s_d$i.connect_units(a0.p_a".$i."[$u:$l]);\n";
        print FH "    c0.p_c".$i."[$u-:$l].connect_units(s_d_br$i);\n";
        print FH "    p_d$i"."[$u:$l].connect_units(s_a$i);\n";
    }
    elsif($i > 2 && $i <= 4) {
        print FH "    s_d$i.connect_units(pc[$u:$l]);\n";
        print FH "    b0.p_b".$i."[$u:$l].connect_units(s_d$i);\n";
        print FH "    pd[$u-:$l].connect_units(s_a$i);\n";
    }
    elsif($i > 4) {
        print FH "    s_d$i.connect_units(a0.p[$u:$l]);\n";
        print FH "    c0.pc[$u-:$l].connect_units(sd);\n";
    }
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    s_e_br$i.connect_units(a0.pa[$u:$l]);\n";
        print FH "    b0.p[$u:$l].connect_units(s_e$i);\n";
        print FH "    b0.p[$u:$l].connect_units(s_e_br$i);\n";
    }
    elsif($i > 1 && $i <= 3) {
        print FH "    s_e$i.connect_units(c0.p[$u:$l]);\n";
        print FH "    s_e_br$i.connect_units(b0.p_b$i"."[$u-:$l]);\n";
    }
    elsif($i > 3) {
        print FH "    p[$u:$l].connect_units(s_b_br$i);\n";
        print FH "    se.connect_units(a0.p_a_br$i"."[$u:$l]);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 2) {
        print FH "    stop.connect_units(d0.a0.p_a$i"."[$u:$l]);\n";
        print FH "    s_top$i.connect_units(e0.c0.p_c$i"."[$u:$l]);\n";
        print FH "    d0.p_d_br$i"."[$u-:$l].connect_units(e0.a0.s_a$i);\n";
    }
    elsif($i == 3) {
        print FH "    s_top$i.connect_units(e0.a0.p_a$i"."[$u:$l]);\n";
        print FH "    stop.connect_units(d0.b0.p_b$i"."[$u:$l]);\n";
        print FH "    p[$u-:$l].connect_units(e0.b0.s_b$i);\n";
    }
    elsif($i > 3) {
        print FH "    s_top_br$i.connect_units(e0.p_e$i"."[$u:$l]);\n";
        print FH "    s_top_br$i.connect_units(e0.p[$u-:$l]);\n";
        print FH "    d0.a0.pa[$u:$l].connect_units(stop);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
