...
print "the path for generated tests is : $path"."conn_units_s_s_invalid/ \n";
...
sub main {
    my ($i,$var,$it1) = @_;
    my $test_name = "connect_units_s_s".$i."_".$it1."_illegal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/conn_units_s_s_invalid");
    open(FH,">$path/conn_units_s_s_invalid/$test_name");
    
    print FH "//Generated by Petronela\n";
    print FH "//testing the method connect_units for signal to signal\n\n";
    ...
    print FH "  d() {\n";
    if($i <= 5) {
        print FH "    s_d$i.connect_units($var);\n";
        print FH "    c0.sc.connect_units(s_d_br$i);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    s_d$i.connect_units(a0.s_a$i);\n";
        print FH "    s.connect_units(b0.s_b$i);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    s_d$i.connect_units(s);\n";
    }
    ...
    print FH "  e() {\n";
    if($i <= 5) {
        print FH "    s_e_br$i.connect_units(a0.sa);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    s_e$i.connect_units($var);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    s_e$i.connect_units(a0.s_a_br$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 5) {
        print FH "    stop.connect_units(d0.a0.s_a$i);\n";
        print FH "    s.connect_units($var);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    s_top$i.connect_units(e0.a0.s_a$i);\n";
        print FH "    stop.connect_units($var);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    s_top_br$i.connect_units($var);\n";
        print FH "    s.connect_units(s);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
