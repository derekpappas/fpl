...
*
*  Description :  K7J643682M (1M x 36 SRAM)
*
*  File Name   :  k7j643682m.v
*  Version     :  Rev0.6
*  Date        :  Jan 7th, 2002
*
...
*   0.5  Seungmin Lee   (82) 31-209-3823  12/22/2001  Correct the part of command fetch, when the skew between K and K_N occur
...
module k7j643682m (D, Q, SA, RW_N, LD_N, BW_N, K, K_N, C, C_N, CQ, CQ_N, DOFF_N);
