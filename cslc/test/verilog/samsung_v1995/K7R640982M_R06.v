/****************************************************************************************
* 
*  SAMSUNG K7R640982M QDRII-b2 SRAM Verilog Behavioral model
*  
*  Description :  K7R640982M (8MM x 09 QDRII-2B SRAM)
*
*  File Name   :  K7R640982M_R06.v 
*  Version     :  0.6 
...
module K7R640982M (D, Q, SA, R_N, W_N, BW_N, K, K_N, C, C_N, CQ, CQ_N, DOFF_N);

        parameter       addr_bits = 22;
        parameter       data_bits = 09;
        parameter       mem_sizes = 8388608 - 1 ;                                //  1M
