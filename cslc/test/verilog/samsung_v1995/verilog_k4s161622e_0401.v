...
`ifdef M16
	...
	`endif //end of S80
        `ifdef S70 //M16+G9+LVTTL
            ...
            `define tRASmax 100000      // row active maximum time
            `define tRC     69         // row cycle time(min)
