//
//	File Name: K7M321825M.v
//	Version  : Rev 0.1
//	NOV  6 2001
//
//	Description: ( 32Mb X18 NtSRAM ) 
//
...
`endif
     ...
     `define     addr_bits  21   // Address is 19 bits + 2bit(Burst count)
...
module K7M321825M ( Dq, Addr, K, CKEb, 
	   	  Bwa_n, Bwb_n,
	   	  WEb, ADV, OEb,                  
	   	  CS1b, CS2, CS2b, LBOb, ZZ ); 

parameter mem_sizes = 2*1024*1024 -1 ;                                //  1M
...
reg     ck ;	    					      // clk
reg     ckb ;	    					      // clkb
reg     [`data_bits -1 : 0] mem [ 0 : mem_sizes ];              // common IO = 18 ,512K
...
if((zz==0)&&( now_adv==0 )&&(now_state==0)&&(now_deselect==0))   // Single Write
		...
		//   Write Burst Logic  //
                //////////////////////////
        	//if((single_w==1)&&( now_adv==1 )&&(burst_state[t]==0)&&(deslct==0))  // Write Burst
...
/////////////////////   Write Logic END   //////////////////////
		...
		//  Read Logic  //
        	...
        	//if((single_r==1)&&( ADV==1 )&&(burst_state[t]==1)&&(oeb==0)&&(deslct==0))   // Read Burst
