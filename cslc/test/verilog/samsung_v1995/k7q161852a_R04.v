...
*  
*  Description :  K7Q161852A (1M x 18 QDR-b2 SRAM)
*
*  File Name   :  k7q161852a.v 
*  Version     :  Rev0.4 
*  Date        :  Jan 7th, 2002
*
...
// QDR speed option (fc16, fc13, fc10)

`ifdef fc16
	`define		tKHKH		6.0	// Min clock cycle time      
	`define		tKHKL		2.4	// Min clock high time   
	`define		tKLKH		2.4     // Min clock low time 
	...
	`define		tKHCH		0.0     // Min clock to data clock
        `define         tCHQV           2.5     // Max C, C_b high to output valid
        `define         tCHQX           1.2     // Min C, C_b high to output hold
        `define         tCHQZ           2.5     // Max C high to output high-z
...
// In case C and C_b tied to high, QDR speed option is fc16_ocf, fc13_ocf & fc10_ocf
...
module k7q161852a (D, Q, SA, R_N, W_N, BW_N, K, K_N, C, C_N);
