/***************************************************************************************
*
*  SAMSUNG 32Mb DDR2 CIO b4 SRAM Verilog Behavioral model
*
*  Description :  K7I323684M (1M x 36 SRAM)
*
*  File Name   :  k7i323684m.v
*  Version     :  Rev0.3
*  Date        :  Dec 22th, 2001
*
...
////////////////////////////////////////////////////////////////////////////// 
       	...
       	if (ocf == 1) begin
         	...
         	if ((rcount[dor_r + bu_n ] == 0) && (rcount[dor_r] == 1)) begin
            		$display("%m : at time %t : N-R (ocf = 1)", $realtime);
             		//OUT_BUF <= #(nKHKL + `tCHQX1) {data_bits{1'bz}};
         	...
         	// Read - Read
            		...
            		//OUT_BUF <= #(nKHKL + `tCHQX) {data_bits{1'bz}};
            		OUT_BUF <= #`tCHQV OUT_REG;
         	end
		...
		// Continue
            		...
            		//OUT_BUF <= #(nKLKH + `tCHQX) {data_bits{1'bz}};
            		OUT_BUF <= #`tCHQV OUT_REG;
         	end
