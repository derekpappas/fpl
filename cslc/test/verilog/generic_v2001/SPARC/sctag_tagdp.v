...
dff     #(`TAG_WIDTH-6)  ff_wrdata_tag_c1  	
...
dff  #(30)  ff_tagdp_lkup_addr_c4  (.din(tagdp_lkup_addr_c3[39:10]), .clk(rclk),
...
dff  #(`TAG_WIDTH)  ff_tagdp_evict_tag_c4  (.din(tagdp_evict_tag_c3[`TAG_WIDTH-1:0]), .clk(rclk),
                   .q(tagdp_evict_tag_c4[`TAG_WIDTH-1:0]), .se(se), .si(), .so());

dff  #(`TAG_WIDTH)  ff_tagdp_diag_data_c6  (.din(tagdp_evict_tag_c4[`TAG_WIDTH-1:0]), .clk(rclk),
                   .q(tagdp_diag_data_c6[`TAG_WIDTH-1:0]), .se(se), .si(), .so());

dff  #(`TAG_WIDTH)  ff_tagdp_diag_data_c7  (.din(tagdp_diag_data_c6[`TAG_WIDTH-1:0]), .clk(rclk),
...
dff     #(6)    ff_ecc_c2     (.din(tag_acc_ecc_c1[5:0]), .clk(rclk),
             .q(tag_acc_ecc_c2[5:0]), .se(se), .si(), .so());

dff     #(6)    ff_ecc_c3     (.din(tag_acc_ecc_c2[5:0]), .clk(rclk),
             .q(tag_acc_ecc_c3[5:0]), .se(se), .si(), .so());

dff     #(6)    ff_ecc_c4     (.din(tag_acc_ecc_c3[5:0]), .clk(rclk),
             .q(tag_acc_ecc_c4[5:0]), .se(se), .si(), .so());

dff     #(6)    ff_ecc_c5     (.din(tag_acc_ecc_c4[5:0]), .clk(rclk),
             .q(tag_acc_ecc_c5[5:0]), .se(se), .si(), .so());

dff     #(6)    ff_ecc_c6     (.din(tag_acc_ecc_c5[5:0]), .clk(rclk),
             .q(tag_acc_ecc_c6[5:0]), .se(se), .si(), .so());

dff     #(6)    ff_ecc_c7     (.din(tag_acc_ecc_c6[5:0]), .clk(rclk),
             .q(tag_acc_ecc_c7[5:0]), .se(se), .si(), .so());

dff     #(6)    ff_ecc_c8     (.din(tag_acc_ecc_c7[5:0]), .clk(rclk),
...
dff  #(1)  ff_addr11_c4  (.din(lkup_addr_c3[11]), .clk(rclk),
