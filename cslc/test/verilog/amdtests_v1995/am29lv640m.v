...
//    V0.1    A.Savic       03 July   22  Initial
...
//    v0.4   M.Marinkovic   03 Dec 10     RY# is open drain
//                                        mem cannot be 2D array
//    v0.5   M.Marinkovic   03 Dec 11     Path delay section corrected
//    v0.6   M.Marinkovic   03 Dec 15    Corrected verilog problem in NCsim
//    v0.7   M.Marinkovic   04 Jan 16    Memory preload changed
//                                       Path delay changed to pin-to-pin
//    v0.8   A.Savic        26 Apr 04    Sector Erase Timer reset fix
//
//////////////////////////////////////////////////////////////////////////////
//  PART DESCRIPTION:
//
...
//  Part:           AM29LV640MH/L
//
//  Description:    64Mbit (4M x16-Bit/8M x8-Bit) Uniform Sector Flash Memory
//
//
//////////////////////////////////////////////////////////////////////////////
//  Known Bugs:
...
//  internal delays
    ...
    parameter mem_file_name   = "none";//"am29lv640m.mem";
    parameter prot_file_name  = "none";//"am29lv640m_prot.mem";
    parameter secsi_file_name = "none";//"am29lv_secsi.mem";

    parameter TimingModel = "DefaultTimingModel";//"AM29LV640H90R";

    parameter PartID = "AM29LV640MH";
...
//    nmos   (RDY ,   RY_zd     , 1);
 ...
 specify
     ...
     specparam   tdevice_WBPB                    = 11000; // 11 us
            //Program Operation
     specparam   tdevice_POB                     = 100000; //100 us;
 ...
 reg deq;
    ...
    reg     sector_prot[0:128];
        ...
        begin
           ...
           //am29lv640mh_prot  sector protect file
           //   //      - comment
           ...
           // Memory Preload
           //am29lv640m.mem, memory preload file
