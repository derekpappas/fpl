/////////////////////////////////////////////////////////////////////////////////////////
//
// File:           - M45PE40_Macro.v
// Date:           - July 2004
// Author:         - Xue-feng Hu at MPG Memory Competence Center of China
// Description:    - Define macro regarding characteristics of M45PE40 SPI flash memory 
...
//=======================================================================================
//                          M45PE40         M45PE20         M45PE40(*)      M45PE80
//=======================================================================================
...
//=======================================================================================
`define DATA_BITS           8
`define MEM_SIZE            524288          //4M bits = 512K bytes
`define MEM_ADDR_BITS       19              //memory address bits
`define PAGES               2048            //2048 pages
`define PAGE_SIZE           256             //256 bytes in each page
`define PAGE_ADDR_BITS      11              //page address bits
`define PAGE_OFFSET_BITS    8               
`define SECTORS             8               //8 sectors
`define SECTOR_SIZE         65536           //64K bytes in each sector
`define SECTOR_ADDR_BITS    3
