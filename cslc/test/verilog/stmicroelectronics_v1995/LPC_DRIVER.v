/*****************************************************************************
  ...
  M50FLW040 LPC Interface Access Driver for Verification
...
//-----------------------------------------------
    ...
    #10 lpc_writereg_op(`MEM_ADDR_BITS'h00002,8'h00); //Reset Block 0 lock reg
    #10 lpc_readreg_op(`MEM_ADDR_BITS'h00002);
    #10 lpc_writereg_op(`MEM_ADDR_BITS'h00002,8'h02); //Lock down Block 0 lock reg
    #10 lpc_readreg_op(`MEM_ADDR_BITS'h00002);
    ...
    $display("========================================================");
    #10; lpc_readreg_op(19'h40000);

    $display("========================================================");
    $display("        Testing 4: Read Electronic Signature Code.");
    $display("========================================================");
    #100 Lpc_ElectronicSignatureCmd;
    #100 lpc_readmem_op(19'h00000);
    #100 lpc_readmem_op(19'h00001);

    $display("========================================================================");
    $display("        Testing 5: BLOCK0~6 WRITE PROTECT AND WRITE LOCK.");
    $display("========================================================================");
    #100; wp_n = 1'b0;  //write protect enable
    #100; lpc_writereg_op(19'h00002,8'h00); //reset block0 lock reg
    #100; Lpc_ProgramCmd(19'h00000,8'h55);  //program to block 0
    #`Time_Program;
    ...
    #100; lpc_writereg_op(19'h00002,8'h01); //set wr lock bit in block0 lock reg
    #100; Lpc_ProgramCmd(19'h00000,8'h55);  //program to block 0
    #`Time_Program;
    #100; Lpc_ReadMemoryArrayCmd;           //read data
    #100; lpc_readmem_op(19'h00000);
    ...
    #100; lpc_writereg_op(19'h70002,8'h00); //reset block7 lock reg
    #100; Lpc_ProgramCmd(19'h70000,8'h55);  //program to block 7
    #`Time_Program;
    #100; Lpc_ReadMemoryArrayCmd;           //read data
    #100; lpc_readmem_op(19'h70000);

    #100 Lpc_ClearStatusRegisterCmd;

    #100; tbl_n = 1'b1;  //write protect disable
    #100; lpc_writereg_op(19'h70002,8'h01); //set wr lock bit in block7 lock reg
    #100; Lpc_ProgramCmd(19'h70000,8'h55);  //program to block 7
    #`Time_Program;
    #100; Lpc_ReadMemoryArrayCmd;           //read data
    #100; lpc_readmem_op(19'h70000);
    ...
    $display("===========================================================================");
    #100; lpc_writereg_op(19'h70002,8'h04); //set rd lock bit in block7 lock reg
    #100; lpc_readmem_op(19'h70000);
    #100; lpc_writereg_op(19'h70002,8'h00); //reset read-lock bit
    #100; lpc_readmem_op(19'h70000);
    ...
    #100 lpc_writereg_op(19'h00002,8'h00);  //reset write-lock bit
    #100 lpc_writereg_op(19'h10002,8'h00);  //reset write-lock bit
    #100 lpc_writereg_op(19'h20002,8'h00);  //reset write-lock bit
    #100 lpc_writereg_op(19'h30002,8'h00);  //reset write-lock bit
    #100 lpc_writereg_op(19'h40002,8'h00);  //reset write-lock bit
    #100 lpc_writereg_op(19'h50002,8'h00);  //reset write-lock bit
    #100 lpc_writereg_op(19'h60002,8'h00);  //reset write-lock bit
    #100 lpc_writereg_op(19'h70002,8'h00);  //reset write-lock bit

    #100 Lpc_ProgramCmd(19'h0ffff,8'h55);
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h20000,8'h55);
    #`Time_Program;

    #100 Lpc_ProgramCmd(19'h10001,8'h11);
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h10001,8'haa);   //can not change 0 to 1
    #`Time_Program;

    #100 Lpc_ClearStatusRegisterCmd;
    
    #100 Lpc_ReadMemoryArrayCmd;
    #100 lpc_readmem_op(19'h10000);
    #100 lpc_readmem_op(19'h10001);
    #100 lpc_readmem_op(19'h10002);
    #100 lpc_readmem_op(19'h0ffff);
    #100 lpc_readmem_op(19'h20000);

    $display("======================================================");
    $display("        Testing 9: BLOCK ERASE VALIDATION.");
    $display("======================================================");
    #100 Lpc_BlockEraseCmd(19'h10000);
    #`Time_BlockErase_n;
    #100 Lpc_ReadMemoryArrayCmd;
    ...
    #100 lpc_readmem_op(19'h10001);
    #100 lpc_readmem_op(19'h10002);
    #100 lpc_readmem_op(19'h10003);
    #100 lpc_readmem_op(19'h10004);
    #100 lpc_readmem_op(19'h10005);
    #100 lpc_readmem_op(19'h10006);
    #100 lpc_readmem_op(19'h10007);
    #100 lpc_readmem_op(19'h10008);
    #100 lpc_readmem_op(19'h0ffff);
    #100 lpc_readmem_op(19'h20000);
    ...
    $display("======================================================");
    #100 Lpc_ProgramCmd(19'h07000,8'h77);
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h07fff,8'h77);
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h06fff,8'h66);
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h08000,8'h88);
    #`Time_Program;
    #100 Lpc_ReadMemoryArrayCmd;
    #100 lpc_readmem_op(19'h06fff);
    #100 lpc_readmem_op(19'h07000);
    #100 lpc_readmem_op(19'h07fff);
    #100 lpc_readmem_op(19'h08000);
    #100 Lpc_SectorEraseCmd(19'h07000);
    #`Time_SectorErase_n;
    #100 Lpc_ReadMemoryArrayCmd;
    #100 lpc_readmem_op(19'h06fff);
    #100 lpc_readmem_op(19'h07000);
    ...
    $display("=========================================================");
    #100 lpc_readmem_op(19'h6fffc);
    #100 lpc_readmem_op(19'h6fffd);
    #100 lpc_readmem_op(19'h6fffe);
    #100 lpc_readmem_op(19'h6ffff);
    #100 Lpc_ProgramCmd(19'h6fffc,8'h56); //Program "56" to address 6fffch
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h6fffd,8'h78); //Program "78" to address 6fffch
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h6fffe,8'h9a); //Program "9a" to address 6fffch
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h6ffff,8'hbc); //Program "bc" to address 6fffch
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    #`Time_Program;
    ...
    $display("===========================================================");
    #100 Lpc_BlockEraseCmd(19'h60000);
    ...
    $display("=============================================================");
    #100 Lpc_ProgramCmd(19'h00ffc,8'h56); //Program "56" to address 00ffch
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h00ffd,8'h78); //Program "78" to address 00ffdh
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h00ffe,8'h9a); //Program "9a" to address 00ffeh
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h00fff,8'hbc); //Program "bc" to address 00fffh
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h01000,8'hde);
    #100 lpc_readmem_op(19'h00000);       //read sr
    #`Time_Program;
    #100 Lpc_ReadMemoryArrayCmd;
    #100 lpc_readmem_op(19'h00ffc);
    #100 lpc_readmem_op(19'h00ffd);
    #100 lpc_readmem_op(19'h00ffe);
    #100 lpc_readmem_op(19'h00fff);
    #100 lpc_readmem_op(19'h01000);
    #100 Lpc_SectorEraseCmd(19'h00ffe);
    #5000 Lpc_PESuspendCmd;
    #`Time_EraseSusp
    #100 Lpc_PEResumeCmd;
    #`Time_SectorErase_n;
    ...
    $display("======================================================================");
    #100 Lpc_BlockEraseCmd(19'h00ffe);    //Block 0 Erase
    #`Time_BlockErase_n;
    #100 Lpc_ProgramCmd(19'h00000,8'haa); //Program "aa" to address 00000h
    #`Time_Program;
    #100 Lpc_ReadMemoryArrayCmd;
    #100 lpc_readmem_op(19'h00000);       //Read data from address 00000
    #100 lpc_readmem_op(19'h4fffc);
    #100 lpc_readmem_op(19'h4fffd);
    #100 lpc_readmem_op(19'h4fffe);
    #100 lpc_readmem_op(19'h4ffff);       //Read data from address 4fffc~4ffff
    #100 Lpc_BlockEraseCmd(19'h00ffe);    //Block 0 Erase
    #5000 Lpc_PESuspendCmd;               //Block Erase Suspend
    #`Time_EraseSusp;
    #100 Lpc_ProgramCmd(19'h4fffc,8'h56); //Program "56" to address 4fffch
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h4fffd,8'h78); //Program "78" to address 4fffdh
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h4fffe,8'h9a); //Program "9a" to address 4fffeh
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h4ffff,8'hbc); //Program "bc" to address 4ffffh
    #`Time_Program;
    ...
    #100 Lpc_BlockEraseCmd(19'h00ffe);    //Block 0 Erase
    #`Time_BlockErase_n;
    #100 Lpc_ProgramCmd(19'h00000,8'hbb); //Program "bb" to address 00000h
    #`Time_Program;
    #100 Lpc_ReadMemoryArrayCmd;
    #100 lpc_readmem_op(19'h00000);       //Read data from address 00000
    #100 lpc_readmem_op(19'h3fffc);
    #100 lpc_readmem_op(19'h3fffd);
    #100 lpc_readmem_op(19'h3fffe);
    #100 lpc_readmem_op(19'h3ffff);       //Read data from address 3fffc~3ffff
    #100 Lpc_SectorEraseCmd(19'h00f11);   //Sectror 0 Erase
    #5000 Lpc_PESuspendCmd;               //Block Erase Suspend
    #`Time_EraseSusp;
    #100 Lpc_ProgramCmd(19'h3fffc,8'h11); //Program "11" to address 3fffch
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h3fffd,8'h22); //Program "22" to address 3fffdh
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h3fffe,8'h33); //Program "33" to address 3fffeh
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    #`Time_Program;
    #100 Lpc_ProgramCmd(19'h3ffff,8'h44); //Program "44" to address 3ffffh
    #100 lpc_readmem_op(19'h00000);       //read sr
    #5000 Lpc_PESuspendCmd;               //Program Suspend
    #`Time_ProgSusp
    #100 Lpc_PEResumeCmd;                 //Program Resume
    ...
    #5000 Lpc_PESuspendCmd;                           //Sector Erase Suspend
    #`Time_EraseSusp;
    //#100 lpc_writemem1_op(`MEM_ADDR_BITS'h7FFFF,8'h40);
    //#200 lpc_writemem4_op(address,data1,data2,data3,data4);
    #100 Lpc_ProgramCmd(`MEM_ADDR_BITS'h00f11,8'h11);
    #`Time_Program;
    #100 Lpc_PEResumeCmd;                 //Sector Erase Resume
    #`Time_SectorErase_n;
    ...
    #100 Lpc_BlockEraseCmd(`MEM_ADDR_BITS'h60000);     //block 6
    #5000 Lpc_PESuspendCmd;
    #100 Lpc_ReadMemoryArrayCmd;                       //read data
    #100 Lpc_ElectronicSignatureCmd;
...
*/  
  ...
  task lpc_readmem_op;
    ...
    begin
      ...
      `CLK_CYCLE; fwh_lad_out = 4'b1111;
      `CLK_CYCLE; fwh_lad_out = 4'b1111;
      `CLK_CYCLE; fwh_lad_out = {2'b11,~id1[2:1]};//A22 = 1, A[21:19] = ~ID[2:0]
      `CLK_CYCLE; fwh_lad_out = {~id1[0],address[`MEM_ADDR_BITS-1:`MEM_ADDR_BITS-3]}; 
      `CLK_CYCLE; fwh_lad_out = address[`MEM_ADDR_BITS-4:`MEM_ADDR_BITS-7];	
      `CLK_CYCLE; fwh_lad_out = address[`MEM_ADDR_BITS-8:`MEM_ADDR_BITS-11];
      `CLK_CYCLE; fwh_lad_out = address[`MEM_ADDR_BITS-12:`MEM_ADDR_BITS-15];	
      `CLK_CYCLE; fwh_lad_out = address[`MEM_ADDR_BITS-16:`MEM_ADDR_BITS-19];
  ...
  task lpc_readreg_op;
    ...
    begin
      ...
      `CLK_CYCLE; fwh_lad_out = 4'b1111;
      `CLK_CYCLE; fwh_lad_out = 4'b1111;
      `CLK_CYCLE; fwh_lad_out = {2'b10,~id1[2:1]};//A22 = 1, A[21:19] = ~ID[2:0]
      `CLK_CYCLE; fwh_lad_out = {~id1[0],reg_addr[`MEM_ADDR_BITS-1:`MEM_ADDR_BITS-3]}; 
      `CLK_CYCLE; fwh_lad_out = reg_addr[`MEM_ADDR_BITS-4:`MEM_ADDR_BITS-7];	
      `CLK_CYCLE; fwh_lad_out = reg_addr[`MEM_ADDR_BITS-8:`MEM_ADDR_BITS-11];
      `CLK_CYCLE; fwh_lad_out = reg_addr[`MEM_ADDR_BITS-12:`MEM_ADDR_BITS-15];	
      `CLK_CYCLE; fwh_lad_out = reg_addr[`MEM_ADDR_BITS-16:`MEM_ADDR_BITS-19];
  ...
  task lpc_writereg_op;
    ...
    begin
      ...
      `CLK_CYCLE; fwh_lad_out = 4'b1111;
      `CLK_CYCLE; fwh_lad_out = 4'b1111;
      `CLK_CYCLE; fwh_lad_out = {2'b10,~id1[2:1]}; //A22 = 0, A[21:19] = ~ID[2:0]
      `CLK_CYCLE; fwh_lad_out = {~id1[0], reg_addr[`MEM_ADDR_BITS-1:`MEM_ADDR_BITS-3]};
      `CLK_CYCLE; fwh_lad_out = reg_addr[`MEM_ADDR_BITS-4:`MEM_ADDR_BITS-7];
      `CLK_CYCLE; fwh_lad_out = reg_addr[`MEM_ADDR_BITS-8:`MEM_ADDR_BITS-11];
      `CLK_CYCLE; fwh_lad_out = reg_addr[`MEM_ADDR_BITS-12:`MEM_ADDR_BITS-15];
