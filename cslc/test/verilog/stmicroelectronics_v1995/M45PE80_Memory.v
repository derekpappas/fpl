/////////////////////////////////////////////////////////////////////////////////////////
//
// File:           - M45PE80_Memory.v
// Date:           - July 2004
// Author:         - Xue-feng Hu at MPG Memory Competence Center of China
// Description:    - M45PE80 SPI Bus Flash Memory Verilog Simulation Model
...
//=====================================
// M45PE80 memory simulation model
//=====================================
module M45PE80  (
                    C,
                    D,
...
parameter       memory_capacity         = 8'h14;
...
begin
    ...
    begin
        if(i==0)
        begin
            if(memory_address[`MEM_ADDR_BITS-1:0] == `MEM_ADDR_BITS'hfffff)
