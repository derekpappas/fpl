...
*        Model:  mt48h4m16lf Y25L (1Meg x 16 x 4 Banks)
*
*  Description:  Micron 64 SDRAM Verilog model
*
...
* ---  --------------------------  ---------------------------------------
* 3.3  dritz           02/28/2006  - MT48H4M16LF_B Y25L
* 3.2  dritz           11/04/2005  - Fixed Drive Strength bits
...
`include "parameters_msdr_64.v"

    parameter addr_bits =       12;
    parameter data_bits =       16;
    parameter col_bits  =        8;
    parameter mem_sizes =  1048576;  //64 Meg part -> 1meg device * 16 data_bits * 4 banks
    ...
    always @ (posedge Sys_clk) begin
        ...
        */
        ...
        if (Data_in_enable == 1'b1) begin                                   // Writing Data to Memory
            if (dqm !== 2'b11) begin  // If DQM is not all 1's (If DQM has some 0's)
                if ((dqm | 2'b01) == 2'b11) begin // if bit 1 == 0
                end else begin
                    case (Bank)
                    ...
                    endcase
                end if ((dqm | 2'b10) == 2'b11) begin // if bit 0 == 0
                end else begin
                    case (Bank)
            ...
            if (Dqm_reg0 !== 2'b11) begin // If DQM is not all 1's (If DQM has some 0's)
                if (Dqm_reg0[1] == 1'b0) begin
                    if (Cas_latency_3) begin
                        case (Bank)
