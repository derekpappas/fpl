...
* ----  ----------------------------  ----------  ---------------------------------------
* 0.0a  Son Huynh                     04/29/1999  - First Release (from 64Mb rev 0.0e)
*       Micron Technology Inc.                    - Simple testbench included
* 1.0a  Son Huynh                     08/04/2000  - Improve alternate banks read/write
*       Micron Technology Inc.                      access with auto precharge enable
* 1.1   Yong Phan       208-363-2184  09/26/2001  - Change tOH (2.7ns to 3.0ns)
*       Micron Technology Inc.                      According to Data sheet Rev D.
*
****************************************************************************************/
...
module mt48lc64m4a2 (Dq, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, Dqm);
    ...
    parameter data_bits =        4;                         //  4 bits
    parameter col_bits  =       11;                         // 11 bits
    parameter mem_sizes =     1024;                         // 16 Mb full size = 16777215
