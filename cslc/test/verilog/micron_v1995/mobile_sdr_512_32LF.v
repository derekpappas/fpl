...
*        Model:  mt48h16m32lf (4Meg x 32 x 4 Banks)
*
*  Description:  Micron 512 SDRAM Verilog model
*
...
* ---  --------------------------  ---------------------------------------
* 3.1  dritz           09/22/2005  - MT48H16M32LF simply model rename
...
module model (Dq, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, dqm);

`include "parameters_msdr_512_32LF.v"

    parameter addr_bits =       13;
    parameter data_bits =       32;
    parameter col_bits  =        9;
    parameter mem_sizes =  4194304;  //512 Meg part = 4meg device * 32 data_bits * 4 banks
    ...
    // Timing Parameters for speed group -6
    //parameter tAC3 =   6.0;
    //parameter tAC2 =   8.0;
    //parameter tHZ3 =   7.0;
    //parameter tHZ2 =   8.0;
    ...
    always @ (posedge Sys_clk) begin
                ...
                if (Debug) begin
                    if (Ba == 2'b10) begin
                        ...
                        case (Addr[2 : 0])
                            ...
                            default : $display ("%m :            Error:           CAS Latency      = Reserved");
                        endcase
                        ...
                        case (Addr[6 : 5])
                            ...
                            2'b11    : $display ("%m :                             Drive Strength    = Eighth Strength");
                            default  : $display ("%m :             Error:          Drive Strength    = Reserved");
                        endcase

                        // Reserved
                        case (Addr[11 : 7])
                            5'b00000  : begin end //do nothing
                            default   : $display ("%m :             Error:          Ext_mode_Reg[11:7] are Reserved");
                        endcase
                        ...
                        case (Addr[2 : 0])
                            ...
                            default : $display ("%m :            Error:           Burst Length     = Reserved");
                        endcase
                        ...
                        if (Addr[3] === 1'b0) begin
                            ...
                            $display ("%m :                      Error: Burst Type       = Reserved");
                        end
                        ...
                        if (Addr[9] === 1'b0) begin
                            ...
                            $display ("%m :                      Error: Write Burst Mode = Reserved");
                        end
                    end
                end
        ...
        */
        ...
        if (Data_in_enable == 1'b1) begin                                   // Writing Data to Memory
            if (dqm !== 4'b1111) begin  // If DQM is not all 1's (If DQM has some 0's)
            //    if (dqm == 4'b0) begin  //If DQM is all zeros - 100% data out enable
            //        case (Bank)
            ...
            //        endcase
                ...
                if ((dqm | 4'b0111) == 4'b1111) begin // if bit 3 == 0
                end else begin
                    case (Bank)
                        2'b00 : Bank0 [{Row, Col}][31:24] = Dq[31:24];
                        2'b01 : Bank1 [{Row, Col}][31:24] = Dq[31:24];
                        2'b10 : Bank2 [{Row, Col}][31:24] = Dq[31:24];
                        2'b11 : Bank3 [{Row, Col}][31:24] = Dq[31:24];
                    endcase
                end if ((dqm | 4'b1011) == 4'b1111) begin // if bit 2 == 0
                end else begin
                    case (Bank)
                        2'b00 : Bank0 [{Row, Col}][23:16] = Dq[23:16];
                        2'b01 : Bank1 [{Row, Col}][23:16] = Dq[23:16];
                        2'b10 : Bank2 [{Row, Col}][23:16] = Dq[23:16];
                        2'b11 : Bank3 [{Row, Col}][23:16] = Dq[23:16];
                    endcase
                end if ((dqm | 4'b1101) == 4'b1111) begin // if bit 1 == 0
                end else begin
                    case (Bank)
                    ...
                    endcase
                end if ((dqm | 4'b1110) == 4'b1111) begin // if bit 0 == 0
                end else begin
                    case (Bank)
                ...
                // Display debug message
                if (Debug) begin
                    $display("%m : at time %t WRITE: Bank = %d Row = %d, Col = %d, Data = %h", $time, Bank, Row, Col, Dq);
                end
            end else begin  // DQM is all 1's - 100% data mask
                if (Debug) begin
            ...
            if (Dqm_reg0 !== 4'b1111) begin // If DQM is not all 1's (If DQM has some 0's)

                //if (Dqm_reg0 == 4'b0) begin //If DQM is all zeros - 100% data out enable
                    //if (Cas_latency_3) begin
                        //case (Bank)
                ...
                if (Dqm_reg0[3] == 1'b0) begin
                    if (Cas_latency_3) begin
                        case (Bank)
                            2'b00 : Dq_reg[31:24] <= #tAC3 Bank0[{Row, Col}][31:24];
                            2'b01 : Dq_reg[31:24] <= #tAC3 Bank1[{Row, Col}][31:24];
                            2'b10 : Dq_reg[31:24] <= #tAC3 Bank2[{Row, Col}][31:24];
                            2'b11 : Dq_reg[31:24] <= #tAC3 Bank3[{Row, Col}][31:24];
                        endcase
                    end else begin
                        case (Bank)  // Cas_latency_2
                            2'b00 : Dq_reg[31:24] <= #tAC2 Bank0[{Row, Col}][31:24];
                            2'b01 : Dq_reg[31:24] <= #tAC2 Bank1[{Row, Col}][31:24];
                            2'b10 : Dq_reg[31:24] <= #tAC2 Bank2[{Row, Col}][31:24];
                            2'b11 : Dq_reg[31:24] <= #tAC2 Bank3[{Row, Col}][31:24];
                        endcase
                    end
                end else begin
                    if (Cas_latency_3) begin
                            Dq_reg[31:24] <= #tAC3 8'hzz;
                    end else begin
                            Dq_reg[31:24] <= #tAC2 8'hzz;
                    end
                end if (Dqm_reg0[2] == 1'b0) begin
                    if (Cas_latency_3) begin
                        case (Bank)
                            2'b00 : Dq_reg[23:16] <= #tAC3 Bank0[{Row, Col}][23:16];
                            2'b01 : Dq_reg[23:16] <= #tAC3 Bank1[{Row, Col}][23:16];
                            2'b10 : Dq_reg[23:16] <= #tAC3 Bank2[{Row, Col}][23:16];
                            2'b11 : Dq_reg[23:16] <= #tAC3 Bank3[{Row, Col}][23:16];
                        endcase
                    end else begin
                        case (Bank)  // Cas_latency_2
                            2'b00 : Dq_reg[23:16] <= #tAC2 Bank0[{Row, Col}][23:16];
                            2'b01 : Dq_reg[23:16] <= #tAC2 Bank1[{Row, Col}][23:16];
                            2'b10 : Dq_reg[23:16] <= #tAC2 Bank2[{Row, Col}][23:16];
                            2'b11 : Dq_reg[23:16] <= #tAC2 Bank3[{Row, Col}][23:16];
                        endcase
                    end
                end else begin
                    if (Cas_latency_3) begin
                            Dq_reg[23:16] <= #tAC3 8'hzz;
                    end else begin
                            Dq_reg[23:16] <= #tAC2 8'hzz;
                    end
                end if (Dqm_reg0[1] == 1'b0) begin
                    if (Cas_latency_3) begin
                        case (Bank)
                    ...
                    if (Cas_latency_3) begin
                            Dq_reg[15:8] <= #tAC3 8'hzz;
                    end else begin
                            Dq_reg[15:8] <= #tAC2 8'hzz;
                    end
                end if (Dqm_reg0[0] == 1'b0) begin
                    if (Cas_latency_3) begin
                        case (Bank)
                    ...
                    if (Cas_latency_3) begin
                            Dq_reg[7:0] <= #tAC3 8'hzz;
                    end else begin
                            Dq_reg[7:0] <= #tAC2 8'hzz;
                    end
                end
                if (Debug) begin
                ...
                if (Debug) begin // DQM is all 1's - 100% data mask
