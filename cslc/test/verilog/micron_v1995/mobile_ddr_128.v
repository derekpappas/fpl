...
* 1.3  ritz   01/21/05    - Merged with version 5.2 of the SMG model
* 1.4  ritz   02/15/05    - Fixed display.*WRITE to use hex for "data".
* 1.5  ritz   04/22/05    - Fixed read latency (#0.5 and 2*Read_latency-1) for MMG latency
****************************************************************************************/
...
`endif
    ...
    specify
                                                  ...
                                                  // ------ ----- -----------
`ifdef sg75                                       //              specparams for -7.5 (CL = 3)
        ...
        specparam tDQSH            =     0.4*tCK; // tDQSH  ns    DQS input High Pulse Width
        specparam tDQSL            =     0.4*tCK; // tDQSL  ns    DQS input Low Pulse Width
`else
