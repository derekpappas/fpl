...
//									     **
//  									     **	
// File name		:		CY7C1393AV18.v			     **
//									     **
// Date			:		March 20th , 2003		     **	
// Model		:		CY7C1393AV18(1M x 18 Two word burst **
...
`define mem_size (524288 -1) // 2 arrays of 512K x18 RAM
`define bus_size 18
`define address_bus (19 - 1)
// JTAG Definitions
...
always @(posedge Rd_Clk_n)
	begin
		if (prev_cycle1 == `Read)
			...
			fork
			Data_out[17:0] <= `tCO Mem_array1[Rd_Address_reg1];
			join
		    end	
	end  
...
always @(posedge Rd_Clk)
	begin
		if (prev_cycle2 == `Read)
			...
			Data_out[17:0] = 18'hzz;
			fork	
			Data_out[17:0] <= `tCO Mem_array2[Rd_Address_reg2];
			join
		    end	
	end 
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010100100010101000001101001;	// IDCODE for QDR2 CY7C1393AV18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
