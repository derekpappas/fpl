...
`ifdef sb225
        ...
        `define         tCH             1.8     // Clock HIGH time
        `define         tCL             1.8     // Clock LOW time
...
module CY7C1366_PLDCD (ZZ, Mode, ADDR, GW_N, BWE_N, BWd_N, BWc_N, BWb_N, BWa_N, CE1_N, CE2, CE3_N, ADSP_N, ADSC_N, ADV_N, OE_N, DQ, CLK);
