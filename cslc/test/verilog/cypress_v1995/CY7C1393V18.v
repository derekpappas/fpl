...
//									     **
//  									     **	
// File name		:		CY7C1393V18.v			     **
//									     **
// Date			:		March 20th , 2003		     **	
// Model		:		CY7C1393V18(1M x 18 Two word burst **
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010100100010101000001101001;	// IDCODE for QDR2 CY7C1393V18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
