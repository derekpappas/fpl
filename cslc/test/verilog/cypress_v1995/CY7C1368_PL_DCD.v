...
*       Part #:  CY7C1368B 
*
*  Description:  Cypress 9Mb Synburst SRAM (Pipelined DCD)
*
*
...
// Timings for Different Speed Bins (sb):	225MHz, 200MHz, 167MHz
...
`ifdef sb200
        ...
        `define         tCLZ            1.25    // Clock to Low-Z
...
module CY7C1368_PLDCD (ZZ, Mode, ADDR, GW_N, BWE_N, BWd_N, BWc_N, BWb_N, BWa_N, CE1_N, CE2, CE3_N, ADSP_N, ADSC_N, ADV_N, OE_N, DQ, CLK);
