...
*       Part #:  CY7C1215H (32K x 32)
*
*  Description:  Cypress 1Mb Synburst SRAM (Pipelined SCD)
*
*
...
module CY7C1215H_PLSCD (ZZ, Mode, ADDR, GW_N, BWE_N, BWd_N, BWc_N, BWb_N, BWa_N, CE1_N, CE2, CE3_N, ADSP_N, ADSC_N, ADV_N, OE_N, DQ, CLK);

    parameter                       addr_bits =     15;         //  	17 bits
    parameter                       data_bits =     32;         //  	32 bits
    parameter                       mem_sizes = 32768;         // 	32K
