...
//
//  
//	Model:	CY7C1414AV18 1M x 36 QDR(tm)-II Burst-of-2 SRAM
// 	Date:		Sept 29, 2004
//
//	Release:	1.0 
//
...
//
//	Revision History
//	Rev 1.0-(RKF) Model Created, based on the QDR(tm)-II B2 x18 model w/ JTAG.
//
...
`define no_words (524288 -1)		// 512K x 36 RAM (Uses 2)
...
`define tclkcyc	#100		// TCK cycle time (min)			CHECK JTAG TIMINGS
...
module cyqdr2_b2(TCK, TMS, TDI, TDO, D, Q, A, K, K_n, C, C_n, RPS_n, WPS_n, BW0_n, BW1_n, BW2_n, BW3_n, CQ, CQ_n, ZQ, DOFF_b);
...
reg[18:0] Read_Address, Read_Address_o, Read_Address_o_o, Write_Address;
...
reg Set_CQ_Rise_Flag1, Set_CQ_n_Rise_Flag1, Set_CQ_Rise_Flag2, Set_CQ_n_Rise_Flag2, Set_CQ_Fall_Flag1, Set_CQ_n_Fall_Flag1, Set_CQ_Fall_Flag2, Set_CQ_n_Fall_Flag2, Setter, Modified_Setter,Single_Dual_Flag, Count_2_10_Flag;

integer Count2, Count10, Count1000;

parameter DLL_DelayCycles = 3;
parameter Wait_Cycles = (DLL_DelayCycles - 1);
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00011010011010100111000001101001;	// IDCODE for QDR2 CY7C1514V18 device. This may not be changed.
