...
module cy1304( TCK,TMS,TDI,TDO,D, Q, A, K, Kb, RPSb, WPSb, BWS0b, BWS1b, C, Cb,ZQ); 
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00101011010011010110000001101001;	// IDCODE for QDR CY7C1304CV25 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
