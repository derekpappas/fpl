// *******************************************************************************************************
// **                                                                           			**
// **   M24LC128.v - 24LC128 128K-BIT I2C SERIAL EEPROM (VCC = +2.5V TO +5.5V)				**
// **                                                                           			**
// *******************************************************************************************************
// **                                                                           			**
...
module M24LC128 (A0, A1, A2, WP, SDA, SCL, RESET);
...
// *******************************************************************************************************
   ...
   reg	[13:00]		StartAddress;			// memory access starting address
   reg	[05:00]		PageAddress;			// memory page address

   reg	[07:00]		WrDataByte [0:63];		// memory write data buffer
   wire [07:00]		RdDataByte;			// memory read data

   reg	[13:00]		WrCounter;			// write buffer counter

   reg	[05:00]		WrPointer;			// write buffer pointer
   reg	[13:00]		RdPointer;			// read address pointer

   reg			WriteActive;			// memory write cycle active

   reg	[07:00]		MemoryBlock0 [0:2047];		// EEPROM data memory array
   reg	[07:00]		MemoryBlock1 [0:2047];		// EEPROM data memory array
   reg	[07:00]		MemoryBlock2 [0:2047];		// EEPROM data memory array
   reg	[07:00]		MemoryBlock3 [0:2047];		// EEPROM data memory array
   reg	[07:00]		MemoryBlock4 [0:2047];		// EEPROM data memory array
   reg	[07:00]		MemoryBlock5 [0:2047];		// EEPROM data memory array
   reg	[07:00]		MemoryBlock6 [0:2047];		// EEPROM data memory array
   reg	[07:00]		MemoryBlock7 [0:2047];		// EEPROM data memory array
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(negedge SCL) begin
      if (CTRL_Rcvd & (BitCounter == 8)) begin
         if (RdWrBit == 0) begin
            StartAddress[13:08] <= ShiftRegister[05:00];
            RdPointer[13:08]    <= ShiftRegister[05:00];
...
// -------------------------------------------------------------------------------------------------------
   ...
   always @(posedge WriteActive) begin
      for (LoopIndex = 0; LoopIndex < WrCounter; LoopIndex = LoopIndex + 1) begin
         ...
         case (StartAddress[13:11])
            3'b000 : MemoryBlock0[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
            3'b001 : MemoryBlock1[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
            3'b010 : MemoryBlock2[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
            3'b011 : MemoryBlock3[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
            3'b100 : MemoryBlock4[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
            3'b101 : MemoryBlock5[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
            3'b110 : MemoryBlock6[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
            3'b111 : MemoryBlock7[{StartAddress[10:06],PageAddress[05:00]}] = WrDataByte[LoopIndex[05:00]];
         endcase
      end
   end
...
// -------------------------------------------------------------------------------------------------------
   ...
   assign RdDataByte = {8{(RdPointer[13:11] == 0)}} & MemoryBlock0[RdPointer[10:00]]
                     | {8{(RdPointer[13:11] == 1)}} & MemoryBlock1[RdPointer[10:00]]
                     | {8{(RdPointer[13:11] == 2)}} & MemoryBlock2[RdPointer[10:00]]
                     | {8{(RdPointer[13:11] == 3)}} & MemoryBlock3[RdPointer[10:00]]
                     | {8{(RdPointer[13:11] == 4)}} & MemoryBlock4[RdPointer[10:00]]
                     | {8{(RdPointer[13:11] == 5)}} & MemoryBlock5[RdPointer[10:00]]
                     | {8{(RdPointer[13:11] == 6)}} & MemoryBlock6[RdPointer[10:00]]
                     | {8{(RdPointer[13:11] == 7)}} & MemoryBlock7[RdPointer[10:00]];
