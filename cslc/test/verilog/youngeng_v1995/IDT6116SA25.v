// *******************************************************************************************************
// **                                                                           			**
// **   IDT6116SA25.v - IDT6116SA 2K x 8-BIT RAM (-25 SPEED GRADE)					**
// **                                                                           			**
// *******************************************************************************************************
// **                                                                           			**
...
module IDT6116SA25 (IO, A, WE_N, OE_N, CS_N, RESET);
...
// *******************************************************************************************************
   ...
   initial begin
      tAA  = 25;					// address to data access time
      tACS = 25;					// chip select to data access time
      tCLZ = 5;						// CS_N to data low-Z delay
      tOLZ = 5;						// OE_N to data low-Z delay
      tCHZ = 12;					// CS_N to data high-Z delay
      tOHZ = 10;					// OE_N to data high-Z delay
      tWHZ = 16;					// WE_N to data high-Z delay
      tOE  = 13;					// OE_N to data valid delay
...
// *******************************************************************************************************
   ...
   specify
      specparam
         tCW = 17,              			// CS_N to end of write
         tAW = 17,              			// A valid to end of write
         tAS = 0,              				// A write setup time
         tWP = 15,					// write pulse width
         tWR = 0,					// write recovery time
         tDW = 13,					// write data setup time
