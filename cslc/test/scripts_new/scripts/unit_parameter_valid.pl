...
sub createCslFile {
    ...
    if($i > 5 && $i <= 20) {
        ...
        print FH "  a #(.a_y($val4)) a0(.p_a(p_b));\n";
        print FH "  b(){}\n";
        print FH "};\n\n";
    }
    if($i > 10 && $i <= 20) {
    ...
    if($i > 20 && $i <= 30 ) {
        ...
        print FH "  csl_parameter b_y($val3,$val4);\n";
    ...
    if($i > 25 && $i <= 30) {
        ...
        print FH "  csl_parameter c_z($val3,$val1);\n";
        ...
        print FH "  a #(.a_z($val3)) a0(.pta(p_c));\n";
        print FH "  c(){}\n";
        print FH "};\n";
    }
    if($i > 30) {
    ...
    if($i > 20 && $i <= 30){
        print FH "  csl_parameter top_y($val3,$val4);\n";
    ...
    if($i > 30){
        ...
        print FH "  b #(.b_x($val8 \'b$val9)) b1(.pb(pt_a));\n";    
    }
    if($i > 35) {
        ...
        print FH "  csl_signal st_top(top_v);\n";
        print FH "  c #($val6 \'b$val7,$val8 \'b$val9) c0(.p_c(pt_top),.pc(p_t));\n";
        print FH "  c #(,,$val23 \'h$val24) c1(.pt_c(st_top));\n";    
    }
    print FH "  top(){\n";
    if($i > 15 && $i <= 20) {
