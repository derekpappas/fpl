...
print "the path for generated tests is : $path"."conn_units_p_s_invalid/ \n";
...
sub main {
    my ($i,$var,$it1) = @_;
    my $test_name;
    $test_name = "connect_units_p_s".$i."_".$it1."_illegal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/conn_units_p_s_invalid");
    open(FH,">$path/conn_units_p_s_invalid/$test_name");
   
    print FH "//Generated by Petronela\n";
    print FH "//testing the method connect_units for port to signal and signal to port\n\n";
    ...
    print FH "  c() {\n";
    if($i <= 5) {
        print FH "    b0.p_b$i.connect_units($var);\n";
        print FH "    b0.s_b$i.connect_units(a0.p_a$i);\n";
        
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    pt.connect_units(sg);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    p_c$i.connect_units(sg);\n";
        print FH "    a0.sg.connect_units(p_c$i);\n";
        print FH "    pt.connect_units(s_c$i);\n";
        
    }
    elsif($i > 15 && $i <= 20) {
        print FH "    a0.p_a$i.connect_units(s_a$i);\n";
        print FH "    sc.connect_units(a0.p_a$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    if($i > 5 && $i <= 10) {
        ...
        print FH "    pt.connect_units(b0.s_b$i);\n";
        print FH "    b0.sb.connect_units(pt);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i > 10 && $i <= 15) {
        print FH "    c0.a0.pt.connect_units(p_top$i);\n";
        print FH "    s_top$i.connect_units(pt);\n";
        print FH "    d0.p_d$i.connect_units($var);\n";
    }
    elsif($i > 15 && $i <= 20) {
        print FH "    d0.a0.p_a$i.connect_units($var);\n";
        print FH "    s_a$i.connect_units(c0.p_c$i);\n";
        print FH "    s_top$i.connect_unts(d0.a0.p_a$i);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
