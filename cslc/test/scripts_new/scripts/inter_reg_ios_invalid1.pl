...
#oanab
#method called for a ifc,unit,port,signal,sg,reg
...
print "Generated tests path : inter_reg_ios_invalid1/\n";
...
#unit a
    ...
    if($i <= 50) {
	print FH "    ifc$k\_$zero.set_clock(clk);\n";
	print FH "    ifc$k\_$zero.register_ios(output,.reset(rst),0);\n";
    }
    elsif($i > 50 && $i <= 100) {
	print FH "    p_a$i.register_ios(input);\n";
    }
    elsif($i > 100 && $i <= 150) {
	print FH "    ifc$m\_$zero.set_clock(clk);\n";
	print FH "    ifc$m\_$zero.ifc$k\_$zero.register_ios(output,.reset(rst$k),0);\n";
	print FH "    ifc$m\_$zero.ifc$k\_$one.register_ios(output,.reset(rst$k),3);\n";
    }
    elsif($i > 200 && $i <= 250) {
	print FH "    sg$k\_$zero.set_clock(clk);\n";
	print FH "    sg$k\_$zero.register_ios(input,.reset(rst),4);\n";
    }
    elsif($i > 250 && $i <= 300) {
	print FH "    set_clock(clk);\n";
	print FH "    register_ios(input);\n";
	print FH "    p_clk.set_attr(clock);\n";
	print FH "    ifc$m\_$zero.set_clock(p_clk);\n";
	print FH "    ifc$m\_$zero.register_ios(output,.en(enable));\n";
    }
    print FH "  }\n";
    print FH "};\n\n";
...
# unit b
	...
	print FH "    p_$i.register_ios(input);\n";
    }
    elsif($i > 50 && $i <= 100) {
	...
	print FH "    set_clock(clk);\n";
	print FH "    register_ios(input,.reset(a$k\_$zero.rst$k),$val1);\n";
    }
    elsif($i > 200 && $i <= 250) {
	print FH "    set_clock(clk);\n";
	print FH "    ifc$m\_$one.ifc$k\_$one.register_ios(input,.reset_(rst$k),4,.en(enable$k));\n";
    }
    elsif($i > 250 && $i <= 300) {
	print FH "    reg$k\_$zero.set_clock(clk);\n";
	print FH "    reg$k\_$zero.register_ios(input,.reset(rst$k),$val1);\n";
    }
    print FH "  }\n";
    print FH "};\n";
...
# unit c
	...
	print FH "    clk.set_attr(clock);\n";
	if($i > 100 && $i <= 150) {
	    print FH "    p_x$i.set_clock(clk);\n";
	    print FH "    p_x$i.register_ios(input);\n";
	    print FH "    p_y$i.set_clock(clk);\n";
	    print FH "    p_y$i.register_ios(output);\n";
	}
	elsif($i > 150 && $i <= 200) {
	    print FH "    s_a$i.set_clock(clk);\n";
	    print FH "    s_a$i.register_ios(input,.reset(rst),$val3);\n";
	}
	elsif($i > 200 && $i <= 250) {
	    print FH "    ifc$m\_$zero.ifc$k\_$one.register_ios(input,.en(enable$k));\n";
	}
	print FH "  }\n";
	print FH "};\n";
    }
