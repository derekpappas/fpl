...
print "the path for the generated tests is : $path"."conn_pattern_pps_sps_ifc_sg_invalid1/ \n";
...
sub main {
    my ($i,$l,$u,$it1,$it2) = @_;
    my $test_name = "connect_pattern_pps_sps_ifcp_sgsig".$i."_".$l."_".$u."_".$it1."_".$it2."_illegal.csl";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val5);
    &mkDir("$path/conn_pattern_pps_sps_ifc_sg_invalid1");
    open(FH,">$path/conn_pattern_pps_sps_ifc_sg_invalid1/$test_name");
    ...
    if($i <= 5){
        ...
        print FH "    ifcb0.p_ifb.connect_by_pattern(a0.ifca1.p_ifa,$word1);\n";
    }
    elsif($i > 5 && $i <= 7) {
    ...
    if($i <= 5){
        ...
        print FH "    sgb0.s_sb.connect_by_pattern(a0.ifca1.p_if);\n";
    }
    elsif($i > 10 && $i <= 12) {
    ...
    if($i <= 2) {
        ...
        print FH "    b0.sb[$u:$l].connect_by_pattern(c1.b0.a0.ifca1.p_ifa,$word11);\n";
        print FH "    sd[$u:$l].connect_by_pattern(c1.ifcb0.p_if,$word5);\n";
    }
    elsif($i >2 && $i <= 5) {
        print FH "    p_d$i"."[$u:$l].connect_by_pattern(b0.a0.ifcb0.p_ifb,$word4);\n";
    ...
    if($i <= 5) {
        ...
        print FH "    d0.b0.a0.sga1.s_sa.connect_by_pattern(ifcb2.p_if);\n";
    }
    elsif($i > 5 && $i <= 10) {
    ...
    if($i <= 5) {
        ...
        print FH "    ifcb3.p_ifb.connect_by_pattern(d0.b0.a0.sga1.s_sgga);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    e1.ifcb2.p_ifcb$i.connect_by_pattern(p[$u:$l],$word7);\n";
        print FH "    e0.sgb2.s_siggb.connect_by_pattern(p[$u:$l],$word12);\n";
        print FH "    ifca4.p_if.connect_by_pattern(e2.ifcb2.p_ifb,$word12);\n";
        print FH "    sga4.s_sgga.connect_by_pattern(e0.b0.ifcb0.p_ifcb$i,$word13);\n";
    }
