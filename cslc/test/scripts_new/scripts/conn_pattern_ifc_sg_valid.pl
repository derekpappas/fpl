...
print "th path to the generated tests is : $path"."conn_pattern_ifc_sg_valid/ \n";
...
#	print FH "  sge sge0;\n";
    ...
    print FH "  b() {\n";
    if($i > 10 && $i <= 15) {
	print FH "    ifca2 = sgb4.sga0;\n";
	print FH "    ifca2 = sgb4.sga1;\n";
	print FH "    sgb2.p_ifcb$i = sgb2.p_ifb;\n";
	print FH "    sgb2.p_ib = sgb2.p_iftb$i;\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
...
#	print FH "  b b1;\n";
    ...
    print FH "  c() {\n";
    if($i <= 5){
	print FH "    ifcd3.connect_by_pattern(a0.ifcd2,$word4);\n";
    }
    elsif($i > 5 && $i <= 10) {
	print FH "    ifce0.connect_by_pattern(a0.ifce0,$word4);\n";
        print FH "    sgd2.$it2.sga1.connect_by_pattern(b0.ifce0.ifcd0.ifcb0.ifca0,$word6);\n";
...
#        print FH "    b0.sge0.$it2.connect_by_pattern(b0.a0.ifcb2.ifca0,$word5);\n";
	...
	print FH "  c c0(.ifcb0(ifcb3),.ifca1(ifca3));\n";
	print FH "  ifca ifca3;\n"; 
	print FH "  ifcb ifcb3;\n";
    }
    elsif($i > 15 && $i <= 20) {
	...
	print FH "    ifcb3.connect_by_pattern(b0.sgb2,$word7);\n";
#        print FH "    ifca3.connect_by_pattern(c0.b1.a0.sgd2.sgb0.sga0,$word7);\n";
#        print FH "    ifcb3.connect_by_pattern(c0.b0.sgb2.sga0,$word8);\n";
    }
    elsif($i > 15 && $i <= 20) {
        print FH "    c0.b0.a0.sgd2.sgb0.sga0.set_prefix(\"$word7\");\n";
        print FH "    c0.b0.sgb2.sga0.set_suffix(\"$word8\");\n";
        print FH "    ifca3.connect_by_pattern(c0.b1.a0.sgd2.sgb0.sga0);\n";
        print FH "    ifcb3.connect_by_pattern(c0.b0.sgb2.sga0);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
...
#	print FH "  sgd sgd4;\n";
	...
	print FH "    ifcb4.connect_by_pattern(c0.ifcb2,$word10);\n";
        ...
        print FH "    ifce2.ifcd0.$it1.ifca0.connect_by_pattern(d1.sga3,$word9);\n";
	print FH "    ifce2.connect_by_pattern(c0.ifce0);\n";
#        print FH "    d1.c1.b0.sge0.sgd1.$it2.connect_by_pattern(c0.ifcb2,$word11);\n";
    }
    elsif($i > 10 && $i <= 15) {
	print FH "    sgb4.connect_by_pattern(c0.ifcb0,$word9);\n";
	print FH "    ifcb4.ifca0 = sgb4.sga0;\n";
	print FH "    ifcb4.ifca1 = sgb4.sga1;\n";
	print FH "    sgb4.p_ifcb$i = sgb4.p_ifb;\n";
	print FH "    sgb4.p_ib = sgb4.p_iftb$i;\n";
#        print FH "    ifca4.connect_by_pattern(d0.c0.b0.a0.ifcb2,$word9);\n";
#        print FH "    sgb4.connect_by_pattern(d1.c0.b0.ifca2,$word10);\n";
    }
    elsif($i > 15 && $i <= 20) {
        print FH "    d0.c0.b0.a0.ifcb2.set_suffix(\"$word9\");\n";
        print FH "    d1.c0.b0.ifca2.set_prefix(\"$word10\");\n";
        print FH "    ifca4.connect_by_pattern(d0.c0.b0.a0.ifcb2,$word9);\n";
        print FH "    sgd4.connect_by_pattern(d1.c0.b0.ifca2,$word10);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
	...
	print FH "  e e1(.ifcb4(ifcb5),.ifcd4(ifcd5));\n";
        print FH "  ifcd ifcd5;\n";
        print FH "  sgb sgb5;\n";
	print FH "  ifcb ifcb5;\n";
    }
	...
	print FH "  e e0(.ifcb4(ifcb5));\n";
	print FH "  e e1(.ifcb4(ifcb5));\n";
        print FH "  ifca ifca5;\n";
	print FH "  ifcb ifcb5;\n";
#        print FH "  sge sge3;\n";
    }
	...
	print FH "    ifcb5.connect_by_pattern(d0.ifcb3,$word12);\n";
        print FH "    sgb5.sga0.connect_by_pattern(c1.ifcb2.ifca0,$word14);\n";
	print FH "    sgb5.sga1.connect_by_pattern(c1.ifcb2.ifca1,$word13);\n";
    }
    elsif($i > 5 && $i <= 10) {
	...
	print FH "    ifca5.connect_by_pattern(e0.d0.c0.b0.a0.ifca2);\n";
#        print FH "    e0.sgd4.sgb1.connect_by_pattern(ifca5,$word13);\n";
#        print FH "    e0.d0.ifcb3.ifca0.connect_by_pattern(sge3,$word14);\n"
    }
    elsif($i > 15 && $i <= 20) {
        print FH "    e0.d0.ifca3.set_prefix(\"$word13\");\n";
        print FH "    sge3.set_suffix(\"$word14\");\n";
        print FH "    e0.sgd4.sgb1.connect_by_pattern(ifcb5);\n";
        print FH "    e0.d0.ifcb3.ifca0.connect_by_pattern(sge3);\n"
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
