...
#        print FH "  csl_signal sc($val3);\n";
	...
	print FH "  b b0(.p_b$i(sd),.p(s_d_br$i\[".($w-1)."\:".($val1-1)."\]),.pb(p));\n";
...
#        print FH "    p_e$i"."[$u:$l].connect_by_name({b1.s_b$i,b1.sb,b1.s_b_br$i});\n";
        print FH "    b1.pb[$u:$l].connect_by_name({se$i,se,s});\n";
        print FH "    b1.p_b1.connect_by_name({s_e$i});\n";
    }
    elsif($i > 2 && $i <= 4) {
	...
	print FH "  e e0(.p(ptop));\n";
        print FH "  csl_port ptop(input,$val3);\n";
        print FH "  csl_port p(input,$val2);\n";
#	print FH "  csl_port p_top$i(input,$val9);\n";
        print FH "  csl_signal s_top$i(".($val2-1).");\n";
        print FH "  csl_signal stop(".(1).");\n";
...
#        print FH "    s_top$i.connect_by_name({d0.c0.p_c$i,d0.c0.pc,d0.c0.p});\n";
        print FH "    e0.p_e$i.connect_by_name({stop,s_top$i});\n";
    }
    elsif($i > 2 && $i <= 4) {
