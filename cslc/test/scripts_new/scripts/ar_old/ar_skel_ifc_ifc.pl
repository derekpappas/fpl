...
my $dirTest="ar_skel_ifc_ifc".$typeTest;
...
# create an interface containing clk and rst ports
    ...
    push(@ifcnamelist,"ifcresetclock");
...
# Create a unit with an interface

    push(@created_units,"myUnit");

    my @myifclist=("ifcresclk");
    my @myifcnamelist=("ifcresetclock");
    &createUnitWithNames(FH,"myUnit","","","","",\@myifclist,\@myifcnamelist,"","","","","");
...
# add to top unit clock and reset interface

    my @top_ifclist=("ifcresclk");

#create body for top unit containing one or more connections

    my @top_body=("ifci0.connect(ifcresetclock);\n");

#create top unit
&createUnit(FH,"top",\@top_portinlist,\@top_portinbrlist,"","",\@top_ifclist,"","",\@created_units,\@top_body);
