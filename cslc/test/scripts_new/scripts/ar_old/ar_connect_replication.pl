...
sub main {
    my ($i,$l, $u) = @_;
    my $test_name = "connect_connect_replication$i"."_".$l."_".$u."_legal.csl";
...
sub createCslFile {
    ...
    &mkDir("$path/ar_connect_replication_valid");
    open(FH,">$path/ar_connect_replication_valid/$test_name");
    ...
    print FH "  d() {\n";
    if($i <= 2) {
        print FH "    p_d$i.connect({5{p_a$i}});\n";
        print FH "    p_d_br$i.connect({3{p,p_a_br$i}});\n";
        print FH "    p[$l:$u].connect({2{p_c$i}});\n";
    }
    elsif($i > 2 && $i <= 4) {
        if($val3 != 0){
            print FH "    s_d$i"."[$l:$u].connect({3{pa}});\n";   
            print FH "    b0.p".$i."[$l:$u].connect({3{d.p}});\n";
        }
        elsif($val4 != 0) {
            print FH "    s_d$i"."[$l:$u].connect({4{pa}});\n";   
            print FH "    b0.p".$i."[$l:$u].connect({4{d.p}});\n";
        }
        else {
            print FH "    s_d$i"."[$l:$u].connect({2{pa}});\n";
            print FH "    b0.p".$i."[$l:$u].connect({2{d.p}});\n";
        }
        print FH "    pd[$l:$u].connect({2{sa}});\n";
    }
    elsif($i > 4) {
        print FH "    sd.connect({2{pc}});\n";
        if($val4 != 0) {
            print FH "    b0.p[$l:$u].connect({2{s_d_br$i,s_d$i}});\n";
        }
        else {  
            print FH "    b0.p[$l:$u].connect({2{s_d_br$i}});\n";
        }
    }
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    s_e_br$i.connect({2{p_b$i,p}});\n";
        print FH "    p_e$i"."[$l:$u].connect({2{sb}});\n";
        if($val4 != 0){
            print FH "    b0.pb[$l:$u].connect({2{se,s}});\n";
        }
        else {  
            print FH "    b0.pb[$l:$u].connect({2{se}});\n";
        }
    }
    elsif($i > 1 && $i <= 3) {
        if($val4 != 0) {
            print FH "    p_e$i"."[$l:$u].connect({4{s_a$i}});\n";
        }
        else {
            print FH "    p_e$i"."[$l:$u].connect({2{s_a$i}});\n";
        }
        print FH "    s_e$i"."[$l:$u].connect({2{p_b$i}});\n";
    }
    elsif($i > 3) {
        print FH "    p[$l:$u].connect({2{pb}});\n";
        print FH "    se.connect({5{p_b$i}});\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i <= 2) {
        print FH "    stop.connect({2{p_a_br$i,p}});\n";
        print FH "    s_top$i.connect({2{p_c$i,pc,p}});\n";
        print FH "    d0.p"."[$l:$u].connect({2{sa}});\n";
    }
    elsif($i == 3) {
        print FH "    s_top$i.connect({4{p_a$i}});\n";
        print FH "    stop.connect({2{pb}});\n";
        print FH "    p[$l:$u].connect({2{sa}});\n";
    }
    elsif($i > 3) {
        print FH "    s_top_br$i.connect({2{e0.p_e$i,pe}});\n";
        print FH "    s_top_br$i.connect({4{p_d$i}});\n";
        print FH "    d0.b0.p_b$i"."[$l:$u].connect({2{p_top$i}});\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
