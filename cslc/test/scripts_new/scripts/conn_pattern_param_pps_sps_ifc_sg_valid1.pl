...
print "the path for the generated tests is : $path"."conn_pattern_param_pps_sps_ifc_sg_valid1/ \n";
...
sub main {
    my ($i,$l,$u,$it1,$it2) = @_;
    my $test_name = "connect_pattern_param_pps_sps_ifcp_sgsig".$i."_".$l."_".$u."_".$it1."_".$it2."_legal.csl";
...
sub createCslFile {
    ...
    my $word12 = &word($val3);
    my $word13 = &word($val5);
    &mkDir("$path/conn_pattern_param_pps_sps_ifc_sg_valid1");
    open(FH,">$path/conn_pattern_param_pps_sps_ifc_sg_valid1/$test_name");
    
    print FH "//Generated by Petronela\n";
    print FH "//testing the method connect_by_pattern with parameter for conections port[ps] to ifc.p[ps], signal[ps] to ifc.p[ps], ifc.p[ps] to port[ps] ,ifc.p[ps] to signal[ps], port[ps] to signal_group.sig[ps], sg.sig[ps] to port[ps]\n\n";
    ...
    if($i <= 5 ) {
        ...
        print FH "  csl_port p_ifa(input,ifca_x);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "  csl_parameter ifca_u($u);\n";
        print FH "  csl_parameter ifca_l($l);\n";
        ...
        print FH "  csl_port p_if(output,ifca_x);\n";
    }
    elsif($i > 10 ) { 
        print FH "  csl_parameter ifca_u($u);\n";
        print FH "  csl_parameter ifca_l($l);\n";
    ...
    if($i <= 5) {
        ...
        print FH "  csl_port p_ifb(output,ifcb_x);\n";
        ...
        print FH "  csl_port p_ifb(input,$val1);\n";
        print FH "  csl_port p_if(input,ifcb_x);\n";
        print FH "  csl_port p_iftb$i(input,$val1);\n";
        print FH "  csl_port p_b(input,ifcb_y);\n";
    }
    print FH "  ifcb() {\n";
    print FH "  }\n";        
    print FH "};\n";        
    ...
    print FH "  csl_signal s_sa(sga_x);\n";
    print FH "  csl_signal s_sgga($val1);\n";
    print FH "  csl_signal s_siga(sga_y);\n";
    ...
    print FH "  csl_signal s_sgb(sgb_x);\n";
    print FH "  csl_signal s_sb($val1);\n";
    print FH "  csl_signal s_sggb($val1);\n";
    print FH "  csl_signal s_sigb(sgb_y);\n";
    ...
    if($i <= 5) {
        ...
        print FH "  csl_parameter b_u($u);\n";
        print FH "  csl_parameter b_l($l);\n";
        print FH "  csl_port p_b$i(input,b_z);\n";
    ...
    print FH "  b() {\n";
    if($i <= 5){
        print FH "    ifcb0.p_ifb[ifcb_u:ifcb_l].connect_by_pattern(a0.p[a_u:a_l],$word);\n";
        print FH "    s_b$i"."[b_u:b_l].connect_by_pattern(a1.ifca1.p_ifa[ifca_u:ifca_l]);\n";
        print FH "    sgb0.s_sb[sgb_u:sgb_l].connect_by_pattern(a1.p[a_u:a_l],$word1);\n";
    }
    elsif($i > 5 && $i <= 7) {
        print FH "    $it1"."[$u:$l].connect_by_pattern(a0.ifca1.p_ifa[ifca_u:ifca_l],$word1);\n";
        print FH "    s_b_br$i"."[b_u:b_l].connect_by_pattern(a1.ifcb0.p_ifcb$i"."[$u:$l]);\n";
        print FH "    a0.ifcb0.p_ifb[$u:$l].connect_by_pattern(s_b$i"."[$u:$l],$word);\n";
    }
    elsif($i > 7 && $i <=10) {
        print FH "    $it1"."[$u:$l].connect_by_pattern(a1.ifcb0.p_ifb[$u:$l],$word1);\n";
        print FH "    s_b$i"."[b_u:b_l].connect_by_pattern(a1.ifca1.p_ifca$i"."[ifca_u:ifca_l],$word);\n";
        print FH "    a0.ifca1.p_ifa[ifca_u:ifca_l].connect_by_pattern(s_b_br$i"."[b_u:b_l]);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    a0.ifca1.p_ifta$i"."[ifca_u:ifca_l].connect_by_pattern(p_b$i"."[b_u:b_l],$word);\n";
        print FH "    a1.sga1.s_sigga[sga_u:sga_l].connect_by_pattern(p_b$i"."[$u:$l],$word1);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    if($i <= 5 ) {
        ...
        print FH "  csl_signal sc(c_t);\n";
    }
    print FH "  c() {\n";
    if($i <= 5){
        print FH "    b0.ifca1.p_ifca$i"."[ifca_u:ifca_l].connect_by_pattern(pc[$u:$l],$word2);\n";
        print FH "    sc[c_u:c_l].connect_by_pattern(b1.ifcb0.p_ifcb$i"."[ifcb_u:ifcb_l],$word3);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    s_c_br$i"."[$u:$l].connect_by_pattern(b0.ifca1.p_ifa[ifca_u:ifca_l],$word2);\n";
        print FH "    a0.sgb0.s_sggb[sgb_u:sgb_l].connect_by_pattern(p_c$i"."[c_u:c_l],$word3);\n";
        print FH "    sgb0.s_sb[$u:$l].connect_by_pattern(a0.ifca.p_if[ifca_u:ifca_l]);\n";
    }
    elsif($i > 10 && $i <= 12) {
        print FH "    b0.a1.ifca1.set_prefix(\"$word7\");\n";
        print FH "    $it1"."[$u:$l].connect_by_pattern(a1.ifca1.p_ifca$i"."[ifca_u:ifca_l],$word3);\n";
        print FH "    s_c$i"."[c_u:c_l].connect_by_pattern(a0.ifcb0.p_b[ifcb_u:ifcb_l],$word2);\n";
    }
    elsif($i > 12 && $i <= 15) {
        print FH "    $it1"."[$u:$l].connect_by_pattern(a1.ifcb0.p_ifcb$i"."[ifcb_u:ifcb_l],$word3);\n";
        print FH "    a0.ifca1.p_if[ifca_u:ifca_l].connect_by_pattern(sc[c_u:c_l],$word2);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    if($i <= 2) {
        ...
        print FH "    c0.b0.p_b$i"."[$u:$l].connect_by_pattern(c0.ifca1.p_ifca$i"."[ifca_u:ifca_l],$word4);\n";
        print FH "    b0.sb[b_u:b_l].connect_by_pattern(b0.a0.ifca1.p_ifa[ifca_u:ifca_l],$word11);\n";
        print FH "    sd[$u:$l].connect_by_pattern(c1.ifcb0.p_if[$u:$l],$word5);\n";
    }
    elsif($i >2 && $i <= 5) {
        print FH "    p_d$i"."[$u:$l].connect_by_pattern(a0.ifcb0.p_ifb[ifcb_u:ifcb_l],$word4);\n";
        print FH "    s_d$i"."[$u:$l].connect_by_pattern(b0.ifca1.p_ifa[ifca_u:ifca_l],$word5);\n";
        print FH "    a0.ifca1.p_ifca$i"."[ifca_u:ifca_l].connect_by_pattern(sd[$u:$l],$word11);\n";
    }
    elsif($i > 5 && $i <= 7) {
        print FH "    s_d$i"."[$u:$l].connect_by_pattern(c0.ifca1.p_if[ifca_u:ifca_l],$word4);\n";
        print FH "    c0.ifcb0.p_ifb[ifcb_u:ifcb_l].connect_by_pattern(s_d_br$i"."[$u:$l],$word5);\n";
    }
    elsif($i > 7 && $i <= 10) {
        print FH "    a0.ifca1.p_ifca$i"."[ifca_u:ifca_l].connect_by_pattern(p_d$i"."[$u:$l],$word5);\n";
        print FH "    s_d_br$i"."[$u:$l].connect_by_pattern(a0.ifca1.p_ifa[ifca_u:ifca_l],$word4);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    sd[$u:$l].connect_by_pattern(b0.ifcb0.p_ifcb$i"."[ifca_u:ifca_l],$word4);\n";
        print FH "    p_d$i"."[$u:$l].connect_by_pattern(b0.sgb0.s_sb[sgb_u:sgb_l],$word5);\n";
    }
    ...
    if($i <= 5) {
        ...
        print FH "  csl_parameter e_t($val1);\n";
    ...
    print FH "  e() {\n";
    if($i <= 5) {
        print FH "    p_e_br$i"."[$u:$l].connect_by_pattern(c1.b0.ifca1.p_ifa[ifca_u:ifca_l],$word6);\n";
        print FH "    b0.a0.sa[a_u:a_l].connect_by_pattern(ifca3.p_ifca$i"."[ifca_u:ifca_l],$word10);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    se[$u:$l].connect_by_pattern(c0.ifcb0.p_ifb[ifcb_u:ifcb_l],$word9);\n";
        print FH "    b0.s_b_br$i"."[$u:$l].connect_by_pattern(ifcb2.p_ifcb$i"."[ifcb_u:ifcb_l],$word6);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    ifca3.p_if[ifca_u:ifca_l].connect_by_pattern(c0.b1.a0.p_a_br$i"."[$u:$l],$word6);\n";
        print FH "    s_e_br$i"."[$u:$l].connect_by_pattern(c1.b0.ifca1.p_ifta$i"."[ifca_u:ifca_l],$word10);\n";
        print FH "    sga3.s_sga[sga_u:sga_l].connect_by_pattern(c1.b1.a0.p_a_br$i"."[$u:$l],$word9);\n";
    }
    ...
    if($i <= 5) {
        ...
        print FH "  csl_parameter top_z($val1);\n";
    ...
    print FH "  top(){\n";
    if($i <= 5) {
        print FH "    ifca4.p_ifa[ifca_u:ifca_l].connect_by_pattern(d0.a0.p_a$i"."[$u:$l],$word7);\n";
        print FH "    d0.b0.p[$u:$l].connect_by_pattern(ifca4.p_ifa[ifca_u:ifca_l],$word8);\n";
        print FH "    s_top$i"."[$u:$l].connect_by_pattern(d0.ifca2.p_ifca$i"."[ifca_u:ifca_l],$word12);\n";
    }
    elsif($i > 5 && $i <= 10) {
        print FH "    ifcb3.p_ifb[ifcb_u:ifcb_l].connect_by_pattern(e2.b0.p_b$i"."[b_u:b_l],$word8);\n";
        print FH "    e1.ifcb2.p_ifcb$i"."[ifcb_u:ifcb_l].connect_by_pattern(st[$u:$l],$word7);\n";
        print FH "    s_top_br$i"."[$u:$l].connect_by_pattern(d1.b0.ifcb0.p_ifb[ifcb_u:ifcb_l],$word12);\n";
        print FH "    ifcb3.p_ifb[$u:$l].connect_by_pattern(d0.b0.a0.sga1.s_sgga[sga_u:sga_l]);\n";
    }
    elsif($i > 10 && $i <= 15) {
        print FH "    e1.ifcb2.p_ifcb$i"."[ifcb_u:ifcb_l].connect_by_pattern(p[$u:$l],$word7);\n";
        print FH "    e0.sgb2.s_siggb[sgb_u:sgb_l].connect_by_pattern(p[$u:$l],$word12);\n";
    }
