...
sub createCslFile {
    ...
    if($i == 1 ) {
        ...
        print FH "  csl_port p_a(output,$val1);\n";
    }
    elsif($i == 2) {
        print FH "  csl_parameter ifca_x($val1);\n";
        print FH "  csl_parameter ifca_y($val1);\n";
    ...
    print FH "  csl_parameter sgd_z($val1);\n";
    ...
    print FH "  sgd sgd0;\n";
    print FH "  sgd sgd1;\n";
    print FH "  csl_parameter sge_x($val1);\n";
    print FH "  csl_parameter sge_y($val1);\n";
    ...
    print FH "  c() {\n";
    if($i == 1){
        print FH "    ifca2.p_ifca$i"."[$u:$l].connect_by_pattern(b0.ifcb2.$it1.p_ifa[ifca_u:ifca_l],$word4);\n";
        print FH "    sgd2.p_if[sgd_u:sgd_l]connect_by_pattern(b1.ifcb2.p_if[$u:$l],$word5);\n";
    }
    elsif($i == 2) {
        print FH "    ifcd2.$it1.ifca0.p_ifca$i"."[ifca_u:ifca_l].connect_by_pattern(b0.sgb2.p_if[$u:$l],$word4);\n";
        print FH "    ifca2.p_ifa[$u:$l].connect_by_pattern(b0.a0.ifce0.ifcd1.$it1.p_ifca$i"."[$u:$l],$word5);\n";
        print FH "    sgd2.$it2.sga1.p_ifa[$u:$l].connect_by_pattern(b0.ifce0.p_if[$u:$l],$word6);\n";
    }
    else {
        print FH "    ifce0.$it1.p_a[$u:$l].connect_by_pattern(b1.a0.ifca2.p_if[ifca_u:ifca_l],$word4);\n";
        print FH "    b0.sge0.$it2.p_ifta$i"."[sgd_u:sgd_l].connect_by_pattern(b0.a0.ifcb2.ifca0.p_ifa[ifca_u:ifca_l],$word5);\n";
    }
    ...
    print FH "  d() {\n";
    if($i == 1) {
        print FH "    a0.ifcd2.ifcb0.p_ifa[ifcb_u:ifcb_l].connect_by_pattern(ifcd3.p_ifca$i"."[$u:$l],$word7);\n";
        print FH "    c0.ifcb2.ifca1.p_ifa[ifca_u:ifca_l].connect_by_pattern(ifcb3.$it1.p_a[ifca_u:ifca_l],$word8);\n";
    }
    
    elsif($i == 2) {
        print FH "    sgd3.p_if[$u:$l].connect_by_pattern(c0.ifce0.ifcd1.$it1.p_ifa[ifcb_u:ifcb_l],$word7);\n";
        print FH "    c0.ifca2.p_ifa[$u:$l].connect_by_pattern(c1.sge0.sgd1.$it2.p_ifca$i"."[$u:$l],$word8);\n";
    }
    else {
        print FH "    ifca3.p_ifta$i"."[$u:$l].connect_by_pattern(a0.sgd2.sgb0.sga0.p_ifa[sga_u:sga_l],$word7);\n";
        print FH "    ifcd3.p_ifta$i"."[$u:$l].connect_by_pattern(b0.sgb2.sga0.p_if[sga_u:sga_l],$word8);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    d0.sgb3.$it2.p_ifca$i"."[$u:$l].connect_by_pattern(ifcd4.ifcb1.$it1.p_if[ifca_u:ifca_l],$word9);\n";
        print FH "    b0.a0.sgb2.pifca$i"."[sgb_u:sgb_l].connect_by_pattern(ifcb4.p_ifa[ifcb_u:ifcb_l],$word10);\n";
    }
    elsif($i == 2) {
        print FH "    ifce2.ifcd0.$it1.p_ifa[ifcb_u:ifcb_l].connect_by_pattern(d1.ifcd3.p_ifca$i"."[ifcd_u:ifcd_l],$word9);\n";
        print FH "    sge2.p_if[sge_u:sge_l].connect_by_pattern(c0.ifcb2.ifca0.p_ifa[ifca_u:ifca_l],$word10);\n";
        print FH "    b0.sge0.sgd1.$it2.p_if[sgb_u:sgb_l].connect_by_pattern(d0.ifcb3.pifca$i"."[$u:$l],$word11);\n";
    }
    else {
        print FH "    ifca4.p_a[ifca_u:ifca_l].connect_by_pattern(d0.b0.a0.ifcb2.p_ifa[ifcb_u:ifcb_l],$word9);\n";
        print FH "    sgb4.p_ifca$i"."[sgb_u:sgb_l].connect_by_pattern(d1.b0.ifca2.p_ifa[ifca_u:ifca_l],$word10);\n";
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
    ...
    print FH "  top(){\n";
    if($i == 1) {
        print FH "    ifca5.p_ifca$i"."[ifca_u:ifca_l].connect_by_pattern(d0.b0.ifcb2.$it1.p_if[$u:$l],$word12);\n";
        print FH "    ifcd5.p_ifca$i"."[ifcd_u:ifcd_l].connect_by_pattern(e0.b0.ifca2.p_ifa[ifca_u:ifca_l],$word13);\n";
        print FH "    sgb5.p_if[sgb_u:sgb_l].connect_by_pattern(d0.ifcd3.p_ifca$i"."[ifcd_u:ifcd_l],$word14);\n";
    }
    elsif($i == 2) {
        print FH "    ifcb5.p_ifa[ifcb_u:ifcb:l].connect_by_pattern(e0.b0.a0.sga2.p_if[sga_u:sga_l],$word14);\n";
        print FH "    ifcd5.p_if[ifcd_u:ifcd_l].connect_by_pattern(d0.sga3.p_ifca$i"."[sga_u:sga_l],$word13);\n";
    }
    else {
        print FH "    ifca5.p_ifta$i"."[ifca_u:ifca_l].connect_by_pattern(e0.sgd4.sgb1.p_ifca$i"."[sgb_u:sgb_l],$word13);\n";
        print FH "    d0.ifcb3.ifca0.p_if[ifca_u:ifca_l].connect_by_pattern(sge3.p_ifca$i"."[$u:$l],$word14);\n"
    }
    print FH "  }\n";        
    print FH "};\n";        
    print FH "\n";
