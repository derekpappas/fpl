...
print "the path for generated tests is: $path"."conn_units_u_u_invalid/ \n";
...
sub main {
    ...
    $test_name = "conn_unit_u_u".$i."_".$it1."_".$it2."_".$it3."_".$it4."_illegal.csl";
...
sub createCslFile {
    ...
    my $word5 = &word($val4);
    my $word6 = &word($val5);
    &mkDir("$path/conn_units_u_u_invalid");
    open(FH,">$path/conn_units_u_u_invalid/$test_name");
    
    print FH "//Generated by Petronela\n";
    print FH "//testing the command connect_units for connections unit to unit --illegal \n\n";
    ...
    print FH "  csl_port p_addr2(input,$val1);\n";
    ...
    if($i >= 3){
        ...
        print FH "  csl_port p_addr2(output,$val1);\n";
        print FH "  csl_port p_data2(output,$val1);\n";
        print FH "  csl_port p_addr1(input,$val1);\n";
        print FH "  csl_signal s_data($val2);\n"; 
        print FH "  csl_signal s_addr($val2);\n";
    ...
    if($i <= 2) {
        if($it2 eq "a0" || $it2 eq "a1"){
            print FH "    $it1.connect_units(c1.b1.$it2);\n";
            print FH "    $it1.connect_units(c0);\n";
        }
        elsif($it2 ne "b0" && $it2 ne "b1"){
            print FH "    $it1.connect_units($it2);\n";
            print FH "    b1.a0.connect_units($it2);\n";
        }
    }
    elsif($i > 2) {
    ...
    if($i > 4){
        print FH "    sg.set_suffix(\"$word5\");\n"; 
        print FH "    sgg.no_prefix();\n";
    }
    ...
    print FH "  e() {\n";
    if($i == 1) {
        print FH "    $it3.connect_units(b0.$it4);\n";
        print FH "    c0.connect_units($it4);\n";
    }
    elsif($i == 3) {
        print FH "    d0.$it3.connect_units(c1.$it4);\n";
        print FH "    d1.$it3.connect_units(c2.$it4);\n";
    }
    if($i > 4 ) {
        print FH "    sg.set_suffix(\"$word5\");\n";
        print FH "    sgg.no_prefix();\n";
    ...
    if($i == 2) {
        if($it3 == "e0" || $it3 == "e1"){
            ...
            print FH "    $it3.connect_units(d0.$it4.a0);\n";
            print FH "    d2.c1.b0.a1.connect_units(e0.d0);\n"; 
        }
        else {
            print FH "    $it3.connect_units(e0.d0.$it4);\n";
            print FH "    $it3.connect_units(e0.d0.$it4.a0);\n";
            print FH "    d1.b1.connect_units(e1.c0.b0.a1);\n";
        }
    }
    elsif($i >= 4) {
        print FH "    $it3.connect_units(e0.d0.c0.$it4);\n";
        print FH "    a0.connect_units(d1.c1.$it4);\n";
        print FH "    d1.connect_units(e2.c1.a0);\n";
    }
    if($i > 4 ) {
