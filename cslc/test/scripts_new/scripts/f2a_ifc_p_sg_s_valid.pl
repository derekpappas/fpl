...
sub createCslFile {
    ...
    print FH "  unit_a a0(.inter2.p1_ifc2_$k(sgn1.s2_sg1_$k),.inter2.p2_ifc2_$k(sgn1.s1_sg1_$k)) ; \n";
    print FH "  unit_a a1(.inter2.p4_ifc2_$k(sgn1.s2_sg1_$k)) ; \n";
    ...
    print FH "  sg1 sgn1; \n";
    print FH "  unit_a ainst;\n";
    print FH "  unit_b binst;\n";
    }
    elsif($k > 10 && $k <= 15) {
    print FH "  sg1 sgn3; \n";
    print FH "  ifc2 inter32 ; \n";
    ...
    print FH "  unit_b b0(.inter32.p3_ifc2_$k(sgn2.s1_sg2_$k),.inter32.p2_ifc2_$k(sgn2.s3_sg2_$k)) ; \n";
    print FH "  unit_b b1(.inter32.p4_ifc2_$k(sgn2.s2_sg2_$k)); \n";
    print FH "  unit_a a2(.inter32.p1_ifc2_$k(sgn1.s2_sg1_$k)); \n";
    print FH " // F2a sg_s_ifc_p . \n";
    }   
    print FH "  unit_top() { \n";  
    print FH "  }\n";        
